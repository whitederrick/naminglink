// 배치 147(밀러 `Ouija`~`Owl`) — 기존 하나를 손본다.
//
//   coat(외투) ← 밀러 `Overcoat` 둘(「멋진 새 외투」 문장은 「새 외투를 봄」과 같은
//               그림이라 뺐다)
//
// **한 번만 돌린다.** 실행: node scripts/patch-km-147.mjs
...
const PATCHES = {
  coat: {
    ...
    contextsEnAdd: {
      "외투 꿈을 꿈": "contrariness exhibited others",
      "외투를 빌림": "borrow strangers mistakes",
    },
  },
};
let changed = 0;
