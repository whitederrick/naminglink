// 배치 141(밀러 `Nuns`~`Nymph`) — 기존 하나를 손본다. **밀러 N 이 여기서 끝난다.**
//
//   wedding(혼례) ← 밀러 `Nuptial` 하나. 원문 자신이 「[139] See Marriage」라 적었다
//
// **한 번만 돌린다.** 실행: node scripts/patch-km-141.mjs
...
const PATCHES = {
  wedding: {
    aliasesAdd: [],
    contextsAdd: {
      "여성이 제 혼례를 봄": "제 혼례 새 인연 화목",
    },
    contextsEnAdd: {
      "여성이 제 혼례를 봄": "her nuptials distinction pleasure harmony",
    },
  },
};
let changed = 0;
