      ...
      messages: [
        {
          role: "system",
          content: [
            `You translate a Korean saju-compatibility service's help pages into ${language}.`,
            ...
            "CRITICAL: write 'Inyeon-Link' exactly in Latin letters, never transliterated or translated. It is a trademark and matches the domain inyeon-link.com. The same holds for any domain name.",
          ].join("\n"),
        },
