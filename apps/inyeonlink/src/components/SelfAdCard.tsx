 ...
 * 아니라 결함으로 읽힌다. 명단은 코어에 있고 여기서 `inyeonlink`를 뺀다 — 이 앱을 복제할 때
 * 그 한 글자만 바꾸면 된다.
 */
...
export function SelfAdCard({
  ...
  const candidates = selfAdsExcluding("inyeonlink");
              ...
              <div className="flex min-w-0 flex-col gap-1">
                ...
                {service.live ? (
                  <a
                    ...
                    className="break-all text-xs text-brand-plum underline underline-offset-2"
                  >
                    {service.domain}
                  </a>
                ) : (
