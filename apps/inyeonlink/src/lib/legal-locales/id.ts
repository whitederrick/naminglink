...
const d0 = {
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphs": [
        "Alamat layar hasil mencakup nilai yang dimasukkan dalam bentuk yang dienkripsi. Namun, nilai ini terletak setelah # di alamat, dan menurut standar web, konten setelah # tidak dikirimkan oleh browser ke server. Oleh karena itu, meskipun tautan hasil dibuka, catatan akses server hanya menyimpan jalur alamat.",
    ...
    },
    {
      ...
      "paragraphs": [
        ...
        "Saat ini, tidak ada iklan yang ditampilkan di layanan ini. Jika di masa depan iklan ditampilkan, penyedia iklan (misalnya, Google) dapat menggunakan cookie untuk menampilkan iklan. Pada saat itu, ketentuan ini akan diperbarui terlebih dahulu untuk menjelaskan apa yang berubah sebelum dimulai."
      ]
    },
    {
...
const d1 = {
  ...
  "intro": "Syarat dan ketentuan ini menetapkan syarat penggunaan layanan InyeonLink (selanjutnya disebut \"layanan\"). Dengan menggunakan layanan ini, Anda dianggap telah menyetujui syarat dan ketentuan ini.",
  "effectiveLabel": "Tanggal Berlaku",
  "sections": [
    {
      "heading": "1. Sifat Layanan",
      "paragraphs": [
        "Layanan ini menunjukkan referensi hubungan antara dua orang dengan menerapkan aturan hubungan tradisional berdasarkan tanggal lahir yang dimasukkan, menggunakan saju (사주) dan zodiak Korea.",
        "Persentase kecocokan dan penjelasan yang diberikan adalah **referensi dari perspektif interpretasi tradisional dan bukan prediksi ilmiah atau kepastian mengenai hubungan.** Skor yang rendah tidak berarti hubungan itu buruk, dan skor yang tinggi tidak menjamin hubungan tersebut."
      ]
    },
    {
      ...
      "paragraphs": [
        ...
        "Ketika penjualan produk berbayar (laporan kompatibilitas PDF) dimulai, ketentuan di bawah pasal 3 akan berlaku. Ketentuan ini akan diinformasikan kembali sebelum dimulainya penjualan."
      ]
    },
    {
      "heading": "3. Produk Berbayar dan Pengembalian Dana",
      "paragraphs": [
        "Produk berbayar yang dijual adalah **laporan kompatibilitas PDF**. Hasil dari layar akan dibuat menjadi dokumen PDF sebanyak 3 halaman, yang juga mencakup nilai kekuatan lima elemen yang tidak ditampilkan di layar.",
        "Harga untuk pembayaran domestik adalah {priceDomestic} (termasuk PPN), dan untuk pembayaran internasional adalah {priceGlobal}. Pembayaran domestik dapat dilakukan melalui Toss Payments menggunakan kartu kredit/debit dan pembayaran mudah (seperti Toss Pay, Kakao Pay, Naver Pay, Payco, dll.), sedangkan pembayaran internasional dilakukan melalui PayPal melalui PortOne. Jumlah akhir mengikuti jumlah yang ditampilkan di layar pembayaran.",
        "**Layanan ini tidak menyimpan input pengguna maupun file PDF yang dihasilkan.** Setelah pembayaran disetujui, dokumen akan dibuat dan diunduh secara langsung, tanpa menyisakan apa pun di server. Oleh karena itu, file yang diunduh harus disimpan oleh pengguna secara langsung.",
        "Jika unduhan terhenti atau file hilang, file dapat diunduh kembali **hingga 5 kali** dengan pesanan yang sama. Namun, jika input hilang setelah keluar dari layar hasil, file tidak dapat dibuat kembali, jadi harap simpan file segera setelah pembayaran."
      ],
      "bullets": [
        "**Sebelum unduhan dimulai setelah pembayaran,** Anda dapat membatalkan dan mendapatkan pengembalian penuh kapan saja.",
        "**Setelah unduhan selesai,** pembatalan karena perubahan pikiran tidak dapat dilakukan. Ini adalah konten digital yang disediakan segera setelah pembayaran dan tidak dapat dikembalikan, yang termasuk dalam alasan pembatasan pembatalan sesuai dengan Pasal 17 Ayat 2 Undang-Undang Perlindungan Konsumen dalam Transaksi Elektronik.",
        "**Jika dokumen tidak dibuat karena kesalahan sistem, file tidak dapat dibuka, atau jumlah pembayaran berbeda dari pesanan,** maka akan diproses dengan penerbitan ulang atau pengembalian penuh.",
        "**Keluhan mengenai isi hasil** tidak termasuk dalam alasan pengembalian dana. Hasil kompatibilitas adalah bahan referensi dari perspektif interpretasi tradisional dan sifatnya telah diinformasikan sebelum pembayaran (lihat Ayat 1 di atas).",
    ...
    },
    {
      ...
      "paragraphs": [
        ...
        "Jika waktu kelahiran tidak dimasukkan, perhitungan akan dilakukan tanpa mempertimbangkan si-ju (時柱), sehingga hasilnya dapat berbeda. Semakin tepat lokasi kelahiran yang dipilih, semakin akurat perhitungan si-ju.",
        "Perhitungan manseyeok menggunakan pustaka perhitungan yang dipublikasikan, dan hasilnya dapat berbeda tergantung pada cara penanganan solar term dan zona waktu."
      ]
    },
    {
    ...
    {
      "heading": "7. Penolakan Tanggung Jawab",
      "paragraphs": [
        ...
        "Kami tidak bertanggung jawab atas kerugian yang timbul akibat penghentian layanan karena alasan yang tidak dapat dikendalikan, seperti bencana alam, gangguan dari penyedia infrastruktur, dan lain-lain."
      ]
    },
    {
    ...
    },
    {
      ...
      "paragraphs": [
        ...
        "Ketentuan ini tunduk pada hukum Republik Korea, dan sengketa yang berkaitan dengan penggunaan layanan akan mengikuti prosedur yang ditentukan oleh peraturan perundang-undangan yang berlaku."
      ]
    }
  ]
};
...
const d2 = {
  ...
  "intro": "Ini adalah standar pembatalan dan pengembalian untuk laporan kompatibilitas PDF. Kami telah mengumpulkan informasi yang sama seperti yang tercantum dalam Pasal 3 syarat dan ketentuan.",
  "sections": [
    {
      "heading": "1. Sifat Produk",
      "paragraphs": [
        "Produk yang dijual adalah **laporan kompatibilitas PDF** yang merupakan konten digital yang dibuat dan dikirimkan secara instan setelah pembayaran disetujui.",
        "**Layanan tidak menyimpan input pengguna maupun file PDF yang dihasilkan.** Oleh karena itu, file yang diunduh harus disimpan oleh pengguna secara langsung."
      ]
    },
    {
    ...
    },
    {
      ...
      "paragraphs": [
        "Pengembalian dan pertanyaan dapat diajukan melalui pusat layanan pelanggan ({customerCenter}) atau email ({email}). Jika Anda memberikan nomor pesanan, konfirmasi akan lebih cepat.",
  ...
  "sections": [
    {
      ...
      "paragraphs": [
        ...
        "Anda dapat melihat tingkat kecocokan, skor per item, pilar saju (사주) dari kedua orang, serta bentuk hubungan di layar."
      ]
    },
    {
      ...
      "paragraphs": [
        ...
        "Hasil di layar akan dibuat menjadi dokumen PDF sebanyak 3 halaman. Ini juga akan mencakup nilai kekuatan elemen yang tidak ditampilkan di layar.",
        "Dengan pesanan yang sama, Anda dapat mengunduhnya kembali hingga **5 kali**. Namun, jika nilai input hilang setelah keluar dari layar hasil, Anda tidak dapat membuatnya lagi, jadi harap simpan file segera setelah pembayaran."
      ]
    },
    {
  ...
  "sections": [
    {
      ...
      "paragraphs": [
        "Tanggal lahir, waktu lahir, tempat lahir, jenis kelamin, dan nama yang digunakan untuk perhitungan kompatibilitas **tidak disimpan di mana pun.** Informasi ini hanya digunakan dalam memori server selama pemrosesan permintaan dan akan hilang bersama dengan respons.",
        "Tidak dicatat dalam database, dan juga tidak disimpan dalam file terpisah. Karena tidak ada pendaftaran anggota, nilai yang dimasukkan tidak terhubung dengan individu tertentu."
      ]
    },
    {
      "heading": "2. Informasi yang Termasuk dalam Tautan Hasil",
      "paragraphs": [
        "Alamat layar hasil mencakup nilai yang dimasukkan dalam bentuk yang terenkode. Namun, nilai ini terletak setelah # di alamat, dan menurut standar web, konten setelah # tidak dikirimkan oleh browser ke server. Oleh karena itu, meskipun tautan hasil dibuka, catatan akses server hanya akan menyimpan jalur alamat.",
        "Jika tautan hasil dikirimkan kepada orang lain, orang tersebut juga dapat melihat hasil yang sama. Tautan itu sendiri menyimpan nilai yang dimasukkan, jadi keputusan untuk membagikannya adalah tanggung jawab pengguna."
      ]
    },
    {
      "heading": "3. Informasi yang Dikumpulkan Secara Otomatis",
      "paragraphs": [
        "Tidak ada informasi yang dikumpulkan untuk mengidentifikasi pengguna. Namun, catatan minimum yang diperlukan untuk operasi layanan akan secara otomatis disimpan oleh penyedia infrastruktur."
      ],
      "bullets": [
        "Alamat IP yang diakses, waktu akses, jenis browser, dan catatan akses server umum lainnya",
        "Informasi negara — hanya digunakan untuk secara otomatis menentukan bahasa layar dan tidak disimpan"
    ...
    },
    {
      ...
      "paragraphs": [
        "Karena tidak ada data pribadi yang disimpan, tidak ada data pribadi yang disediakan kepada pihak ketiga.",
        "Untuk menjalankan layanan, kami menggunakan infrastruktur hosting dari {hostingProvider}, dan dalam proses ini, catatan akses yang disebutkan di atas akan diproses sesuai dengan kebijakan penyedia tersebut.",
    ...
    },
    {
      "heading": "10. Perubahan Kebijakan",
      "paragraphs": [
        "Jika kebijakan ini diubah, tanggal mulai dan rincian perubahan akan diposting di halaman ini. Jika ada perubahan yang benar-benar mempengaruhi pemrosesan, seperti mulai menampilkan iklan atau menjual produk berbayar, kami akan memberi tahu terlebih dahulu."
      ]
    }
  ],
  "effectiveLabel": "Tanggal Berlaku"
  ...
  "sections": [
    {
      "heading": "1. Informasi yang Tidak Disimpan",
      "paragraphs": [
        "Tanggal lahir, waktu lahir, tempat lahir, jenis kelamin, dan nama yang digunakan untuk perhitungan kompatibilitas **tidak disimpan di mana pun.** Informasi tersebut hanya digunakan dalam memori server selama pemrosesan permintaan dan akan hilang bersama dengan respons.",
        "Tidak dicatat dalam basis data, dan tidak disimpan dalam file terpisah. Karena tidak ada pendaftaran anggota, nilai yang dimasukkan tidak terhubung dengan individu tertentu."
      ]
    },
    {
      "heading": "2. Informasi yang Termasuk dalam Tautan Hasil",
      "paragraphs": [
        "Alamat layar hasil mencakup nilai yang dimasukkan dalam bentuk yang terenkode. Namun, nilai ini terletak setelah # di alamat, dan menurut standar web, konten setelah # tidak dikirimkan oleh browser ke server. Oleh karena itu, meskipun tautan hasil dibuka, catatan akses server hanya menyimpan jalur alamat.",
        "Jika tautan hasil dikirimkan kepada orang lain, orang tersebut juga dapat melihat hasil yang sama. Tautan itu sendiri menyimpan nilai yang dimasukkan, jadi keputusan untuk membagikannya adalah tanggung jawab pengguna."
      ]
    },
    {
    ...
    },
    {
      "heading": "5. Informasi yang Disimpan Saat Pembayaran",
      "paragraphs": [
        "Ketika melakukan pembayaran untuk produk berbayar (laporan kompatibilitas PDF), informasi pesanan disimpan untuk pemrosesan pembayaran dan penyimpanan catatan transaksi sesuai dengan hukum.",
      ...
      "bullets": [
        ...
        "Jumlah pembayaran, mata uang, dan status pembayaran (belum dibayar, pembayaran selesai, dibatalkan)",
        "Klasifikasi produk, status pemrosesan, jumlah unduhan dokumen, waktu pemesanan",
        "Bahasa layar saat pemesanan dan klasifikasi wilayah pembayaran (domestik, internasional)",
        "Periode penyimpanan — Sesuai dengan Pasal 6 Undang-Undang Perlindungan Konsumen dalam Transaksi Elektronik, catatan pembayaran dan penyediaan barang akan disimpan selama 5 tahun, dan catatan keluhan atau sengketa konsumen akan disimpan selama 3 tahun sebelum dihancurkan."
      ]
    },
    {
      "heading": "6. Penyediaan dan Penanganan Pihak Ketiga",
      "paragraphs": [
    ...
    },
    {
      "heading": "10. Perubahan Kebijakan",
      "paragraphs": [
        "Jika kebijakan ini diubah, tanggal mulai dan isi perubahan akan diposting di halaman ini. Jika ada perubahan nyata dalam konten pemrosesan, seperti mulai menampilkan iklan atau menjual produk berbayar, kami akan memberi tahu terlebih dahulu tentang perubahan tersebut."
      ]
    }
  ],
  "effectiveLabel": "Tanggal Berlaku"
...
const d6 = {
  ...
  "intro": "Ketentuan ini menetapkan syarat penggunaan layanan InyeonLink (selanjutnya disebut \"layanan\"). Dengan menggunakan layanan ini, Anda dianggap telah menyetujui ketentuan ini.",
  "sections": [
    {
      "heading": "1. Sifat Layanan",
      "paragraphs": [
        "Layanan ini menunjukkan hubungan antara dua orang berdasarkan tanggal lahir yang dimasukkan dengan menerapkan aturan hubungan tradisional saju (사주) dan zodiak Korea (띠).",
    ...
    },
    {
      ...
      "paragraphs": [
        ...
        "Menerima hasil dalam bentuk laporan PDF adalah berbayar. Harga dan syarat akan ditampilkan di bagian 3 di bawah ini dan di layar pembayaran."
      ]
    },
    {
      "heading": "3. Produk Berbayar dan Pengembalian Dana",
      "paragraphs": [
        "Produk berbayar yang dijual adalah **laporan kecocokan PDF**. Hasil di layar akan dibuat menjadi dokumen PDF sebanyak 3 halaman, dan akan mencakup nilai kekuatan elemen yang tidak ditampilkan di layar.",
        "Harga untuk pembayaran domestik adalah {priceDomestic} (termasuk PPN), dan untuk pembayaran internasional adalah {priceGlobal}. Pembayaran domestik dapat dilakukan melalui Toss Payments menggunakan kartu kredit/debit dan pembayaran mudah (Toss Pay, Kakao Pay, Naver Pay, Payco, dll.), sedangkan pembayaran internasional dilakukan melalui PayPal melalui PortOne. Jumlah akhir mengikuti jumlah yang ditampilkan di layar pembayaran.",
        ...
        "Untuk kasus di mana unduhan terhenti atau file hilang, file dapat diunduh kembali **hingga 5 kali** dengan pesanan yang sama. Namun, jika input hilang setelah keluar dari layar hasil, file tidak dapat dibuat kembali, jadi harap simpan file segera setelah pembayaran."
      ],
      "bullets": [
    ...
    },
    {
      ...
      "paragraphs": [
        "Semua skor dihitung berdasarkan aturan yang dipublikasikan, sehingga jika nilai yang sama dimasukkan, hasilnya akan selalu sama.",
        "Jika waktu lahir tidak dimasukkan, perhitungan akan dilakukan tanpa shiji (시주), sehingga hasilnya dapat berbeda. Semakin akurat tempat lahir yang dipilih, semakin tepat perhitungan shiji.",
        "Perhitungan manse (万岁) menggunakan pustaka perhitungan yang dipublikasikan, dan hasil dapat berbeda tergantung pada cara penanganan solar term dan zona waktu."
      ]
    },
    {
      "heading": "5. Tanggung Jawab Pengguna",
    ...
    },
    {
      ...
      "bullets": [
        ...
        "Menyajikan hasil layanan seolah-olah merupakan fakta atau hasil penilaian dari seorang ahli",
        "Menggandakan atau memodifikasi layanan untuk menyediakan layanan yang sama"
      ]
    },
    {
...
const d7 = {
  "title": "Kebijakan Pengolahan Data Pribadi",
  "intro": "InyeonLink tidak menyimpan informasi yang diperlukan untuk perhitungan kompatibilitas. Kebijakan ini menjelaskan apa yang diterima oleh layanan, apa yang tidak disimpan, dan apa yang secara otomatis dicatat.",
  "sections": [
    {
      "heading": "1. Informasi yang Tidak Disimpan",
      "paragraphs": [
    ...
    },
    {
      ...
      "paragraphs": [
        ...
        "Jika tautan hasil dikirimkan kepada orang lain, orang tersebut juga dapat melihat hasil yang sama. Tautan itu sendiri mengandung nilai yang dimasukkan, jadi keputusan untuk membagikannya adalah tanggung jawab pengguna."
      ]
    },
    {
      "heading": "3. Informasi yang Dikumpulkan Secara Otomatis",
    ...
    },
    {
      "heading": "7. Hak Pengguna",
      "paragraphs": [
        "Karena nilai yang dimasukkan untuk perhitungan kompatibilitas tidak disimpan, tidak ada pihak yang dapat diminta untuk melihat, mengoreksi, atau menghapus. Catatan pesanan yang tersisa akibat pembayaran memiliki kewajiban untuk disimpan selama periode yang ditentukan oleh hukum, sehingga tidak dapat dihapus selama periode tersebut, dan setelah periode berakhir, akan dihancurkan.",
        "Pengguna dapat menghapus semua jejak input hanya dengan menghapus tautan hasil di bilah alamat browser.",
        "Jika ada pertanyaan terkait penggunaan layanan, silakan beri tahu kami melalui kontak di bawah ini."
      ]
    },
    ...
    },
    {
      "heading": "10. Perubahan Kebijakan",
      "paragraphs": [
        "Jika kebijakan ini diubah, tanggal mulai dan rincian perubahan akan diposting di halaman ini. Jika ada perubahan yang benar-benar mempengaruhi konten pemrosesan, seperti mulai menampilkan iklan atau menjual produk berbayar, kami akan memberi tahu terlebih dahulu tentang perubahan tersebut."
      ]
    }
  ],
  "effectiveLabel": "Tanggal Berlaku"
