...
export const ES_DOCS = {
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "p": "Inyeon-Link construye dos cartas natales a partir de las fechas y horas de nacimiento y muestra **cómo se encuentran los dos conjuntos de energías.** También puedes leer tu propia carta por separado y ver qué temperamentos tienden a ser adecuados para ti."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Las cartas se construyen a partir del **calendario lunisolar coreano**, y la hora de nacimiento se corrige a **tiempo solar verdadero** para el lugar de nacimiento — la misma hora del reloj significa una posición solar diferente dependiendo de dónde naciste."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          {
            "ul": [
              "**No contamos fortunes.** Nada aquí te dice que persigas o evites a alguien. Es una referencia extraída de una tradición.",
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "p": "La tasa de coincidencia proviene de dos ramas. **La compatibilidad del saju** considera toda la carta original del saju de ambos individuos, mientras que **la compatibilidad zodiacal** solo considera una rama terrestre del año de nacimiento. El valor final se obtiene promediando ponderadamente los dos."
          },
          {
            "table": {
              "head": [
      ...
      },
      {
        ...
        "blocks": [
            ...
            "table": {
              ...
              "rows": [
                ...
                [
                  ...
                  "¿Las ramas del día (日支) de las dos personas son una combinación o un choque?",
                  "{weightDayBranch}"
                ]
              ]
            }
          ...
          {
            "p": "La rama del día se lee porque la tradición la trata como el **palacio del cónyuge**. De los cuatro pilares, es el que apunta al compañero, lo que lo convierte en el primer lugar que la compatibilidad examina."
          }
        ]
      },
      {
        "title": "Si el género no se divulga, se omite el elemento del cónyuge",
        "blocks": [
          {
            "p": "El elemento del cónyuge requiere conocimiento del género para el cálculo. La tradición lee la posición que apunta a un cónyuge de manera diferente dependiendo del género. Si no se divulga, este ítem será **excluido** y los pesos de los tres ítems restantes serán renormalizados."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Si las posiciones faltantes se tratan como 0 puntos, la puntuación se reducirá injustamente simplemente porque no se divulgó el género. La renormalización de los pesos previene este problema."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          {
            "p": "Si conoces la hora, por favor selecciona también el lugar de nacimiento. Si la hora estándar difiere de la posición solar real, usarla tal cual puede desalinear el pilar de la hora [(corrección de la hora solar verdadera)](/guide/true-solar-time)."
          }
        ]
      },
      {
  ...
  "guide/branches": {
    ...
    "summary": "Esta es una tabla de relaciones utilizada tanto para la compatibilidad de ramas del día como para la compatibilidad zodiacal. Revela completamente lo que cada combinación, choque y discordia significa y sus respectivas puntuaciones.",
    "backLabel": "Base de Cálculo",
    "sections": [
      {
        ...
        "blocks": [
          ...
          {
            "p": "En saju, cada uno de los cuatro pilares tiene una rama terrestre. Inyeon-Link utiliza la **rama del día** (el palacio del cónyuge) y la **rama del año** (el animal del zodiaco) entre ellas. Ambas posiciones se evalúan utilizando la tabla de relaciones a continuación."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "table": {
              ...
              "rows": [
                ...
                [
                  "Triada parcial (半合)",
                  "Dos caracteres que incluyen una rama real (王地) del triada (子·酉·午·卯)",
                  "Una combinación a medio que incluye el carácter en el centro de la formación. No puede formar una combinación completa con solo dos caracteres, lo que la hace inferior a una triada completa.",
                  "{scoreBanhap}"
                ],
                [
                ...
                [
                  ...
                  "子未 · 丑午 · 寅酉 · 卯申 · 辰亥 · 巳戌",
                  "Pares que no pueden separarse a pesar de albergar resentimiento. Aparecen tranquilos en la superficie, pero se consideran duraderos.",
                  "{scoreWonjin}"
                ],
                [
                  "Choque (沖)",
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Una triada completa requiere tres caracteres para formarse. Sin embargo, la compatibilidad se estructura emparejando las ramas terrestres de dos personas **una por una**, resultando en solo dos caracteres. Por lo tanto, lo que aparece aquí es siempre una triada parcial, y los puntos de triada completa {scoreSamhap} se reservan para cuando se examinan las formaciones dentro de cada saju."
          }
        ]
      },
      {
        "kind": "note",
        "title": "Las triadas parciales deben incluir una rama real",
        "blocks": [
          {
            "p": "También hay un método que cuenta como una triada parcial si ambos caracteres pertenecen al mismo grupo de triada. Esto puede llevar a altas puntuaciones incluso para combinaciones que son difíciles de llamar triada, como 申辰. Por lo tanto, este servicio reconoce una triada parcial solo para pares que incluyen una rama real (王地) (子·酉·午·卯), y combinaciones como 申辰·巳丑·寅戌·亥未 sin una rama real no se cuentan como triadas."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Los seis pares de discordia silenciosa se ven tan frecuentemente en compatibilidad como los choques. Si contamos combinaciones como pares y choques, estos seis pares quedarían todos enterrados bajo puntos neutrales {scoreNeutral}, por lo que se colocan por separado."
          },
          {
            "p": "Mientras que los choques son evidentes y llamativos, la discordia silenciosa está sutilmente desalineada. Por lo tanto, se coloca en una puntuación de {scoreWonjin}, que es más alta que los choques ({scoreChung}) pero definitivamente más baja que lo neutral ({scoreNeutral})."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "La puntuación más baja de choque es {scoreChung}. La intención no es asignar un valor cercano a 0. En la tradición, un choque no es un 'fin' sino una 'colisión', y asignar una puntuación baja implicaría que el servicio está haciendo una declaración definitiva sobre la relación."
          },
          {
  ...
  "guide/zodiac": {
    "eyebrow": "Zodiaco",
    "title": "¿Por qué la compatibilidad zodiacal considera la rama del año?",
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "p": "El saju consiste en cuatro pilares: año, mes, día y hora, con cada pilar conteniendo un tallo celestial y una rama terrestre. La **rama del año** es la que lleva el animal que llamamos signo zodiacal."
          },
          {
            "table": {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Por eso solo recopilamos la fecha de nacimiento sin preguntar por el zodiaco en la pantalla de entrada. Cuando el motor de saju calcula la rama del año, el límite de Ipchun se ajusta automáticamente. Si lo seleccionas directamente, alguien nacido a principios de febrero puede elegir un zodiaco que no coincide con el suyo real."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "El cálculo de la compatibilidad zodiacal es simple. Compara las ramas del año de dos personas para determinar si la relación es armoniosa, un choque o una discordia tranquila, y utiliza esa puntuación tal como está. Dado que solo hay un ítem, no es necesario distribuir pesos."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "La compatibilidad zodiacal representa {weightZodiac} de la tasa final de coincidencia. Mientras que la compatibilidad del saju observa los cuatro pilares, el zodiaco solo considera un carácter, por lo que no pueden ser ponderados igualmente."
          },
          {
  ...
  "guide/ten-gods": {
    ...
    "summary": "Observamos qué tallo del día tiene cada persona respecto a la otra a través de los Diez Dioses. Explicamos por qué la riqueza directa y la riqueza indirecta se leen de manera diferente a pesar de que ambas son riqueza.",
    "backLabel": "Base de Cálculo",
    "sections": [
      {
        ...
        "blocks": [
          {
            "p": "Entre los ocho caracteres del saju, el **tronco del día** (el tronco celestial del día de nacimiento) se refiere a la persona misma. Los otros siete caracteres se leen como el entorno en el que se encuentra ese tronco del día."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Hay un método para ver la relación del tronco del día con los tres elementos (generación mutua, igualdad, superación mutua). Es simple, pero **el yin y el yang desaparecen.** 甲 (madera yang) y 乙 (madera yin) se convierten en la misma 'igualdad' como 甲 y 甲, y la superación mutua se aplasta en una única puntuación sin dirección o yin y yang."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "En la tradición, cuál de los Diez Dioses representa a un cónyuge varía según el género."
          },
          {
            "table": {
              "head": [
  ...
  "guide/yongsin": {
    ...
    "summary": "Vemos los cinco elementos no como '¿eligieron dos?' sino como '¿tiene la contraparte lo que necesito?'. También divulgamos el valor límite que distingue a un día maestro fuerte de uno débil.",
    "backLabel": "Base de cálculo",
    "sections": [
      {
        "title": "Si los cinco elementos están 'balanceados' no es una cuestión de compatibilidad",
        "blocks": [
          {
          ...
          {
            "p": "El grado de balance es simétrico, pero la complementariedad es inherentemente asimétrica. Esto se debe a que lo que A necesita es diferente de lo que B necesita. Por lo tanto, medimos cada lado por separado y promediamos — dado que es un promedio, la puntuación total permanece simétrica."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "El Elemento de Apoyo (用神) es 'la energía que esta persona necesita en este momento'. Hay varios métodos para determinarlo (suprimir, apoyar, enfermedad y comunicación), pero puede traducirse en reglas, y el más utilizado es **suprimir (抑扶)**. Si el día maestro es fuerte, se considera que se necesita energía para reducir, y si es débil, se necesita energía para añadir."
          },
          {
            "table": {
              "head": [
      ...
      {
        "title": "Valores umbral para fuerza y debilidad",
        "blocks": [
          {
            "p": "El lado del tallo del día es **印星 y 比劫** — la energía que me da vida y la energía que es como yo. Dado que son dos de cinco, si la energía está completamente balanceada, se convierte en {evenAllyRatio}. Se establece un rango por encima y por debajo de ese valor."
          },
          {
            "table": {
      ...
      {
        "kind": "note",
        "title": "El balance es un 'juicio menos cierto'",
        "blocks": [
          {
            "p": "El balance significa que no puede ser cubierto por el elemento de apoyo. En este momento, simplemente vemos las dos energías más delgadas como necesarias. En la pantalla de resultados, se anota como 'actualmente en una posición delgada' en lugar de una declaración definitiva."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Al contar el poder de los cinco elementos, no simplemente contamos los ocho caracteres tal como aparecen. Usamos un valor que refleja los tallos celestiales ocultos (地藏干) dentro de las ramas terrenales y la temporada de la energía del mes (月令) en el que uno nació."
          },
          {
            "p": "Si solo contamos los caracteres superficiales, perdemos el hecho de que incluso dos caracteres de 木 pueden tener fuerzas completamente diferentes dependiendo de la temporada. El 木 de primavera y el 木 de otoño, aunque son el mismo carácter, tienen diferentes poderes."
          }
        ]
      },
      {
        "title": "Puntuando el grado de llenado",
        "blocks": [
          {
            "p": "Observamos la proporción de mi elemento de apoyo en el poder del oponente. Sin embargo, no usamos esa proporción directamente, sino que **dividimos la expectativa por el tamaño del elemento de apoyo.** Cuando es fuerte, el elemento de apoyo es tres (expectativa 60%), y cuando es débil, es dos (expectativa 40%), por lo que usar la proporción directamente significaría que una persona fuerte siempre recibe una puntuación más alta."
          },
          {
            "p": "Si se llena al nivel esperado, se obtiene una puntuación cercana a 78 puntos, y si se llena mucho más, alcanza 100 puntos, mientras que si falta significativamente, se dirige hacia 55 puntos. Aquí, también, el mínimo no se establece en 0."
          }
        ]
      },
      {
  ...
  "guide/affinity": {
    ...
    "summary": "Solo tomamos los datos de una persona mientras dejamos la posición del oponente vacía y sustituimos todos los valores posibles en esa posición. Explicamos la razón por la que no se adjunta una puntuación total al tipo obtenido de esta manera.",
    "backLabel": "Base de cálculo",
    "sections": [
      {
        "title": "Los cálculos se realizan dejando la posición del oponente vacía",
        "blocks": [
          {
            "p": "Las puntuaciones de compatibilidad se calculan emparejando a dos personas. **Inyeon’s Match** solo toma los datos de una persona mientras deja la posición del oponente vacía y prueba todos los valores posibles que podrían entrar en esa posición. Es como ejecutar el motor de compatibilidad al revés."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "p": "En las personas reales, el day master y los cinco elementos no operan por separado. Una persona con 甲木 generalmente tiene una fuerte energía de 木 también. Este método de contar branches por separado ignora esa correlación, por lo que el valor obtenido al conectar las puntuaciones más altas para cada branch se convierte en una combinación que no existe en la realidad."
          },
          {
            "p": "Por lo tanto, la pantalla solo muestra **puntuaciones de elementos** y no proporciona una puntuación total. La puntuación total se calculará al recibir la fecha de nacimiento de la otra persona para [compatibilidad saju](/compatibility)."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "El resultado significa 'si conoces a una persona de este tipo, este elemento puntuará alto'. No es un criterio para elegir a una persona, sino más bien una forma de leerlo desde una perspectiva de entendimiento de mí mismo."
          },
          {
            "p": "Las razones por las que ciertos tipos puntuaron alto también se anotan elemento por elemento — si el day master está en una posición favorable, o si esa persona posee la energía que actualmente necesito."
          }
        ]
      },
      {
    ...
    "sections": [
      {
        ...
        "blocks": [
          ...
          {
            "p": "La hora estándar de Corea se basa en 135° de longitud este. Dado que la longitud de Seúl es de aproximadamente 127°, está aproximadamente 8° al oeste, lo que provoca que el sol alcance su cenit más tarde: cuando es mediodía en el reloj, el sol en Seúl aún no ha alcanzado su cenit. Esta diferencia es de aproximadamente **32 minutos**."
          }
        ]
      },
      {
        "kind": "note",
        "title": "32 minutos cambian el pilar de tiempo por un slot",
        "blocks": [
          {
            "p": "El tiempo en saju se divide en unidades de dos horas. Aquellos nacidos cerca del límite tendrán su pilar de tiempo completamente cambiado por una diferencia de 32 minutos: esta corrección es necesaria debido a aquellos que caen exactamente en este límite."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          {
            "p": "En lugares donde la longitud varía considerablemente incluso dentro del mismo país (como EE. UU., Rusia, Indonesia, etc.), las ciudades se han dividido. **15° de longitud equivale a un slot de pilar de tiempo**."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "p": "Inyeon-Link no utiliza un valor fijo para el meridiano estándar, sino que calcula la hora estándar que realmente se utilizó en ese momento basado en la información de **zona horaria IANA** del lugar de nacimiento. El horario de verano y las horas estándar pasadas se reflejan automáticamente."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Dado que la corrección es de -32 minutos, aquellos nacidos entre 00:00 y 00:32 según el reloj serán **23:00 del día anterior** en tiempo solar verdadero. Si solo se revierte la hora y se deja la fecha sin cambios, se escribirá el pilar del día como '23:00 del día anterior'."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "La hora de nacimiento es opcional. Si no la conoces, el cálculo se realizará sin el pilar de tiempo, y este hecho se mostrará en la pantalla de resultados. No hay elementos en la compatibilidad que requieran que el pilar de tiempo se escriba directamente, pero sí influye en los cinco elementos, así que si lo conoces, es más preciso incluirlo."
          },
          {
            "p": "La compatibilidad zodiacal es siempre el mismo valor independientemente de la hora — [porque solo mira el año de la rama](/guide/zodiac)."
          }
        ]
      }
    ]
  ...
  "guide/no-storage": {
    ...
    "title": "Método para no almacenar información ingresada",
    "summary": "Esto explica lo que significa técnicamente que tu fecha de nacimiento no se registre en ningún lado y qué se incluye en el enlace de resultados.",
    "backLabel": "Base de Cálculo",
    "sections": [
      {
        ...
        "blocks": [
          {
            "p": "Inyeon-Link no crea cuentas. No recopila nombres, correos electrónicos ni números de teléfono. La única información recopilada es la fecha de nacimiento y (opcionalmente) la hora de nacimiento, lugar de nacimiento y género, y ni siquiera eso permanece después de que se complete el cálculo."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "El cálculo en sí se realiza en el servidor. Se necesita el the Korean lunisolar almanac (almanac lunisolar coreano) para generar el saju, y esa tabla es demasiado grande para enviarse al navegador. Sin embargo, **después de procesar la solicitud, ese valor no se utiliza en ningún lugar.** No hay código para almacenarlo en una base de datos."
          },
          {
            "p": "Se mantiene un registro mínimo necesario para la operación — un contador para evitar que la misma persona envíe demasiadas solicitudes en poco tiempo. Esto no incluye la fecha de nacimiento, y la IP de acceso tampoco se retiene. Solo se cuenta un valor, hashado con la fecha, y ese valor cambia cuando cambia el día."
          }
        ]
      },
      {
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "p": "Los cálculos de compatibilidad y las consultas de resultados son **gratuitos**. Las tasas de coincidencia, las puntuaciones y pesos de los ítems, los gráficos originales de saju de ambas personas, y la forma de la relación se pueden ver en la pantalla. Nada ha sido eliminado de la pantalla mientras se crea el informe de pago."
          },
          {
            "p": "El propósito del informe es **agregar capas que no están en la pantalla**. Y esa capa no es fabricada; consiste en valores que ya fueron calculados durante el proceso de puntuación pero que no se utilizaron en la pantalla."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Pago nacional {priceGunghapDomestic} (incluyendo IVA), pago internacional {priceGunghapGlobal}. A4 {pagesGunghap} páginas."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "p": "La complementariedad es inherentemente **asimétrica**. Esto se debe a que las energías que necesito y las energías que necesita el otro son diferentes. Si solo miras el promedio, una relación donde un lado llena al otro significativamente y una relación donde ambos se llenan mutuamente de manera equitativa aparecerán como el mismo número. El informe separa esos dos."
          },
          {
            "p": "También se incluye en la misma sección el **gráfico de relaciones de los cuatro pilares**. El único que entra en la tasa de coincidencia es la rama del día (日支) — porque es la posición del cónyuge — pero las otras ramas de año, mes y hora también pueden leerse con el mismo gráfico de relaciones."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Si se incluyera, la puntuación total cambiaría y no coincidiría con el enlace de resultado ya enviado. Por lo tanto, se incluye solo como material de lectura, y ese hecho se indica debajo de la tabla."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          {
            "p": "Puedes ver las fuerzas antes y después de multiplicar por la energía del mes lado a lado, mostrando cuánto la temporada la ha impulsado. La **proporción de aliados** que distingue entre un día maestro fuerte y un día maestro débil también se indica — la pantalla solo muestra el juicio, pero el informe muestra dónde se tomó ese juicio."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "La tasa de coincidencia solo compara los **troncos del día** de ambos individuos. Sin embargo, los otros tres pilares de la otra persona también son determinados por los Diez Dioses usando las mismas reglas. Si bien puedes entender **lo que esta persona significa para mí** mirando solo el tronco del día, no puedes saber **qué posición de esa persona significa para mí**."
          },
          {
    ...
    "sections": [
      {
        ...
        "blocks": [
          ...
          {
            "p": "Las consultas telefónicas se pueden realizar al {customerCenter}."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "ul": [
              ...
              "**Proveedor de Alojamiento** — {hostingProvider}"
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "No es necesario incluir tu fecha y hora de nacimiento en el correo de consulta. No guardamos las entradas, por lo que no podemos recuperarlas, y el número de pedido es suficiente para la confirmación. Por favor, inclúyelo solo si es necesario para un informe de error de cálculo."
          }
        ]
      }
    ]
...
export const ES_NOTICES = {
  ...
  "items": {
    "2026-08-02-contact": {
      ...
      "body": [
        "Preguntas, reembolsos, solicitudes de privacidad e informes de errores de cálculo ahora tienen un lugar al que ir — consulta la página de contacto en el pie de página.",
        "Si algo parece mal calculado, por favor incluye los detalles de nacimiento que lo produjeron. No almacenamos lo que ingresas, así que sin ellos no podemos reproducir la lectura."
      ]
    },
    "2026-08-01-pdf-language": {
      "title": "Los informes se emiten en inglés para árabe y jemer",
      "body": [
        "Si estás leyendo en árabe o jemer, el informe PDF que compras se produce en inglés. La herramienta que organiza nuestros documentos aún no puede establecer párrafos en esos guiones.",
        "La pantalla permanece en tu idioma, y tu nombre se imprime en tu propio guion dentro del informe.",
    ...
    "2026-08-01-engine-version": {
      ...
      "body": [
        ...
        "Si cambiamos las reglas de interpretación de una manera que pueda mover un puntaje, lo publicamos aquí primero, con la fecha en que entra en vigor — porque un enlace de resultado que ya posees podría leerse de manera diferente.",
