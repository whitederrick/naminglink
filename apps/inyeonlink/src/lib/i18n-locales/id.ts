...
export const id: Dictionary = {
  ...
  reportDetail: {
    ...
    supplyHint: "Nilai Lima Unsur adalah rata-rata dua arah. Rata-rata menyembunyikan siapa memasok siapa. Di sini kami memisahkannya — ada pasangan yang hanya satu sisinya tercukupi.",
    supplyReceiveLabel: "Seberapa banyak {name} tercukupi",
    needsLabel: "Yang dibutuhkan saat ini",
    bondTitle: "Ikatan antara kedua Penguasa Hari",
    depthTitle: "Melihat lebih dekat bagan masing-masing",
    vitalityTitle: "Apa yang didorong oleh musim",
    vitalityHint: "Batang menunjukkan seberapa banyak tiap unsur ada. Tabel ini menunjukkan apakah bulan kelahiran mendorongnya. Jumlah yang sama bekerja lain di Wang dan di Sa.",
    vitalities: {
      WANG: { name: "Wang (旺)", body: "pada puncaknya" },
      SANG: { name: "Sang (相)", body: "berikutnya menanjak" },
      HYU: { name: "Hyu (休)", body: "beristirahat setelah gilirannya" },
      SU: { name: "Su (囚)", body: "terkurung, sulit bergerak" },
      SA: { name: "Sa (死)", body: "pada titik terlemah" },
    },
    seasonBoostTitle: "Seberapa besar bulan mengangkatnya",
    rawLabel: "Sebelum bulan",
    strengthLabel: "Sesudah bulan",
    earthSeasonNote: "Lahir pada bulan peralihan (辰未戌丑), sehingga Tanah juga dianggap sedang memuncak.",
    allyRatioLabel: "Porsi pihak Penguasa Hari",
    allyRatioHint: "Sumber ditambah Sejawat, terhadap keseluruhan. Di atas 45% dianggap kuat, di bawah 35% lemah. Angkanya kami cantumkan agar Anda melihat di mana batasnya jatuh.",
    pillarsTitle: "Tempat keempat pilar bertemu",
    pillarsHint: "Hanya cabang Hari yang masuk ke tingkat kecocokan — itulah tempat pasangan. Tiga pilar lain dapat dibaca dengan tabel yang sama, jadi kami sertakan.",
    branchRelations: {
      SAMHAP: "Harmoni tiga",
      BANHAP: "Setengah harmoni",
      YUKHAP: "Harmoni enam",
      SAME: "Cabang sama",
      NEUTRAL: "Tanpa hubungan",
      WONJIN: "Dendam terpendam",
      CHUNG: "Benturan",
    },
    pillarColumn: "Pilar",
    relationColumn: "Hubungan",
    relationScoreColumn: "Nilai",
    tenGodColumn: "Sepuluh Dewa",
    stemGodsTitle: "Apa arti setiap pilarnya bagi Anda",
    stemGodsHint: "Tingkat kecocokan hanya membandingkan Penguasa Hari. Aturan yang sama menetapkan Dewa untuk pilar-pilarnya yang lain — terlihat bagian mana dari orang itu yang berarti apa bagi Anda.",
    seesLabel: "Dilihat oleh {from}",
    notScoredNote: "Nilai pada tabel ini tidak masuk ke tingkat kecocokan. Dicantumkan agar Anda dapat membandingkan kekuatannya.",
    appendixTitle: "Begini bagan ini dihitung",
    timeCorrectionLabel: "Waktu lahir",
    timeCorrectionApplied: "Dikoreksi ke waktu matahari sejati dan dibaca sebagai {time}.",
    timeCorrectionNone: "Waktu lahir tidak diisi, sehingga pilar Jam tidak disertakan.",
    timeCorrectionDateShift: "Koreksi memindahkan tanggal ke {date}; pilar Hari diambil dari hari itu.",
    calendarLabel: "Tanggal yang dipakai menyusun bagan",
    solarLabel: "Masehi",
    lunarLabel: "Imlek",
    lunarUnavailable: "Hari ini tidak ada dalam tabel almanak, sehingga tanggal Imlek tidak dapat dicantumkan.",
  },
  footer: {
    privacy: "Privasi",
    terms: "Ketentuan",
