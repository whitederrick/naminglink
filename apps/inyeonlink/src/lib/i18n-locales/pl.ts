...
export const pl: Dictionary = {
  ...
  reportDetail: {
    ...
    supplyHint: "Wynik Pięciu Żywiołów to średnia dwóch kierunków. Średnia ukrywa, kto kogo uzupełnia. Tutaj je rozdzielamy — bywają pary, w których tylko jedna strona jest dobrze zaopatrzona.",
    supplyReceiveLabel: "Ile otrzymuje {name}",
    needsLabel: "Czego teraz potrzeba",
    bondTitle: "Więź między dwoma Panami Dnia",
    depthTitle: "Bliższe spojrzenie na każdy wykres",
    vitalityTitle: "Co popycha pora roku",
    vitalityHint: "Paski pokazują, ile jest każdego żywiołu. Ta tabela pokazuje, czy miesiąc urodzenia go popycha. Ta sama ilość działa inaczej przy Wang, a inaczej przy Sa.",
    vitalities: {
      WANG: { name: "Wang (旺)", body: "u szczytu" },
      SANG: { name: "Sang (相)", body: "następny we wzroście" },
      HYU: { name: "Hyu (休)", body: "odpoczywa po swojej kolei" },
      SU: { name: "Su (囚)", body: "zamknięty, trudno mu się ruszyć" },
      SA: { name: "Sa (死)", body: "najsłabszy" },
    },
    seasonBoostTitle: "O ile podniósł go miesiąc",
    rawLabel: "Przed miesiącem",
    strengthLabel: "Po miesiącu",
    earthSeasonNote: "Urodzenie w miesiącu przejściowym (辰未戌丑), więc Ziemię również uznano za dominującą.",
    allyRatioLabel: "Udział strony Pana Dnia",
    allyRatioHint: "Zasób plus Równi, w stosunku do całości. Powyżej 45% to silny Pan Dnia, poniżej 35% słaby. Podajemy liczbę, aby widzieli Państwo, gdzie zapadł werdykt.",
    pillarsTitle: "Tam, gdzie spotykają się cztery filary",
    pillarsHint: "Do dopasowania wchodzi tylko gałąź Dnia — to miejsce małżonka. Pozostałe trzy filary czyta się tą samą tabelą, więc je dołączamy.",
    branchRelations: {
      SAMHAP: "Potrójna harmonia",
      BANHAP: "Półharmonia",
      YUKHAP: "Sześciokrotna harmonia",
      SAME: "Ta sama gałąź",
      NEUTRAL: "Brak relacji",
      WONJIN: "Skrywana uraza",
      CHUNG: "Zderzenie",
    },
    pillarColumn: "Filar",
    relationColumn: "Relacja",
    relationScoreColumn: "Punkty",
    tenGodColumn: "Dziesięciu Bogów",
    stemGodsTitle: "Czym jest dla Państwa każdy jego filar",
    stemGodsHint: "Dopasowanie porównuje tylko Panów Dnia. Ta sama reguła wyznacza Boga również dla pozostałych filarów — widać, która część tej osoby jest czym dla Państwa.",
    seesLabel: "Z perspektywy {from}",
    notScoredNote: "Punkty w tej tabeli nie wchodzą do dopasowania. Podajemy je, aby można było porównać natężenie.",
    appendixTitle: "Tak obliczono ten wykres",
    ...
    timeCorrectionNone: "Nie podano godziny urodzenia, więc filar Godziny pominięto.",
    timeCorrectionDateShift: "Korekta przesunęła datę na {date}; filar Dnia wzięto z tego dnia.",
    calendarLabel: "Data, z której sporządzono wykres",
    solarLabel: "Słoneczna",
    lunarLabel: "Księżycowa",
    lunarUnavailable: "Tego dnia brakuje w tabeli almanachu, więc nie udało się podać daty księżycowej.",
  },
  footer: {
    privacy: "Prywatność",
    terms: "Regulamin",
