...
export const it: Dictionary = {
  ...
  affinity: {
    ...
    submitNoAd: "Controlla il profilo di affinità",
  ...
  reportDetail: {
    ...
    supplyHint: "Il punteggio dei Cinque Elementi è la media di due direzioni. Una media nasconde chi nutre chi. Qui le separiamo: in alcune coppie solo un lato è ben rifornito.",
    supplyReceiveLabel: "Quanto riceve {name}",
    needsLabel: "Ciò che serve ora",
    bondTitle: "Il legame tra i due Padroni del Giorno",
    depthTitle: "Uno sguardo più attento a ciascun tema",
    vitalityTitle: "Ciò che la stagione spinge avanti",
    vitalityHint: "Le barre mostrano quanto c'è di ogni elemento. Questa tabella mostra se il mese di nascita lo spinge. La stessa quantità rende diversamente a Wang e a Sa.",
    vitalities: {
      WANG: { name: "Wang (旺)", body: "al culmine" },
      SANG: { name: "Sang (相)", body: "il successivo in ascesa" },
      HYU: { name: "Hyu (休)", body: "a riposo dopo il suo turno" },
      SU: { name: "Su (囚)", body: "rinchiuso, difficile da muovere" },
      SA: { name: "Sa (死)", body: "al minimo" },
    },
    seasonBoostTitle: "Di quanto il mese l'ha sollevato",
    rawLabel: "Prima del mese",
    strengthLabel: "Dopo il mese",
    earthSeasonNote: "Nascita in un mese di transizione (辰未戌丑): anche la Terra è stata considerata dominante.",
    allyRatioLabel: "Quota del lato del Padrone del Giorno",
    allyRatioHint: "Risorsa più Pari, sul totale. Oltre il 45% è un Padrone del Giorno forte, sotto il 35% debole. Riportiamo la cifra perché veda dove è caduto il verdetto.",
    pillarsTitle: "Dove si incontrano i quattro pilastri",
    pillarsHint: "Nella compatibilità entra solo il ramo del Giorno: è il seggio coniugale. Gli altri tre pilastri si leggono con la stessa tabella, perciò li includiamo.",
    branchRelations: {
      SAMHAP: "Tripla armonia",
      BANHAP: "Mezza armonia",
      YUKHAP: "Sestupla armonia",
      SAME: "Stesso ramo",
      NEUTRAL: "Nessuna relazione",
      WONJIN: "Rancore",
      CHUNG: "Scontro",
    },
    pillarColumn: "Pilastro",
    relationColumn: "Relazione",
    relationScoreColumn: "Punti",
    tenGodColumn: "Dieci Dei",
    stemGodsTitle: "Che cosa è per lei ciascun pilastro dell'altro",
    stemGodsHint: "La compatibilità confronta solo i Padroni del Giorno. La stessa regola fissa un Dio anche per gli altri pilastri: mostra quale parte di quella persona è che cosa per lei.",
    seesLabel: "Visto da {from}",
    notScoredNote: "I punteggi di questa tabella non entrano nella compatibilità. Sono riportati per confrontare l'intensità.",
    appendixTitle: "Come è stato calcolato questo tema",
    timeCorrectionLabel: "Ora di nascita",
    timeCorrectionApplied: "Corretta all'ora solare vera e letta come {time}.",
    timeCorrectionNone: "Non è stata indicata l'ora di nascita, quindi il pilastro dell'Ora è stato escluso.",
    timeCorrectionDateShift: "La correzione ha spostato la data al {date}; il pilastro del Giorno viene da quel giorno.",
    calendarLabel: "Data da cui è stato tratto il tema",
    solarLabel: "Solare",
    lunarLabel: "Lunare",
    lunarUnavailable: "Questo giorno manca nella tabella dell'almanacco, perciò non è stato possibile stampare la data lunare.",
  },
  footer: {
    privacy: "Privacy",
    terms: "Termini",
