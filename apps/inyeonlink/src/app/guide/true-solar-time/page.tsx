  ...
  return (
    ...
    >
      ...
      <GuideSection title="표준시는 과거에 여러 번 바뀌었습니다">
        ...
        />
        <p>
          인연링크는 표준 자오선을 고정값으로 두지 않고, 태어난 곳의 <b>IANA 표준시간대</b>{" "}
      ...
      <GuideSection title="자정 직후 출생은 날짜까지 봅니다">
        ...
        <p>
          인연링크는 이 경우 날짜도 함께 되돌립니다. 일주는 사주에서 그 사람 자신을 가리키는
          자리라, 여기가 어긋나면 궁합의 거의 모든 항목이 어긋납니다.
        </p>
      </GuideSection>
      ...
      <GuideSection title="시각을 모르셔도 됩니다">
        <p>
          ...
          표시합니다. 궁합의 네 항목 가운데 시주를 직접 쓰는 것은 없지만, 오행 세력에는 영향이
          있으므로 아신다면 넣는 편이 정확합니다.
        </p>
        <p>
          띠 궁합은 시각과 무관하게 언제나 같은 값입니다 —{" "}
          <a
