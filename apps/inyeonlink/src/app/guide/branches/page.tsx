  ...
  return (
    ...
    >
      ...
      <GuideSection title="삼합은 이 서비스에서 나오지 않습니다">
        ...
        <GuideNote title="반합의 조건을 좁혔습니다">
          예전에는 같은 삼합 그룹에 둘 다 들어 있기만 하면 반합으로 쳤습니다. 그러면 申辰처럼
          합이라 부르기 어려운 조합까지 높은 점수를 받습니다. 지금은 <b>왕지</b>(子·酉·午·卯)를
          낀 두 글자라야 반합으로 인정하고, 왕지가 빠진 申辰·巳丑·寅戌·亥未는 합으로 치지
          않습니다.
        </GuideNote>
      </GuideSection>
      ...
      <GuideSection title="원진을 따로 둔 이유">
        <p>
          원진 여섯 쌍은 궁합에서 충 못지않게 자주 보는 자리인데, 예전 표에는 없어서 전부
          무관계 {BRANCH_RELATION_SCORE.NEUTRAL}점으로 들어가고 있었습니다.
        </p>
        <p>
