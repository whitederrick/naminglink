...
export default async function Page(props: GuidePageProps) {
  ...
  return (
    ...
    >
      ...
      <GuideSection title="오행 셋으로 보던 것을 바꿨습니다">
        <p>
          예전에는 일간 관계를 오행 셋(상생·같음·상극)으로만 봤습니다. 그러면 <b>음양이 사라집니다.</b>{" "}
          甲(양목)과 乙(음목)이 甲과 甲처럼 똑같은 &ldquo;같음&rdquo;이 되고, 상극은 방향도
          음양도 없이 한 점수로 뭉개집니다.
        </p>
        <p>
          배우자성은 이미 십신으로 음양을 따지고 있었으니 한 엔진 안에 기준이 둘이었던 셈입니다.
          십신으로 통일해 그 어긋남을 없앴습니다.
        </p>
      </GuideSection>
