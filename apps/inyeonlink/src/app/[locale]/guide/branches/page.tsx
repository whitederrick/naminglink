...
/**
 * 십이지 관계표 — 합·충·원진과 그 점수.
 *
 * **본문은 `lib/doc-content`에 있다.** 예전에는 이 파일의 JSX가 한국어 산문을 들고 있었고,
 * 그래서 이 문서는 한 언어짜리였다 — 23개 언어는 이 서비스의 약속인데 안내 층만 예외였다.
 * 숫자는 글에 적지 않고 `doc-values`가 엔진에서 읽어 넘긴다(`docs/I18N_DOC_CONTENT.md`).
 */
