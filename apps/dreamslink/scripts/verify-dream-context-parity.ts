...
const PAIRS: Array<{ id: string; label: string; ko: string; en: string }> = [
  ...
  { id: "liquor", label: "술 — 권함을 받음", ko: "누군가 권하는 술을 받아 마셨다", en: "someone offered me alcohol and I accepted" },
  { id: "liquor", label: "술 — 취함", ko: "술에 취하도록 마셨다", en: "I drank alcohol until I was completely drunk" },
