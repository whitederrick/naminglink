...
const CASES: Case[] = [
  ...
  // seal — 2026-09-09에 새 문맥(印綬改遷生貴子)이 붙으며 여섯 번째로 늘었다
  { id: "seal", text: "임신했는데 도장을 몸에 지니고 있었다", want: "도장을 몸에 지님" },
  { id: "seal", text: "임신했는데 도장의 인끈이 바뀌어 관직이 옮겨갔다", want: "인끈이 바뀌어 관직이 옮겨감" },
];
