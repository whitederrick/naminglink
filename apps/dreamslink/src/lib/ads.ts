...
export const adSlots = {
  /** 해몽 결과 — 제목 아래 머리글. */
  dream_result_header: adSlot("DREAM_RESULT_HEADER", process.env.NEXT_PUBLIC_ADSENSE_SLOT_DREAM_RESULT_HEADER),
  /** 해몽 결과 — 본문 중간. */
  dream_result_inline: adSlot("DREAM_RESULT_INLINE", process.env.NEXT_PUBLIC_ADSENSE_SLOT_DREAM_RESULT_INLINE),
  /** 상징 목록 — 제목 아래 머리글. */
  symbol_list_header: adSlot("SYMBOL_LIST_HEADER", process.env.NEXT_PUBLIC_ADSENSE_SLOT_SYMBOL_LIST_HEADER),
  /** 상징 목록 — 목록 중간. */
  symbol_list_inline: adSlot("SYMBOL_LIST_INLINE", process.env.NEXT_PUBLIC_ADSENSE_SLOT_SYMBOL_LIST_INLINE),
  /** 상징 상세 — 제목 아래 머리글. 215장이 이 자리를 쓴다. */
  symbol_detail_header: adSlot("SYMBOL_DETAIL_HEADER", process.env.NEXT_PUBLIC_ADSENSE_SLOT_SYMBOL_DETAIL_HEADER),
  /** 상징 상세 — 본문 중간. */
  symbol_detail_inline: adSlot("SYMBOL_DETAIL_INLINE", process.env.NEXT_PUBLIC_ADSENSE_SLOT_SYMBOL_DETAIL_INLINE),
} as const;
