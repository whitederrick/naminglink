 ...
 *
 * 한국어 화면이면 국내(토스페이먼츠), 그 외에는 해외(페이팔)다. 접속 국가가 아니라
 * **화면 언어**를 기준으로 삼는 이유는, 이용자가 실제로 보고 있는 가격 표기와 결제
 * 수단이 어긋나지 않게 하기 위해서다(naminglink의 일괄 공개와 같은 규칙).
 *
 ...
 * 쓴다(inyeonlink·sajulink에도 같은 모양으로 뽑았다).
 */
