 ...
 * 생성되지 않음」 139건이 **전부 로케일 붙은 주소**였다. 이 앱은 사이트맵이 1,176개로 넷 중
 * 가장 크고 상징 사전이 실제 발행 콘텐츠라, 같은 자리에서 가장 크게 잃고 있었다.
 *
 ...
 *
 * naminglink `lib/route-locale.ts`와 같은 자리다 — 한쪽만 고치면 두 앱의 주소 규칙이 갈린다.
 */
