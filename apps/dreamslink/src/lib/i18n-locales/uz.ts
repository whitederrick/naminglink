...
export const uz: Dictionary = {
  ...
  affinity: {
    ...
    submitNoAd: "Munosabat natijasini ko'ring",
  ...
  reportDetail: {
    ...
    supplyHint: "Besh unsur bahosi ikki yo'nalishning o'rtachasidir. O'rtacha kim kimni to'ldirayotganini yashiradi. Bu yerda ularni ajratamiz — faqat bir tomoni yaxshi to'ladigan juftliklar ham bor.",
    supplyReceiveLabel: "{name} qanchalik to'ldiriladi",
    needsLabel: "Hozir nima kerak",
    bondTitle: "Ikki Kun egasi o'rtasidagi bog'",
    depthTitle: "Har birining xaritasiga chuqurroq nazar",
    vitalityTitle: "Fasl nimani oldinga suradi",
    vitalityHint: "Ustunchalar har bir unsurdan qanchasi borligini ko'rsatadi. Bu jadval tug'ilgan oy uni oldinga surayotganini ko'rsatadi. Bir xil miqdor Vanda va Sada boshqacha ishlaydi.",
    vitalities: {
      WANG: { name: "Van (旺)", body: "eng yuqori nuqtada" },
      SANG: { name: "San (相)", body: "keyingi ko'tarilishda" },
      HYU: { name: "Xyu (休)", body: "navbatidan keyin dam olmoqda" },
      SU: { name: "Su (囚)", body: "qamalgan, qimirlashi qiyin" },
      SA: { name: "Sa (死)", body: "eng kuchsiz holatda" },
    },
    seasonBoostTitle: "Oy uni qanchalik ko'tardi",
    rawLabel: "Oydan oldin",
    strengthLabel: "Oydan keyin",
    earthSeasonNote: "O'tish oyida (辰未戌丑) tug'ilgan, shu bois Tuproq ham eng yuqori nuqtada deb olindi.",
    allyRatioLabel: "Kun egasi tomonining ulushi",
    allyRatioHint: "Manba va Tengdosh yig'indisining butunga nisbati. 45% dan yuqori bo'lsa kuchli, 35% dan past bo'lsa kuchsiz deb qaraladi. Hukm qayerda tushganini o'zingiz ko'rishingiz uchun raqamni ham keltiramiz.",
    pillarsTitle: "To'rt ustun uchrashadigan joy",
    pillarsHint: "Moslik darajasiga faqat Kun shoxi kiradi — u turmush o'rtoq o'rni. Qolgan uch ustunni ham shu jadval bilan o'qish mumkin, shuning uchun qo'shib beramiz.",
    branchRelations: {
      SAMHAP: "Uchlik uyg'unlik",
      BANHAP: "Yarim uyg'unlik",
      YUKHAP: "Oltilik uyg'unlik",
      SAME: "Bir xil shox",
      NEUTRAL: "Aloqasiz",
      WONJIN: "Ichki xafagarchilik",
      CHUNG: "To'qnashuv",
    },
    pillarColumn: "Ustun",
    relationColumn: "Aloqa",
    relationScoreColumn: "Ball",
    tenGodColumn: "O'n xudo",
    stemGodsTitle: "Uning har bir ustuni siz uchun nima",
    stemGodsHint: "Moslik darajasi faqat Kun egalarini taqqoslaydi. Xuddi shu qoida uning boshqa ustunlari uchun ham xudo belgilaydi — o'sha odamning qaysi tomoni siz uchun nima ekani ko'rinadi.",
    seesLabel: "{from} nigohida",
    notScoredNote: "Bu jadvaldagi ballar moslik darajasiga kirmaydi. Kuchini taqqoslay olishingiz uchun keltirilgan.",
    appendixTitle: "Bu xarita shunday hisoblandi",
    timeCorrectionLabel: "Tug'ilgan vaqt",
    timeCorrectionApplied: "Haqiqiy quyosh vaqtiga tuzatilib, {time} deb olindi.",
    timeCorrectionNone: "Tug'ilgan vaqt berilmagani uchun Soat ustuni chetda qoldirildi.",
    timeCorrectionDateShift: "Tuzatish sanani {date} ga ko'chirdi; Kun ustuni o'sha kundan olindi.",
    calendarLabel: "Xarita tuzilgan sana",
    solarLabel: "Quyosh",
    lunarLabel: "Oy",
    lunarUnavailable: "Bu kun almanax jadvalida yo'q, shu bois oy taqvimi sanasi berilmadi.",
  },
  footer: {
    privacy: "Maxfiylik",
    terms: "Shartlar",
