...
export const es: Dictionary = {
  ...
  reportDetail: {
    ...
    supplyHint: "La puntuación de los Cinco Elementos es el promedio de dos direcciones. Un promedio oculta quién nutre a quién. Aquí las separamos: hay parejas en las que solo un lado queda bien abastecido.",
    supplyReceiveLabel: "Cuánto recibe {name}",
    needsLabel: "Lo que hace falta ahora",
    bondTitle: "El vínculo entre los dos Amos del Día",
    depthTitle: "Una mirada más atenta a cada carta",
    vitalityTitle: "Lo que impulsa la estación",
    vitalityHint: "Las barras muestran cuánto hay de cada elemento. Esta tabla muestra si el mes de nacimiento lo impulsa. La misma cantidad no rinde igual en Wang que en Sa.",
    vitalities: {
      WANG: { name: "Wang (旺)", body: "en su punto máximo" },
      SANG: { name: "Sang (相)", body: "el siguiente en ascenso" },
      HYU: { name: "Hyu (休)", body: "en reposo tras su turno" },
      SU: { name: "Su (囚)", body: "confinado, le cuesta moverse" },
      SA: { name: "Sa (死)", body: "en su punto más débil" },
    },
    seasonBoostTitle: "Cuánto lo elevó el mes",
    rawLabel: "Antes del mes",
    strengthLabel: "Después del mes",
    earthSeasonNote: "Nacimiento en un mes de transición (辰未戌丑), por lo que Tierra también se tomó como dominante.",
    allyRatioLabel: "Proporción del lado del Amo del Día",
    allyRatioHint: "Recurso más Par, sobre el total. Por encima del 45% se considera fuerte; por debajo del 35%, débil. Publicamos la cifra para que vea dónde cayó el veredicto.",
    pillarsTitle: "Donde se encuentran los cuatro pilares",
    pillarsHint: "Solo la rama del Día entra en la compatibilidad: es el asiento conyugal. Los otros tres pilares se leen con la misma tabla, así que los incluimos.",
    branchRelations: {
      SAMHAP: "Armonía triple",
      BANHAP: "Media armonía",
      YUKHAP: "Armonía séxtuple",
      SAME: "Misma rama",
      NEUTRAL: "Sin relación",
      WONJIN: "Resentimiento",
      CHUNG: "Choque",
    },
    pillarColumn: "Pilar",
    relationColumn: "Relación",
    relationScoreColumn: "Puntos",
    tenGodColumn: "Diez Dioses",
    stemGodsTitle: "Qué es para usted cada pilar del otro",
    stemGodsHint: "La compatibilidad compara solo los Amos del Día. La misma regla fija un Dios para sus demás pilares: muestra qué parte de esa persona es qué para usted.",
    seesLabel: "Visto por {from}",
    notScoredNote: "Las puntuaciones de esta tabla no forman parte de la compatibilidad. Se imprimen para que pueda comparar intensidades.",
    appendixTitle: "Así se calculó esta carta",
    timeCorrectionLabel: "Hora de nacimiento",
    timeCorrectionApplied: "Corregida a hora solar verdadera y leída como {time}.",
    timeCorrectionNone: "No se indicó la hora de nacimiento, así que se omitió el pilar de la Hora.",
    timeCorrectionDateShift: "La corrección movió la fecha a {date}, y el pilar del Día se tomó de ese día.",
    calendarLabel: "Fecha de la que se extrajo la carta",
    solarLabel: "Solar",
    lunarLabel: "Lunar",
    lunarUnavailable: "Este día falta en la tabla del almanaque, así que no se pudo imprimir la fecha lunar.",
  },
  footer: {
    privacy: "Privacidad",
    terms: "Términos",
