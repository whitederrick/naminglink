...
export const EN_DOCS = {
  ...
  "guide/one-symbol-many-meanings": {
    ...
    "summary": "Traditionally, holding a snake and being bitten by one are opposites. This discusses the structure where 218 symbols have 327 meanings and how to interpret situations.",
