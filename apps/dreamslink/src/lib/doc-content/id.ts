...
export const ID_DOCS = {
  "about": {
    "eyebrow": "Pendahuluan",
    "title": "Pendahuluan ke Dreams-Link",
    ...
    "sections": [
      {
        ...
        "blocks": [
          ...
          {
            "p": "Satu-satunya yang dijual dengan biaya adalah **dua bentuk pelestarian** — sebuah gambar (kartu mimpi) yang berisi mimpi baik dan sebuah PDF yang menangkap latar belakang ketika sebuah simbol yang secara tradisional dianggap sebagai a conception dream muncul."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "**Kami tidak menciptakan makna tradisional yang tidak ada dalam kamus.** Jika tidak ada simbol yang ditemukan, kami hanya menyatakan bahwa tidak ada yang ditemukan dan menyimpulkan. Mengisi ruang itu dengan kata-kata yang masuk akal adalah hal yang paling hati-hati dilakukan layanan ini."
          },
          {
            "p": "**Sebuah a conception dream hanyalah sebuah tanda, bukan penilaian.** Kami hanya memberi tahu Anda bahwa sebuah simbol yang secara tradisional dianggap sebagai a conception dream muncul dalam mimpi. Kami tidak memprediksi kehamilan atau jenis kelamin anak, dan tidak ada dasar untuk klaim semacam itu."
          },
          {
            "p": "Kami tidak **mengeluarkan pernyataan definitif tentang kesehatan, kekayaan, atau karier.** Ini adalah referensi dari perspektif interpretasi mimpi tradisional dan bukan nasihat medis, finansial, atau hukum."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Cerita mimpi adalah bagian yang paling pribadi dari apa yang diterima layanan ini. Oleh karena itu, kami **tidak menyimpannya.** Apa yang Anda masukkan hanya dibawa dalam URL dan digunakan untuk pembacaan; itu tidak dicatat dalam tabel mana pun di server kami."
          },
          {
            "p": "Kami memutuskan **tidak membuat fungsi untuk mengumpulkan mimpi seperti buku harian mimpi.** Ini adalah fitur yang berharga, tetapi akan memerlukan penyimpanan tulisan yang paling pribadi."
          }
        ]
      },
      {
  ...
  "guide": {
    ...
    "summary": "Kami mengungkapkan semua aturan yang digunakan Dreams-Link. Anda dapat memeriksa simbol mana yang ditemukan, apa yang tertulis dalam kamus — dari mana interpretasi yang ditampilkan di layar berasal.",
    "backLabel": "Kembali ke Beranda",
    "sections": [
      {
        "kind": "note",
        "blocks": [
          {
            "p": "Semua angka yang tertulis di sini **dibaca langsung dari kamus simbol dan aturan pencocokan.** Karena kami tidak mentranskripsikan teks secara manual, jika kamus diperluas atau aturan diubah, angka dalam dokumen ini juga akan berubah."
          }
        ]
      }
    ]
    ...
    "sections": [
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "p": "**Kami tidak mengisi ruang kosong.** Menambahkan asal yang masuk akal akan membuat dokumen ini lebih tebal, tetapi pada saat itu, kamus ini tidak akan menyampaikan tradisi tetapi mengada-ada. Lebih jujur untuk membedakan antara apa yang dapat dan tidak dapat dibuktikan."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Kami sebenarnya mencoba untuk memperluas simbol menjadi ratusan tetapi menyerah. Entri yang dihasilkan secara otomatis baik mengulangi frasa yang sama seperti 'romansa → hubungan baik' atau gagal memberikan sumber tradisional yang terdokumentasi. Kami menyimpulkan bahwa **menemukan dengan akurat apa yang ada** lebih baik daripada sekadar meningkatkan angka."
          }
        ]
      },
      {
  ...
  "guide/how-matching-works": {
    "eyebrow": "Dasar untuk Layanan",
    "title": "Bagaimana menemukan simbol dalam cerita mimpi.",
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "p": "Ketika Anda menuliskan cerita mimpi Anda secara bebas, kami mencari simbol dalam teks tersebut dari kamus. Anda tidak perlu memilih item atau menulis dalam format tertentu. Cukup tulis seperti biasa, seperti 'Tadi malam, seekor python besar melilitku.'"
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "ul": [
              "별 (\"bintang\") tersembunyi di dalam 특**별**할 (\"tidak ada yang istimewa\")",
              "게 (\"kepiting\") tersembunyi di dalam 누군가에**게** (\"oleh seseorang\")",
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Sebelum menerapkan aturan ini, saat menguji dengan dua belas kalimat nyata, **semua dua belas** mengandung simbol yang tidak relevan. Satu kalimat tanpa konten signifikan bahkan ditandai sebagai sebuah a conception dream."
          },
          {
          ...
          {
            "p": "Tidak menemukan sesuatu adalah hal yang jujur. Namun, menemukan sesuatu yang tidak relevan berarti membangun tradisi di balik kata itu yang tidak pernah ada."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Tidak ada tempat untuk kebetulan dalam aturan pencocokan. Karena kamus tetap dan aturannya sudah ditetapkan, jika Anda memasukkan kalimat yang sama lagi, **simbol yang sama akan muncul dalam urutan yang sama**. Interpretasi yang Anda lihat hari ini tidak akan berbeda dari yang Anda lihat besok."
          },
          {
            "p": "Kualitas ini juga merupakan janji yang telah kami buat untuk diri kami sendiri. Interpretasi yang berubah setiap kali menghibur tetapi kurang dasar. Ini terhubung dengan cerita tentang [mengapa kami tidak menggunakan model](/guide/no-ai)."
          }
        ]
      }
    ]
  ...
  "guide/one-symbol-many-meanings": {
    ...
    "sections": [
      {
        "title": "Bahkan jika simbolnya sama, situasi yang berbeda menghasilkan arti yang berbeda",
        "blocks": [
          {
            "p": "Dalam interpretasi mimpi tradisional, satu simbol tidak selalu memiliki satu arti. Bahkan untuk ular yang sama, **memegangnya dan digigit telah diinterpretasikan sebagai kebalikan yang lengkap.** Ini juga dicatat dalam kamus."
          },
          {
            "p": "Inilah sebabnya mengapa {symbolTotal} simbol memiliki total {meaningTotal} arti. Setiap arti mencakup **konteks di mana itu berlaku**, dan jika konteks itu terlihat dalam teks yang Anda berikan, kami memilih arti itu."
          }
        ]
      },
      {
        "title": "Cara mengidentifikasi situasi",
        "blocks": [
          {
            "p": "Kami memeriksa apakah teks yang Anda berikan mengandung kata-kata yang menunjukkan situasi itu. Dalam 「뱀이 나를 물었다」 (baemi nareul mul-eotda), situasi menggigit dijelaskan, sementara dalam 「뱀을 품에 안았다」 (baemeul pume anatda), situasi memegang dijelaskan. Jika tidak ada kata yang menunjukkan situasi, kami menginterpretasikannya menggunakan **arti dasar** dari simbol itu."
          },
          {
      ...
      {
        "title": "Ada {contextSplitSymbolTotal} simbol dengan arti yang terpisah",
        "blocks": [
          {
            "p": "Di antara {symbolTotal} simbol dalam kamus, **{contextSplitSymbolTotal}** memiliki arti yang bervariasi tergantung pada situasi. Sisanya telah dibaca dalam satu arah terlepas dari situasi."
          },
          {
            "p": "{contextSplitSymbolTotal} ini adalah area yang paling hati-hati. Salah membaca situasi dapat menyebabkan menyampaikan kabar baik sebagai kabar buruk, atau sebaliknya. Oleh karena itu, jika situasi tidak jelas, kami tidak **memilih satu sisi secara paksa dan sebaliknya menggunakan arti dasar** dari simbol itu — kami tidak ingin menyatakan sesuatu yang tidak pasti seolah-olah itu pasti."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Perasaan dan pengulangan yang ditanyakan di bawah konten mimpi tidak digunakan untuk menemukan simbol. Mereka dirujuk saat memutuskan cara mana untuk menginterpretasikan dalam situasi dengan arti yang terpisah. Anda tidak perlu memilih; hasil tetap akan diberikan."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          {
            "p": "Anda dapat melihat berbagai simbol dan arti mereka dalam [kamus simbol](/dream/symbols). Juga baik untuk melihat apa yang termasuk sebelum menulis mimpi Anda."
          }
        ]
      }
    ]
  ...
  "guide/good-and-bad": {
    "eyebrow": "Dasar Layanan",
    "title": "Kriteria untuk membedakan mimpi yang menguntungkan dan mimpi yang tidak menguntungkan",
    ...
    "sections": [
        ...
        "blocks": [
          ...
          },
          {
            "ul": [
              ...
              "**{polarityAmbivalent} simbol yang bervariasi tergantung situasi** — seperti ular, di mana arti dapat berbalik tergantung pada apa yang dilakukan. Kategori ini adalah yang paling hati-hati.",
              "**{polarityNegative} simbol tidak menguntungkan** — yang dilihat sebagai gosip, perselisihan, atau kerugian.",
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Ini bukan karena kami dermawan dalam penilaian kami. **Interpretasi mimpi tradisional (dream interpretation) selalu seperti ini.** Simbol besar dan kuat seperti babi, naga, api, dan air umumnya dipandang sebagai pertanda baik, dan kamus mencerminkan tradisi itu."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Jika beberapa simbol ditemukan, kami mengumpulkan keberuntungan masing-masing untuk menentukan nada keseluruhan mimpi. Jika hanya simbol positif yang muncul, itu adalah mimpi baik; jika hanya simbol tidak menguntungkan yang muncul, itu adalah mimpi tidak menguntungkan; jika **campuran, kami mengkomunikasikannya sebagai campuran.**"
          },
          {
            "p": "Kami tidak memaksakan pengkategorian simbol campuran ke satu sisi. Pada kenyataannya, mimpi yang dimiliki orang sering kali campuran, dan merangkumnya sebagai 'mimpi baik' tidaklah akurat maupun membantu."
          }
        ]
      },
      {
      ...
      {
        "title": "Ketika Mimpi Buruk Muncul",
        "blocks": [
          {
            "p": "Bahkan jika sebuah simbol yang diinterpretasikan sebagai peringatan muncul, itu tidak selalu berarti berita buruk. Dalam interpretasi mimpi tradisional, sebuah an ominous dream umumnya digunakan sebagai **pernyataan yang menunjuk pada situasi yang ada**. Jika sebuah simbol yang menunjukkan konflik muncul, itu dapat dibaca sebagai pengingat untuk menahan kata-kata."
          },
          {
            "p": "Untuk alasan yang sama, layanan ini tidak menjual jimat atau benda-benda keberuntungan. Yang dijual hanyalah [dua cara untuk menjaga mimpi Anda](/guide/reports)."
          }
        ]
      }
    ]
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "p": "**Dreams-Link tidak menentukan status kehamilan. Itu juga tidak menunjukkan jenis kelamin anak.** Ini adalah hal-hal yang tidak dapat diketahui melalui mimpi, dan itu bukan sesuatu yang dapat kami lakukan."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "p": "Oleh karena itu, kami melihat **makna aktual yang diambil dari simbol tersebut, bukan simbol itu sendiri.** Kami hanya menandainya sebagai mimpi konsepsi ketika makna yang condong ke arah konsepsi dipilih dalam situasi yang Anda berikan. Bahkan dengan babi yang sama, pembacaan berubah jika kalimatnya berbeda."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Jika tulisan Anda mencakup kata-kata seperti kehamilan, mimpi konsepsi, atau persalinan, kami terlebih dahulu melihat makna simbol yang condong ke arah konsepsi. Bahkan dengan mimpi babi yang sama, cara nenek moyang kami menginterpretasikannya bervariasi tergantung pada situasi saat ini."
          }
        ]
      },
      {
  ...
  "guide/how-to-write": {
    ...
    "summary": "Jika Anda menuliskan apa yang Anda lihat dan lakukan, itu akan diinterpretasikan dengan baik. Ini menjelaskan mengapa satu kata kerja dapat menentukan makna dan mengapa kami bertanya tentang perasaan dan pengulangan.",
    "backLabel": "Dasar Interpretasi",
    "sections": [
      {
        ...
        "blocks": [
          {
            "p": "Tidak ada format khusus. Beberapa kalimat seperti yang Anda bicarakan biasanya sudah cukup. Namun, apa yang berhasil ditentukan — **apa yang terlihat** dan **apa yang terjadi.**"
          },
          {
            "ul": [
          ...
          {
            "p": "Jika Anda hanya mencatat perasaan, tidak akan ada simbol yang dapat ditemukan. Ini karena interpretasi mimpi tradisional berbicara tentang [objek dan tindakan](/guide/categories), bukan emosi."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Jika tulisan Anda mencakup kata-kata seperti kehamilan, mimpi konsepsi, atau persalinan, kami terlebih dahulu melihat makna simbol yang condong ke arah konsepsi. Bahkan dengan mimpi babi yang sama, cara nenek moyang kami menginterpretasikannya bervariasi tergantung pada situasi saat ini — [cara menginterpretasikan mimpi konsepsi](/guide/conception-dreams)."
          }
        ]
      },
      {
        "title": "Tidak Perlu Menulis Teks yang Panjang",
        "blocks": [
          {
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "p": "{symbolTotal} simbol dikelompokkan menjadi sembilan kategori berdasarkan karakteristiknya. Kriteria untuk pembagian adalah **bagaimana mereka muncul dalam mimpi** — apakah sebagai hewan, objek, atau tindakan yang kami lakukan."
          },
          {
            "ul": [
              "**Objek {categoryThing}** — Barang-barang nyata seperti uang, cermin, dan pisau. Ini adalah kategori yang paling tebal.",
              "**Hewan {categoryAnimal}** — naga·babi·ular·sapi. Banyak dari ini dianggap sebagai a conception dream.",
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Kategori seperti 「kecemasan」·「kerinduan」 tidak termasuk. **Ini karena interpretasi mimpi tradisional tidak membahas emosi.** Interpretasi lama berfokus pada apa yang terlihat dan apa yang terjadi, bukan pada perasaan si pemimpi."
          },
          {
            "p": "kami telah mencoba untuk membuat kategori emosi, tetapi hasilnya adalah istilah seperti 「kehilangan kasih sayang」·「stabilitas emosional」. Ini bukan **simbol** dari mimpi tetapi kosakata dari psikologi modern. Itu adalah jenis layanan yang berbeda dan bukan apa yang ingin dicapai oleh kamus ini."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Silakan tuliskan **apa yang Anda lihat dan lakukan** daripada perasaan; itu akan menghasilkan hasil yang jauh lebih baik. Namun, kami akan menanyakan tentang perasaan Anda saat bangun secara terpisah — bahkan simbol yang sama dapat memiliki makna yang berbeda tergantung pada situasi."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Warna {categoryColor} dan angka {categoryNumber} tidak memiliki makna baik atau buruk yang melekat. Sama seperti ular putih dan ular hitam berbeda, maknanya berubah tergantung pada **apa yang mereka asosiasikan**. Oleh karena itu, kedua kategori ini dipertimbangkan bersamaan dengan simbol lainnya."
          },
          {
            "p": "Daftar lengkap berdasarkan kategori tersedia di [kamus simbol](/dream/symbols). Membuka simbol akan menunjukkan makna tradisionalnya, kategori, dan simbol terkait."
          }
        ]
      }
    ]
  ...
  "guide/not-found": {
    ...
    "summary": "Jika Anda tidak dapat menemukannya, kami akan memberi tahu Anda bahwa itu tidak ditemukan. kami akan membahas mengapa itu tidak dapat ditemukan, apa yang akan kami tunjukkan sebagai gantinya di layar itu, dan bagaimana kamus diperluas.",
    "backLabel": "Dasar interpretasi",
    "sections": [
      {
        "title": "Ketika tidak ditemukan, kami akan memberi tahu Anda bahwa itu tidak ditemukan",
        "blocks": [
          {
            "p": "Jika kami tidak dapat menemukan simbol apa pun dalam teks yang Anda berikan, kami akan **memberitahu Anda bahwa itu tidak ditemukan.** kami tidak akan memaksakan asosiasi dengan sesuatu yang serupa atau membuat kalimat yang masuk akal untuk mengisi ruang."
          },
          {
            "p": "Ini adalah apa yang paling hati-hati dilakukan oleh layanan ini. Saat kami mengisi kekosongan, itu melanggar janji bahwa kami hanya menyampaikan interpretasi yang diwariskan."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Biasanya, itu adalah salah satu dari berikut."
          },
          {
            "ul": [
              "**Ini adalah simbol yang belum ada di kamus.** Saat ini, ada {symbolTotal} simbol yang terdaftar, tetapi masih banyak lagi yang bisa muncul dalam mimpi.",
              "**Anda hanya menulis perasaan.** Jika hanya ada emosi seperti 「saya merasa takut」·「saya merasa aneh」, tidak ada simbol yang dapat dicocokkan. Interpretasi mimpi tradisional berbicara tentang **objek dan tindakan yang terlihat** daripada emosi.",
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Silakan sertakan **apa yang Anda lihat dan apa yang Anda lakukan** dalam mimpi. Mengatakan 「saya merasa cemas」 kurang efektif daripada mengatakan 「saya jatuh dari tempat yang tinggi」, dan mengatakan 「saya menyukainya」 kurang efektif daripada mengatakan 「saya melihat air jernih mengalir」."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Ketika sesuatu tidak dapat ditemukan, kami juga akan menunjukkan **{popularSymbolCount} simbol yang sering dicari** di layar itu. Ini dipilih dari kamus berdasarkan representativitasnya, yang dapat membantu Anda mengingat jika salah satunya muncul dalam mimpi Anda."
          },
          {
            "p": "Jika Anda ingin menjelajahi seluruh daftar, ada {symbolTotal} simbol yang diorganisir berdasarkan kategori di [kamus simbol](/dream/symbols). Setiap simbol mencakup makna tradisionalnya dan simbol terkait."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Daripada meningkatkan jumlahnya, kami fokus pada **mengidentifikasi dengan akurat apa yang sudah ada.** kami telah menyertakan {aliasTotal} nama alternatif untuk simbol yang sama, dan kami telah membuatnya mungkin untuk mengenali kata-kata yang berubah bentuk dengan akhiran."
          },
          {
            "p": "Saat memperluas simbol itu sendiri, kami hanya akan menyertakan simbol yang dapat **memberikan sumber tradisional yang terdokumentasi.** Meningkatkan jumlah tanpa bukti menjadi penciptaan daripada kamus — kami telah mendokumentasikan upaya dan hasil dalam [mengapa kami tidak menggunakan model](/guide/no-ai)."
          }
        ]
      }
    ]
  ...
  "guide/no-ai": {
    ...
    "summary": "Tidak ada kode yang memanggil model dalam proses pembuatan interpretasi. kami telah meninggalkan upaya untuk memperluas kamus menggunakan model berdasarkan hasil empiris, dan dengan demikian apa yang diperoleh dan apa yang dikorbankan.",
    "backLabel": "Dasar interpretasi",
    "sections": [
      {
        ...
        "blocks": [
          {
            "p": "Banyak layanan interpretasi mimpi saat ini menunjukkan teks yang dihasilkan dengan memasukkan cerita mimpi ke dalam model generatif. Dreams-Link tidak melakukan itu. **Tidak ada kode yang memanggil model dalam proses pembuatan interpretasi.**"
          },
          {
            "p": "Apa yang kami lakukan sederhana. kami menemukan simbol dalam teks yang Anda berikan yang ada di kamus dan memilih serta menunjukkan makna yang telah ditulis oleh kamus untuk simbol-simbol tersebut. Tidak ada tempat untuk kalimat yang tidak ada dalam kamus."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "**Model tidak mengatakan bahwa mereka tidak tahu apa yang tidak mereka ketahui.** Ketika ditanya tentang simbol tanpa sumber tradisional yang terdokumentasi, mereka membuat asal yang masuk akal. Dan apakah itu dibuat atau tidak adalah sesuatu yang tidak dapat dibedakan oleh pembaca. Jika satu menciptakan di tempat menyampaikan tradisi, premis layanan ini runtuh."
          },
          {
            "p": "kami sebenarnya telah mencoba untuk membuat model menciptakan simbol untuk memperluas kamus. Dari enam puluh enam contoh yang layak dipertimbangkan, **lima puluh lima tidak dapat memberikan sumber tradisional yang terdokumentasi**, dan beberapa termasuk hal-hal yang tidak dapat ada dalam interpretasi mimpi tradisional, seperti kereta bawah tanah dan jalan raya. Oleh karena itu, **tidak ada yang disertakan.**"
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Ketika kami mencoba tugas yang sama dengan model yang lebih baik, hanya satu dari sembilan belas yang lulus, dan yang satu itu hanya pengulangan kata yang sama di posisi bukti. Model yang lebih besar hanya berbicara **lebih masuk akal** tentang apa yang tidak mereka ketahui."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "ul": [
              "**Jika itu adalah mimpi yang sama, interpretasi yang sama akan muncul.** Kata-katanya tidak berubah setiap kali.",
              "**Ini cepat.** Tidak ada menunggu respons model, jadi hasilnya disampaikan segera.",
              "**Mimpi yang Anda berikan tidak keluar.** Tidak perlu mengirimnya ke server perusahaan eksternal — silakan baca bersama dengan [metode tidak menyimpan](/guide/no-storage).",
  ...
  "guide/reports": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Untuk mimpi yang menunjukkan simbol-simbol yang diinterpretasikan sebagai mimpi konsepsi, kami membuat dokumen **{conceptionPages}-halaman.** Ini mencakup simbol-simbol apa yang muncul, bagaimana simbol-simbol tersebut telah diinterpretasikan secara tradisional, dan tempat untuk mencatatnya."
          },
          {
            "p": "Karena mimpi konsepsi sering dibahas dan dibagikan di antara anggota keluarga bahkan setelah anak lahir, kami membuat dokumen terpisah untuk mimpi yang terlalu berharga untuk hanya dilihat di layar."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Kami tidak menentukan status kehamilan atau jenis kelamin anak. Pernyataan semacam itu tidak muncul dalam dokumen. Untuk detail lebih lanjut, lihat [cara menginterpretasikan mimpi konsepsi](/guide/conception-dreams)."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Layanan saudara menyediakan laporan sembilan halaman. Mesin saju mengekstrak banyak nilai dari hanya satu tanggal lahir. Interpretasi mimpi tidak bekerja seperti itu."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Harga tertera dalam [panduan harga](/pricing). Alasan dokumen ini tidak mencantumkan jumlah adalah disengaja — untuk mencegah situasi di mana dokumen panduan tetap dengan jumlah lama ketika harga berubah. Layar dan syarat semua membaca jumlah yang sama dari satu tempat."
          },
          {
            "p": "Dokumen yang Anda beli dapat **diperoleh kembali dengan pesanan yang sama.** Namun, karena kami tidak menyimpan file, setelah Anda meninggalkan layar hasil, Anda tidak dapat membuatnya kembali — harap simpan file yang Anda terima."
          }
        ]
      }
    ]
    ...
    "sections": [
      {
        ...
        "blocks": [
          ...
          {
            "p": "Cerita mimpi adalah nilai yang paling pribadi dari layanan ini. Inilah sebabnya mengapa aturannya lebih ketat dari yang diperlukan — kami bahkan tidak membuat tabel untuk menuliskan apa yang Anda kirim."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "ul": [
              "**Tidak ada buku harian mimpi.** Anda tidak dapat mengambil interpretasi dari minggu lalu, dan Anda harus memiliki tautan untuk melihatnya lagi. Ini dilakukan dengan sengaja — untuk membuat buku harian, tulisan yang paling pribadi harus disimpan terus-menerus.",
              "**Kami menghitung nilai yang sama setiap kali.** Tidak ada cache. Sebagai gantinya, kamus tetap, dan aturan pencocokan bersifat deterministik, sehingga teks yang sama akan selalu menghasilkan simbol yang sama — aturan menggantikan apa yang dijamin oleh cache.",
  ...
  "contact": {
    ...
    "sections": [
        ...
        "blocks": [
          {
            "ul": [
              ...
              "**Laporkan Kesalahan Interpretasi** — Jika simbol ditemukan tidak benar atau interpretasinya tampak aneh, harap beri tahu kami. Jika Anda menyertakan kapan Anda menulis cerita mimpi itu, kami dapat mencarinya lagi dengan teks yang sama."
            ]
          }
        ]
      },
        ...
        "blocks": [
          {
            "ul": [
              ...
              "**Alamat** — {address}",
              "**Pusat Layanan Pelanggan** — {customerCenter}",
              "**Email** — {email}",
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Anda tidak perlu menulis ulang mimpi yang Anda berikan dalam email pertanyaan. Kami tidak menyimpan input, jadi kami tidak dapat mencarinya lagi, dan nomor pesanan sudah cukup untuk verifikasi. Harap hanya tuliskan jika benar-benar perlu, seperti untuk melaporkan kesalahan interpretasi."
          }
        ]
      }
    ]
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "p": "Meskipun ini sering dibahas dalam layanan interpretasi mimpi, kami tidak melakukan ini. **Tidak ada dasar dalam interpretasi mimpi tradisional untuk menarik angka dari mimpi.** Meskipun ada catatan tentang menginterpretasikan mimpi babi sebagai kekayaan, tidak ada aturan dalam literatur mana pun yang menghasilkan enam angka dari itu."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Kami hanya akan menyatakan bahwa sebuah simbol yang diinterpretasikan sebagai sebuah a conception dream (a conception dream) telah muncul. Apakah Anda hamil atau apakah anak tersebut seorang putri atau putra adalah **bukan sesuatu yang dapat diketahui melalui mimpi.** Pernyataan semacam itu tidak muncul di layar atau dalam dokumen berbayar."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Sebuah simbol yang dibaca sebagai an ominous dream bukanlah alasan untuk membeli apa pun. Sebuah an ominous dream secara tradisional digunakan untuk **menunjukkan situasi yang perlu diperiksa sekarang**, bukan untuk membayar agar menghindari sesuatu."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Kami tidak membuat pernyataan definitif tentang apakah sesuatu akan terjadi, kapan itu akan terjadi, atau mengenai kesehatan, kekayaan, atau umur. Menyampaikan makna simbol tradisional dan meramalkan masa depan adalah dua hal yang berbeda."
          }
        ]
      },
      {
...
export const ID_NOTICES = {
  ...
  "intro": "Perubahan pada syarat penggunaan Anda — harga, kebijakan — diposting di sini sebelum berlaku. Perbaikan internal seperti layar yang menjadi lebih cepat tidak diposting di sini: apa yang muncul di sini adalah apa yang perlu Anda ketahui.",
  "empty": {
  ...
  "items": {
    "2026-08-06-no-storage": {
      ...
      "body": [
        "Cerita mimpi adalah nilai paling pribadi yang diterima layanan ini. Oleh karena itu, mereka tidak dicatat dalam tabel manapun. Input hanya dibawa dalam alamat hasil untuk perhitungan, dan setelah jendela ditutup, itu menghilang.",
        "Kami memutuskan untuk tidak membuat fitur yang mengumpulkan mimpi dan menunjukkan alur (diari mimpi). Ini adalah fitur yang berguna, tetapi untuk melakukannya, tulisan paling pribadi harus disimpan secara terus-menerus.",
    ...
    "2026-08-06-engine-version": {
      ...
      "body": [
        "Dasar untuk interpretasi adalah kamus simbol interpretasi mimpi tradisional. Hasil dan dokumen akan mencakup versi kamus tersebut (misalnya, 1.2.0) dan versi aturan pencocokan (misalnya dream-1.0.0). Mimpi yang sama akan selalu menghasilkan simbol yang sama berdasarkan kriteria yang sama.",
        "Jika kami menambahkan simbol ke dalam kamus atau mengubah makna dengan cara yang dapat mengubah hasil, fakta ini akan disajikan di sini. Ini karena hasil yang Anda terima sebelumnya mungkin berubah.",
    ...
    "2026-08-06-conception": {
      ...
      "body": [
        ...
        "Sebutannya tentang putra dan putri dalam narasi tradisional adalah refleksi dari adat yang telah diturunkan, dan itu tidak berarti bahwa kami memprediksinya dengan benar."
      ]
    }
  }
