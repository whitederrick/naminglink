    ...
    >
      <div className="w-full max-w-md rounded-2xl border border-line bg-surface p-6 shadow-2xl">
        <div className="flex items-center gap-3">
          <span
            aria-hidden
            className="size-3 shrink-0 animate-pulse rounded-full bg-brand-navy"
          />
        ...
        >
          <div
            className="h-full rounded-full bg-brand-navy transition-[width] duration-200 ease-linear"
