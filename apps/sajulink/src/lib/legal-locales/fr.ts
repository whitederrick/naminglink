...
const d0 = {
  ...
  "intro": "Saju-Link ne conserve aucune information nécessaire à l'interprétation du saju (사주). Cette politique décrit ce que le service reçoit, ce qu'il ne conserve pas et ce qui est enregistré automatiquement.",
  "sections": [
    {
      "heading": "1. Informations non conservées",
      "paragraphs": [
        "La date de naissance, l'heure de naissance, le lieu de naissance, le sexe et le nom utilisé saisis pour l'interprétation du saju ne sont **pas enregistrés nulle part.** Ils sont uniquement utilisés en mémoire du serveur pendant le traitement de la demande et disparaissent avec la réponse.",
    ...
    },
    {
      ...
      "paragraphs": [
        ...
        "Actuellement, aucune publicité n'est diffusée sur ce service. Si des publicités sont diffusées à l'avenir, le fournisseur de publicité (par exemple, Google) peut utiliser des cookies pour la diffusion des annonces. Dans ce cas, cette clause sera d'abord modifiée pour expliquer ce qui change avant de commencer."
      ]
    },
    {
      ...
      "paragraphs": [
        ...
        "Lorsque la vente commence, les éléments suivants seront conservés pour le traitement des paiements et la conservation des enregistrements de transactions conformément à la législation. **À ce moment-là, les valeurs saisies pour l'interprétation du saju et le PDF généré ne seront pas conservés**, et aucune information permettant d'identifier l'utilisateur, comme le nom, les coordonnées ou l'adresse, ne sera collectée."
      ],
      "bullets": [
...
const d1 = {
  ...
  "intro": "Les présentes conditions générales régissent l'utilisation du service Saju-Link (ci-après dénommé « Service »). En utilisant le service, vous êtes réputé avoir accepté ces conditions.",
  "effectiveLabel": "Date d'entrée en vigueur",
  "sections": [
    {
      "heading": "1. Nature du service",
      "paragraphs": [
        "Le service applique les règles de la divination traditionnelle (saju) en se basant sur la date de naissance et l'heure de naissance saisies, et fournit des informations sur le natal chart (원국), l'équilibre des cinq éléments (오행), la force et la faiblesse du jour (일간), ainsi que les interactions entre le jour et le natal chart.",
        "Les scores et les interprétations fournis sont des **documents de référence selon la perspective de la divination traditionnelle, et ne constituent pas des prévisions scientifiques ni des affirmations concernant l'avenir, la santé ou les biens d'un individu.** Un score bas ne signifie pas que la journée sera mauvaise, et un score élevé ne garantit rien.",
        "**Les phrases d'interprétation des rapports payants sont rédigées par une IA générative.** Cependant, tous les chiffres tels que les scores, les troncs et les forces des cinq éléments sont calculés par le moteur de règles du service, et l'IA ne modifie ni ne crée ces valeurs. Dans le cas où l'interprétation ne peut pas être produite, une description basée sur les valeurs calculées par le moteur sera insérée à la même place, et le nombre de pages du document ainsi que les éléments inclus restent tels que décrits au paragraphe 3 ci-dessous."
      ]
    },
    {
      "heading": "2. Frais d'utilisation",
      "paragraphs": [
        "Le service actuel est entièrement gratuit et ne nécessite pas d'inscription.",
        "Lorsque la vente de produits payants (deux rapports PDF) commence, les conditions de l'article 3 ci-dessous s'appliquent. Ces conditions seront à nouveau communiquées avant le début de la vente."
      ]
    },
    {
      "heading": "3. Produits payants et remboursements",
      "paragraphs": [
        "Les produits payants proposés sont **un PDF de « rapport de lecture de vie saju (사주) et de fortune de l'année »**. Il s'agit de créer un document à partir des résultats affichés à l'écran, et d'inclure des informations qui ne sont pas présentes à l'écran.",
        "**A4 9 pages** — couverture et résumé, tendances et forces innées, points à surveiller, les huit caractères du natal chart (원국) et la force des cinq éléments, la force et la faiblesse du jour (일간) et l'énergie nécessaire actuellement (용신), les dix dieux des quatre piliers (네 기둥) et les positions marquantes dans ce saju (사주), les quatre domaines de la vie vus dans le natal chart (재물·애정·직업·건강) et leurs justifications, les détails de la correction de l'heure de naissance (진태양시), et les prévisions pour cette année. Paiement national {priceDomestic} (TVA incluse), paiement international {priceGlobal}.",
        "**La fortune du jour n'est pas incluse dans ce document.** Elle varie chaque jour et est fournie gratuitement à l'écran, tandis que ce document est composé de l'interprétation de la carte natale qui ne change jamais et des prévisions pour cette année.",
        "Les paiements nationaux peuvent être effectués par carte de crédit ou de débit et par des paiements simplifiés (Toss Payments, KakaoPay, NaverPay, Payco, etc.) via Toss Payments, tandis que les paiements internationaux se font par PayPal via PortOne. Le montant final est celui affiché sur l'écran de paiement.",
        "**Le service ne conserve ni les données saisies par l'utilisateur, ni le fichier PDF généré.** Une fois le paiement approuvé, le document est créé et téléchargé immédiatement, sans rien laisser sur le serveur. Par conséquent, le fichier téléchargé doit être conservé par l'utilisateur lui-même.",
        "En cas d'interruption du téléchargement ou de perte de fichier, il est possible de le télécharger à nouveau **jusqu'à 5 fois** avec la même commande. Cependant, si les valeurs d'entrée disparaissent en dehors de l'écran de résultats, il ne sera pas possible de les recréer, veuillez donc enregistrer le fichier immédiatement après le paiement."
      ],
      "bullets": [
        "**Vous pouvez annuler et obtenir un remboursement complet à tout moment avant que le téléchargement ne commence après le paiement.**",
        "**Une fois le téléchargement terminé** , le droit de rétractation pour simple changement d'avis est limité. Il s'agit de contenus numériques fournis immédiatement après le paiement, et leur restitution est impossible, ce qui correspond aux motifs de limitation du droit de rétractation définis à l'article 17, paragraphe 2 de la loi sur la protection des consommateurs dans le commerce électronique.",
        "En cas de **non-création du document en raison d'une erreur système, d'impossibilité d'ouvrir le fichier, ou si le montant du paiement diffère de la commande**, un nouvel envoi ou un remboursement intégral sera effectué.",
        "**Les plaintes concernant le contenu des résultats** ne constituent pas un motif de remboursement. L'interprétation du saju (사주) est un document de référence selon la perspective traditionnelle de la divination coréenne, et sa nature est expliquée avant le paiement (voir point 1 ci-dessus).",
        "Une demande de réémission après avoir utilisé les 5 réémissions est considérée comme un motif de non-remboursement.",
        "**Dans le cas où un mineur effectue un paiement sans le consentement de son représentant légal** lui-même ou son représentant légal peut annuler ce paiement. Veuillez nous en informer aux coordonnées ci-dessous et nous procéderons au remboursement."
      ]
    },
    {
      ...
      "paragraphs": [
        ...
        "Si l'heure de naissance n'est pas saisie, le calcul sera effectué sans le pilier temporel (時柱), ce qui peut entraîner des résultats différents. Plus le lieu de naissance est choisi avec précision, plus le calcul du pilier temporel sera exact.",
        "Le calcul du calendrier natal utilise une bibliothèque de calculs publique, et les résultats peuvent varier en fonction des méthodes de traitement des saisons et des fuseaux horaires."
      ]
    },
    {
      "heading": "5. Responsabilité de l'utilisateur",
      "paragraphs": [
        "L'utilisateur peut saisir la date de naissance d'une autre personne, mais il ne doit pas utiliser les résultats de manière à nuire à cette personne.",
        "Veuillez ne pas utiliser les résultats du service comme base pour des jugements affectant les droits d'autrui, tels que le mariage, le divorce, l'embauche ou les transactions. Le service n'est pas conçu à de telles fins."
      ]
    },
    {
      "heading": "6. Actes interdits",
      "paragraphs": [
        "Les actions suivantes ne sont pas autorisées."
      ],
      "bullets": [
        "L'envoi de demandes excessives par des outils automatisés qui entravent le fonctionnement du service.",
        "L'acte de présenter les résultats du service comme des faits ou comme des résultats d'expertise.",
        "L'acte de reproduire ou de modifier le service afin de fournir un service identique."
      ]
    },
    {
      "heading": "7. Exonération",
      "paragraphs": [
        "Le service ne fournit que des documents de référence et ne saurait être tenu responsable des jugements que l'utilisateur tire des résultats et de leurs conséquences.",
        "Nous ne sommes pas responsables des dommages résultant de l'interruption du service en raison de causes incontrôlables telles que des catastrophes naturelles ou des défaillances de l'infrastructure du fournisseur de services."
      ]
    },
    {
      "heading": "8. Droits de propriété intellectuelle",
      "paragraphs": [
        "Les droits sur l'interface du service, les textes et les règles de calcul appartiennent à l'opérateur. L'utilisateur peut enregistrer ou partager les résultats à des fins personnelles."
      ]
    },
    {
      ...
      "paragraphs": [
        ...
        "Les présentes conditions sont régies par la loi de la République de Corée, et tout litige relatif à l'utilisation du service sera traité conformément aux procédures établies par les lois applicables."
      ]
    }
  ]
};
...
const d2 = {
  ...
  "intro": "Voici les critères d'annulation et de remboursement pour le rapport de lecture de vie saju (사주). Nous avons rassemblé des informations similaires à l'article 3 des conditions générales.",
  "sections": [
    {
      "heading": "1. Nature des produits",
      "paragraphs": [
        "Les produits vendus sont le **rapport de lecture de vie saju PDF (A4 5 pages)** et le **rapport premium de lecture de vie saju PDF (A4 7 pages)**, qui sont tous deux des contenus numériques créés et envoyés immédiatement après l'approbation du paiement.",
        "**Le service ne conserve ni les données saisies par l'utilisateur ni le fichier PDF généré.** Par conséquent, le fichier téléchargé doit être conservé par l'utilisateur."
      ],
      "bullets": []
    },
    {
      ...
      "bullets": [
        ...
        "**Après la fin du téléchargement,** le droit de rétractation pour simple changement d'avis est limité. Il s'agit de contenus numériques fournis immédiatement après le paiement, ce qui les rend non récupérables, conformément à l'article 17, paragraphe 2 de la loi sur la protection des consommateurs dans le commerce électronique. Cette information est préalablement communiquée et votre accord est requis sur l'écran de paiement."
      ]
    },
    {
      "heading": "3. Cas de remboursement intégral",
      "paragraphs": [
        "Dans les cas suivants, un remboursement intégral ou un réémission sera traité après vérification des raisons."
      ],
      "bullets": [
    ...
    },
    {
      ...
      "paragraphs": [
        ...
        "Les remboursements seront effectués par le moyen de paiement utilisé, et selon les politiques de la société de carte ou de paiement, cela peut prendre de 3 à 7 jours ouvrables pour être reflété."
      ]
    }
  ],
  "effectiveLabel": "Date d'entrée en vigueur"
...
const d3 = {
  ...
  "intro": "Nous vous informons des services gratuits et des prix des produits payants.",
  "sections": [
    {
      "heading": "1. Gratuit",
      "paragraphs": [
        "**L'interprétation de saju (사주) et la consultation de la fortune du jour sont gratuites.** Aucune inscription n'est nécessaire.",
        "Vous pouvez voir à l'écran les huit caractères de votre natal chart, la force des cinq éléments, la force et la faiblesse du jour, l'énergie nécessaire actuellement, le score et le grade de votre fortune du jour, ainsi que les scores des quatre domaines de la vie."
      ]
    },
    {
      "heading": "2. Rapport de lecture de vie saju PDF et rapport de fortune de cette année (payant)",
      "paragraphs": [
        "Prix domestique {priceDomestic} (TVA incluse) · Prix international {priceGlobal}",
        "Nous vous fournirons un document PDF de **9 pages A4** contenant les résultats affichés à l'écran. Ce qui n'est pas affiché à l'écran — la force et la faiblesse du jour, l'énergie nécessaire actuellement, les dix dieux des quatre piliers et les positions marquantes dans ce saju, les détails de la correction de l'heure solaire, les quatre domaines de la vie vus dans le natal chart et les chiffres de référence, ainsi que la fortune de cette année — seront également inclus.",
        "Vous pouvez télécharger à nouveau jusqu'à **5 fois** avec la même commande. Cependant, si les valeurs d'entrée disparaissent en dehors de l'écran des résultats, vous ne pourrez pas les recréer, donc veuillez sauvegarder le fichier immédiatement après le paiement."
      ]
    },
    {
      ...
      "paragraphs": [
        ...
        "**International** — Vous pouvez payer via PayPal à travers PortOne.",
...
const d4 = {
  ...
  "sections": [
    ...
    },
    {
      ...
      "bullets": [
        "Adresse IP de connexion, date et heure de connexion, type de navigateur, etc. en tant qu'enregistrements de connexion serveur généraux",
        "Informations sur le pays — utilisées uniquement pour déterminer automatiquement la langue de l'écran et ne sont pas conservées"
      ]
    },
    {
    ...
    },
    {
      ...
      "bullets": [
        "Numéro de commande et identifiant de paiement",
        "Montant du paiement, devise et état du paiement (non payé, payé, annulé)",
        "Type de produit, état de traitement, nombre de téléchargements de documents, date et heure de la commande",
    ...
    },
    {
      ...
      "paragraphs": [
        ...
        "Lorsque la vente de produits payants commence, les paiements nationaux seront confiés à Toss Payments, et les paiements internationaux à PortOne (PayPal). Les informations sur les moyens de paiement, telles que les numéros de carte et de compte, seront également directement traitées par ces entreprises, et le service ne les recevra pas."
      ]
    },
    {
  ...
  "sections": [
    {
      "heading": "1. Informations non conservées",
      "paragraphs": [
        "La date de naissance, l'heure de naissance, le lieu de naissance, le sexe et le nom utilisé saisis pour l'interprétation du saju ne sont **pas conservés nulle part.** Ils sont uniquement utilisés en mémoire du serveur pendant le traitement de la demande et disparaissent avec la réponse.",
        "Aucune donnée n'est enregistrée dans la base de données et aucun fichier séparé n'est conservé. Comme il n'y a pas d'inscription, les valeurs saisies ne sont pas liées à une personne spécifique."
      ]
    },
    {
    ...
    },
    {
      ...
      "paragraphs": [
        "Le service lui-même n'utilise pas de cookies pour suivre les utilisateurs.",
        "Actuellement, il n'y a pas de publicités affichées dans ce service. Si des publicités sont affichées à l'avenir, le fournisseur de publicité (par exemple, Google) peut utiliser des cookies pour l'affichage des publicités. Dans ce cas, cette clause sera d'abord modifiée pour clarifier ce qui change avant de commencer."
      ]
    },
    {
      "heading": "5. Informations conservées lors du paiement",
      "paragraphs": [
        "Lorsque vous payez pour un produit payant (rapport PDF), les informations de commande sont conservées pour le traitement du paiement et la conservation des enregistrements de transaction conformément à la législation.",
    ...
    },
    {
      ...
      "paragraphs": [
        ...
        "Les paiements domestiques sont traités par Toss Payments, tandis que les paiements internationaux sont traités par PayPal via PortOne. Les informations sur les moyens de paiement, telles que les numéros de carte et les numéros de compte, sont directement traitées par ces entreprises, et le service ne les reçoit ni ne les conserve."
      ]
    },
    {
      "heading": "7. Droits de l'utilisateur",
  ...
  "sections": [
    {
      "heading": "1. Nature du service",
      "paragraphs": [
        "Le service fournit des informations basées sur la date de naissance et l'heure de naissance saisies, en appliquant les règles de la divination traditionnelle coréenne (saju) pour afficher le natal chart et la force des cinq éléments, la force du jour, ainsi que les interactions entre le jour et le natal chart.",
        "Les scores et les interprétations fournis sont **des références selon la perspective de la divination traditionnelle et ne constituent pas des prédictions scientifiques ou des affirmations concernant l'avenir, la santé ou les biens d'un individu.** Un score bas ne signifie pas que la journée sera mauvaise, et un score élevé ne garantit rien.",
        "**Les phrases d'interprétation des rapports payants sont rédigées par une IA générative.** Cependant, tous les chiffres tels que les scores, les troncs célestes et la force des cinq éléments sont calculés par le moteur de règles du service, et l'IA ne modifie ni ne crée ces valeurs. Si aucune interprétation n'est produite, une description basée sur les valeurs calculées par le moteur sera insérée au même endroit, et le nombre de pages et les éléments inclus dans le document sont exactement ceux décrits au paragraphe 3 ci-dessous."
      ]
    },
    {
      "heading": "2. Frais d'utilisation",
      "paragraphs": [
        ...
        "Recevoir les résultats sous forme de rapport PDF est payant. Les prix et conditions sont affichés au paragraphe 3 ci-dessous et sur l'écran de paiement."
      ]
    },
    {
      "heading": "3. Produits payants et remboursements",
      "paragraphs": [
        "Le produit payant proposé est **un rapport PDF « Lecture de vie saju et fortune de l'année »**. Il s'agit de créer un document à partir des résultats affichés à l'écran, incluant des informations non visibles à l'écran.",
        "**9 pages A4** — couverture et résumé, traits de caractère innés et forces, points à surveiller, les huit caractères du natal chart et la force des cinq éléments, la force du jour et l'énergie nécessaire (yongshin), les dix dieux des quatre piliers et les positions marquantes dans ce saju, les quatre domaines de la vie vus dans le natal chart (richesse, amour, carrière, santé) et leurs justifications, les détails de la correction de l'heure de naissance, ainsi que la fortune de l'année. Paiement national {priceDomestic} (TVA incluse), paiement international {priceGlobal}.",
        "**La fortune du jour n'est pas incluse dans ce document.** Étant une valeur qui change chaque jour, elle est fournie gratuitement à l'écran, tandis que ce document est constitué d'une interprétation du natal chart qui ne changera jamais et de la fortune de l'année.",
        "Pour les paiements nationaux, vous pouvez utiliser des cartes de crédit, de débit et des paiements simplifiés (Toss Pay, Kakao Pay, Naver Pay, Payco, etc.) via Toss Payments, et pour les paiements internationaux, via PayPal à travers PortOne. Le montant final est celui affiché sur l'écran de paiement.",
        "**Le service ne conserve ni les valeurs saisies par l'utilisateur ni le fichier PDF généré.** Une fois le paiement approuvé, le document est créé et envoyé immédiatement, sans rien laisser sur le serveur. Par conséquent, le fichier téléchargé doit être conservé par l'utilisateur.",
      ...
      "bullets": [
        ...
        "**Les plaintes concernant le contenu des résultats** ne constituent pas un motif de remboursement. L'interprétation du saju est une référence selon la perspective de la divination traditionnelle, et sa nature est expliquée avant le paiement (voir paragraphe 1 ci-dessus).",
        "Une demande de réémission après avoir utilisé les 5 réémissions est considérée comme ne constituant pas un motif de remboursement.",
    ...
    },
    {
      ...
      "paragraphs": [
        "Tous les scores sont calculés selon des règles publiques, donc si les mêmes valeurs sont saisies, le même résultat sera toujours obtenu.",
        "Si l'heure de naissance n'est pas saisie, le calcul se fait sans le troncs célestes (시주), ce qui peut entraîner des résultats différents. Plus le lieu de naissance est choisi avec précision, plus le calcul du troncs célestes sera exact.",
    ...
    },
    {
      ...
      "paragraphs": [
        "Le service ne fournit que des références et ne peut être tenu responsable des jugements et des résultats basés sur ceux-ci pris par l'utilisateur.",
  ...
  "sections": [
    {
      ...
      "paragraphs": [
        ...
        "Aucune donnée n'est enregistrée dans la base de données, ni conservée dans un fichier séparé. Étant donné qu'il n'y a pas d'inscription, les valeurs saisies ne sont pas liées à une personne spécifique."
      ]
    },
    {
      ...
      "paragraphs": [
        ...
        "Si le lien des résultats est envoyé à une autre personne, cette personne pourra également voir les mêmes résultats. Le lien lui-même contient les valeurs saisies, donc la décision de partager ou non appartient à l'utilisateur."
      ]
    },
    {
      "heading": "3. Informations collectées automatiquement",
    ...
    },
    {
      "heading": "7. Droits de l'utilisateur",
      "paragraphs": [
        "Les valeurs saisies pour l'interprétation du saju ne sont pas conservées, donc il n'y a pas de demande d'accès, de correction ou de suppression à adresser. Les enregistrements de commande restants après paiement doivent être conservés pendant la période définie par la loi, et ne peuvent pas être supprimés pendant cette période, mais seront détruits après cette période.",
