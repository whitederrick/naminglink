  ...
  "sections": [
    {
      ...
      "paragraphs": [
        "Ngày tháng năm sinh, giờ sinh, nơi sinh, giới tính, và tên gọi được nhập vào saju (사주) **không được lưu trữ ở bất kỳ đâu.** Chúng chỉ được sử dụng trong bộ nhớ máy chủ trong quá trình xử lý yêu cầu và sẽ biến mất cùng với phản hồi.",
        "Không được ghi lại trong cơ sở dữ liệu và cũng không được lưu trữ trong tệp riêng. Do không có đăng ký thành viên, các giá trị nhập vào cũng không được liên kết với bất kỳ cá nhân nào."
      ]
    },
    {
    ...
    },
    {
      ...
      "paragraphs": [
        "Hiện tại không có thông tin nào được lưu trữ liên quan đến thanh toán vì không có sản phẩm trả phí được bán.",
        "Khi bắt đầu bán hàng, các mục dưới đây sẽ được lưu trữ để xử lý thanh toán và lưu giữ hồ sơ giao dịch theo quy định pháp luật. **Ngay cả lúc đó, các giá trị nhập vào cho saju (사주) và PDF được tạo ra sẽ không được lưu trữ**, và cũng không nhận thông tin nhận diện như tên, liên lạc, địa chỉ của người sử dụng."
      ],
      "bullets": [
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphs": [
        ...
        "Khi bắt đầu bán sản phẩm trả phí (một báo cáo PDF), các điều kiện trong mục 3 dưới đây sẽ được áp dụng. Trước khi bắt đầu bán, các điều khoản này sẽ được thông báo lại."
      ]
    },
    {
...
const d2 = {
  ...
  "intro": "Tiêu chí hủy bỏ và hoàn tiền cho báo cáo saju (사주) PDF. Chúng tôi đã tập hợp các nội dung như trong điều khoản 3.",
  "sections": [
    {
      "heading": "1. Tính chất của sản phẩm",
      "paragraphs": [
        "Sản phẩm được bán là **「Báo cáo cuộc sống saju và vận mệnh năm nay」 PDF (A4 9 trang) duy nhất** và là nội dung kỹ thuật số được tạo ra ngay lập tức sau khi thanh toán được phê duyệt.",
        "**Dịch vụ không lưu trữ thông tin đầu vào của người dùng cũng như tệp PDF đã tạo.** Do đó, tệp đã tải xuống phải được người dùng tự bảo quản."
      ]
    },
    {
      "heading": "2. Hủy bỏ đơn đặt hàng",
      "paragraphs": [
        "Tuân theo các tiêu chí được quy định bởi Luật Thương mại điện tử."
      ],
      "bullets": [
    ...
    },
    {
      ...
      "paragraphs": [],
      "bullets": [
        "**Sự không hài lòng về nội dung kết quả.** Giải thích saju (사주) là tài liệu tham khảo từ quan điểm truyền thống và đã được thông báo trước khi thanh toán.",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphs": [
        ...
        "Chúng tôi sẽ tạo một tài liệu PDF dài **9 trang A4** từ kết quả trên màn hình. Những thông tin không hiển thị trên màn hình — độ mạnh yếu của ngày, năng lượng cần thiết hiện tại, mười thần của bốn cột và vị trí nổi bật trong saju (사주) này, Vương Tương Hưu Tử, bốn lĩnh vực trong cuộc sống theo saju (사주) và các số liệu cơ sở, thông tin điều chỉnh giờ sinh, vận mệnh năm nay — sẽ được bao gồm trong tài liệu này.",
    ...
    },
    {
      ...
      "paragraphs": [
        "**Trong nước** — Bạn có thể sử dụng thẻ tín dụng, thẻ ghi nợ và thanh toán nhanh (Toss Payments, KakaoPay, NaverPay, Payco, v.v.) thông qua Toss Payments.",
        "**Quốc tế** — Bạn có thể thanh toán qua PayPal thông qua PortOne.",
        "Số tiền thanh toán cuối cùng sẽ được xác định theo số tiền hiển thị trên màn hình thanh toán."
      ]
    },
    {
      "heading": "5. Thay đổi giá",
      "paragraphs": [
        "Nếu có thay đổi giá, chúng tôi sẽ công bố trên trang này trước. Giá đã thanh toán cho đơn hàng sẽ không bị ảnh hưởng bởi giá đã thay đổi."
      ]
    }
  ],
  "effectiveLabel": "Ngày có hiệu lực"
...
const d4 = {
  ...
  "sections": [
    ...
    },
    {
      "heading": "4. Cookie và quảng cáo",
      "paragraphs": [
        "Dịch vụ không sử dụng cookie để xác định hoặc theo dõi người dùng. Thông tin nhập vào trong saju (사주) không được chuyển cho các nhà quảng cáo.",
      ...
      "bullets": [
        ...
        "Đối với người dùng ở Khu vực Kinh tế Châu Âu, Vương quốc Anh và Thụy Sĩ, sẽ hỏi ý kiến trước khi sử dụng cookie quảng cáo."
      ]
    },
    {
      "heading": "5. Thông tin được lưu trữ khi thanh toán",
      "paragraphs": [
        ...
        "Khi bắt đầu bán hàng, các mục dưới đây sẽ được lưu trữ để xử lý thanh toán và bảo tồn hồ sơ giao dịch theo quy định pháp luật. **Ngay cả lúc đó, các giá trị nhập vào trong saju (사주) và PDF được tạo ra sẽ không được lưu trữ**, và cũng không nhận thông tin xác định người dùng như tên, thông tin liên lạc, địa chỉ."
      ],
      "bullets": [
        "Số đơn hàng và mã nhận diện thanh toán",
        "Số tiền thanh toán, loại tiền tệ và trạng thái thanh toán (chưa thanh toán, đã thanh toán, hủy bỏ)",
    ...
    },
    {
      ...
      "paragraphs": [
        "Không có thông tin cá nhân nào được lưu trữ, vì vậy cũng không có thông tin cá nhân nào được cung cấp cho bên thứ ba.",
        "Để vận hành dịch vụ, chúng tôi sử dụng hạ tầng lưu trữ của {hostingProvider}, và trong quá trình này, các ghi chép truy cập được xử lý theo chính sách của nhà cung cấp đó.",
        "Khi bắt đầu bán sản phẩm trả phí, thanh toán trong nước sẽ được ủy thác cho Toss Payments, và thanh toán quốc tế sẽ được ủy thác cho PortOne (PayPal). Thông tin về phương thức thanh toán như số thẻ, số tài khoản sẽ được các nhà cung cấp này xử lý trực tiếp, và dịch vụ sẽ không nhận được thông tin này."
      ]
    },
    {
...
const d5 = {
  ...
  "sections": [
    ...
    },
    {
      "heading": "3. Thông tin được thu thập tự động",
      "paragraphs": [
        "Không có thông tin nào được thu thập để xác định người sử dụng. Tuy nhiên, một số ghi chép tối thiểu cần thiết cho việc vận hành dịch vụ web sẽ được tự động lưu lại bởi nhà cung cấp hạ tầng."
      ],
      "bullets": [
        "Địa chỉ IP truy cập, thời gian truy cập, loại trình duyệt và các ghi chép truy cập máy chủ thông thường",
        "Thông tin quốc gia — chỉ được sử dụng để tự động xác định ngôn ngữ màn hình và không được lưu trữ"
    ...
    },
    {
      "heading": "5. Thông tin được lưu trữ khi thanh toán",
      "paragraphs": [
        "Khi thanh toán cho sản phẩm trả phí (báo cáo PDF), thông tin đơn hàng sẽ được lưu trữ để xử lý thanh toán và bảo tồn hồ sơ giao dịch theo quy định pháp luật.",
        "**Các giá trị nhập vào cho saju (사주) và PDF được tạo ra sẽ không được lưu trữ ngay cả khi đã thanh toán.** Nguyên tắc ở mục 1 vẫn giữ nguyên bất kể có thanh toán hay không. Các mục được lưu trữ bao gồm, nhưng không giới hạn ở, thông tin nhận dạng người sử dụng như tên, thông tin liên lạc và địa chỉ không được bao gồm."
      ],
      "bullets": [
        "Số đơn hàng và mã nhận diện thanh toán",
        "Số tiền thanh toán, loại tiền tệ và trạng thái thanh toán (chưa thanh toán, đã thanh toán, hủy bỏ)",
        "Phân loại sản phẩm, trạng thái xử lý, số lần tải xuống tài liệu, thời gian đặt hàng",
        "Ngôn ngữ màn hình tại thời điểm đặt hàng và phân loại khu vực thanh toán (trong nước, quốc tế)",
    ...
    },
    {
      "heading": "7. Quyền của người sử dụng",
      "paragraphs": [
        "Không có đối tượng nào để yêu cầu xem, chỉnh sửa hoặc xóa vì các giá trị nhập vào cho saju (사주) không được lưu trữ. Hồ sơ đơn hàng còn lại sau khi thanh toán có nghĩa vụ phải được lưu giữ trong thời gian quy định bởi pháp luật, vì vậy không thể xóa trong thời gian này, và sau khi hết thời gian sẽ bị tiêu hủy.",
        "Người sử dụng có thể xóa tất cả dấu vết nhập vào chỉ bằng cách xóa liên kết kết quả trong thanh địa chỉ của trình duyệt.",
        "Nếu có bất kỳ câu hỏi nào liên quan đến việc sử dụng dịch vụ, vui lòng cho chúng tôi biết qua thông tin liên lạc dưới đây."
      ]
    },
  ...
  "sections": [
    {
      "heading": "1. Tính chất của dịch vụ",
      "paragraphs": [
        "Dịch vụ cung cấp thông tin dựa trên ngày tháng năm sinh và giờ sinh đã nhập, áp dụng các quy tắc của phong thủy truyền thống (saju) để hiển thị bản đồ saju và sức mạnh của ngũ hành, độ mạnh yếu của ngày sinh, cũng như thông tin về ngày hôm đó và vị trí giao thoa với bản đồ saju.",
        "Các điểm số và giải thích được đưa ra chỉ là **tài liệu tham khảo từ góc độ phong thủy truyền thống, không phải là dự đoán khoa học hay khẳng định về tương lai, sức khỏe, tài sản của cá nhân.** Điểm số thấp không có nghĩa là ngày đó xấu, và điểm số cao không đảm bảo điều gì cả.",
        "**Các câu giải thích trong báo cáo trả phí được viết bởi AI tạo sinh.** Tuy nhiên, tất cả các số liệu như điểm số, can chi, sức mạnh ngũ hành đều được tính toán bởi động cơ quy tắc của dịch vụ, và AI không thay đổi hay tạo ra các giá trị đó. Trong trường hợp không thể tạo ra giải thích, mô tả được viết dựa trên giá trị đã được động cơ tính toán, và số lượng trang tài liệu cùng các mục được ghi như đã nêu trong điều 3 dưới đây."
      ]
    },
    {
      "heading": "2. Phí sử dụng",
      "paragraphs": [
        "Việc giải đoán saju và tra cứu vận may hôm nay là miễn phí và không cần đăng ký thành viên.",
        "Nhận kết quả dưới dạng báo cáo PDF là dịch vụ trả phí. Giá cả và điều kiện sẽ được hiển thị trong điều 3 dưới đây và trên màn hình thanh toán."
      ]
    },
    {
      "heading": "3. Sản phẩm trả phí và hoàn tiền",
      "paragraphs": [
        "Sản phẩm trả phí được bán là **một báo cáo PDF về saju trọn đời và vận may trong năm**. Đây là việc tạo tài liệu từ kết quả trên màn hình, và sẽ bao gồm các nội dung không có trên màn hình.",
        "**9 trang A4** — bìa và tóm tắt, xu hướng bẩm sinh và điểm mạnh, những điều cần chú ý, tám ký tự trong bản đồ saju và sức mạnh ngũ hành, độ mạnh yếu của ngày sinh và năng lượng cần thiết hiện tại (dung thần), mười thần trong bốn cột và vị trí nổi bật trong saju này, bốn lĩnh vực cuộc sống được nhìn từ bản đồ saju (tài chính, tình cảm, nghề nghiệp, sức khỏe) và cơ sở của chúng, thông tin điều chỉnh giờ sinh, và vận may trong năm sẽ được bao gồm. Giá thanh toán trong nước là {priceDomestic} (bao gồm thuế giá trị gia tăng), giá thanh toán quốc tế là {priceGlobal}.",
        "**Vận may hôm nay sẽ không được bao gồm trong tài liệu này.** Giá trị thay đổi hàng ngày và được cung cấp miễn phí trên màn hình, trong khi tài liệu này bao gồm giải đoán bản đồ saju không thay đổi suốt đời và vận may trong năm.",
        ...
        "Trong trường hợp tải xuống bị ngừng hoặc tệp bị mất, bạn có thể tải xuống lại **tối đa 5 lần** với cùng một đơn hàng. Tuy nhiên, nếu thông tin đầu vào bị mất khi ra ngoài màn hình kết quả, bạn sẽ không thể tạo lại, vì vậy hãy lưu tệp ngay sau khi thanh toán."
      ],
      "bullets": [
        ...
        "**Các khiếu nại về nội dung kết quả** không thuộc lý do hoàn tiền. Việc giải đoán saju chỉ là tài liệu tham khảo từ góc độ phong thủy truyền thống và đã được thông báo trước khi thanh toán (xem điều 1 trên).",
    ...
    },
    {
      ...
      "paragraphs": [
        ...
        "Việc tính toán vận mệnh sử dụng thư viện tính toán công khai, và có thể có sự khác biệt trong kết quả do cách xử lý thời điểm và tiết khí."
      ]
    },
    {
...
const d7 = {
  ...
  "sections": [
    ...
    },
    {
      "heading": "3. Thông tin được thu thập tự động",
      "paragraphs": [
        "Không có thông tin nào được thu thập để nhận diện người sử dụng. Tuy nhiên, một số ghi chép tối thiểu cần thiết cho việc vận hành dịch vụ được tự động lưu lại bởi nhà cung cấp hạ tầng."
      ],
      "bullets": [
        "Địa chỉ IP truy cập, thời gian truy cập, loại trình duyệt và các ghi chép truy cập máy chủ thông thường",
        "Thông tin quốc gia — chỉ được sử dụng để tự động xác định ngôn ngữ hiển thị và không được lưu trữ"
    ...
    },
    {
      "heading": "4. Cookie và quảng cáo",
      "paragraphs": [
        "Dịch vụ không sử dụng cookie để nhận diện hoặc theo dõi người sử dụng. Thông tin nhập vào trong saju (사주) không được chuyển cho các nhà quảng cáo.",
        "Dịch vụ này hiển thị quảng cáo thông qua Google AdSense. Trong quá trình này, các sự kiện sau sẽ xảy ra."
      ],
      "bullets": [
        ...
        "Người sử dụng có thể tắt quảng cáo tùy chỉnh trong cài đặt quảng cáo của Google (google.com/settings/ads). Dù tắt, quảng cáo vẫn sẽ hiển thị, nhưng mức độ liên quan đến người sử dụng sẽ giảm.",
        "Quảng cáo tùy chỉnh của các nhà cung cấp bên thứ ba có thể được tắt cùng một lúc tại aboutads.info/choices.",
        "Cũng có thể chặn cookie trong cài đặt trình duyệt.",
        "Đối với người sử dụng ở Khu vực Kinh tế Châu Âu, Vương quốc Anh và Thụy Sĩ, trước khi sử dụng cookie quảng cáo, chúng tôi sẽ hỏi ý kiến đồng ý."
      ]
    },
    {
      "heading": "5. Thông tin được lưu trữ khi thanh toán",
      "paragraphs": [
        ...
        "**Các giá trị nhập vào trong saju (사주) và PDF được tạo ra sẽ không được lưu trữ ngay cả khi đã thanh toán.** Nguyên tắc ở mục 1 vẫn giữ nguyên bất kể có thanh toán hay không. Các mục được lưu trữ bao gồm, nhưng không giới hạn ở, thông tin nhận diện người sử dụng như tên, thông tin liên lạc, địa chỉ."
      ],
      "bullets": [
        "Số đơn hàng và mã nhận diện thanh toán",
        "Số tiền thanh toán, loại tiền tệ và trạng thái thanh toán (chưa thanh toán, đã thanh toán, hủy bỏ)",
    ...
    },
    {
      "heading": "6. Cung cấp cho bên thứ ba và ủy thác xử lý",
      "paragraphs": [
        "Vì không lưu trữ thông tin cá nhân nhận diện người sử dụng, nên cũng không có thông tin cá nhân nào được cung cấp cho bên thứ ba. Việc xử lý thanh toán được ủy thác cho các nhà cung cấp dưới đây.",
    ...
    },
    {
      "heading": "7. Quyền của người sử dụng",
      "paragraphs": [
        "Vì không lưu trữ các giá trị nhập vào trong saju (사주), nên không có đối tượng nào để yêu cầu xem, chỉnh sửa hoặc xóa. Hồ sơ đơn hàng còn lại sau khi thanh toán có nghĩa vụ phải được lưu giữ trong thời gian quy định bởi pháp luật, vì vậy không thể xóa trong thời gian này, và sẽ bị tiêu hủy sau khi hết thời gian.",
        "Người sử dụng có thể xóa tất cả dấu vết nhập vào chỉ bằng cách xóa liên kết kết quả trong thanh địa chỉ của trình duyệt.",
