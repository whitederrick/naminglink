...
const d0 = {
  ...
  "intro": "Saju-Link non memorizza informazioni necessarie per la lettura del saju (사주). Questa informativa descrive quali dati vengono ricevuti, quali non vengono conservati e quali vengono registrati automaticamente.",
  "sections": [
    {
    ...
    },
    {
      ...
      "paragraphs": [
        ...
        "Attualmente non ci sono annunci pubblicati in questo servizio. Se in futuro verranno pubblicati annunci, i fornitori di annunci (ad esempio Google) potrebbero utilizzare cookie per la pubblicazione degli annunci. In tal caso, questa clausola sarà modificata per chiarire cosa cambia prima di iniziare."
      ]
    },
    {
      ...
      "paragraphs": [
        ...
        "Quando inizieremo a vendere, le seguenti informazioni saranno memorizzate per il trattamento dei pagamenti e la conservazione dei registri delle transazioni ai sensi della legge: **anche in quel caso, i valori inseriti per la lettura del saju (사주) e il PDF generato non saranno memorizzati**, né raccoglieremo informazioni identificative come nome, contatto, indirizzo."
      ],
      "bullets": [
        ...
        "Periodo di conservazione — ai sensi dell'articolo 6 della legge sulla protezione dei consumatori nel commercio elettronico, i registri relativi al pagamento e alla fornitura di beni saranno conservati per 5 anni, mentre i registri relativi a reclami o controversie dei consumatori saranno conservati per 3 anni e poi distrutti."
      ]
    },
    {
      ...
      "paragraphs": [
        ...
        "Utilizziamo l'infrastruttura di hosting di {hostingProvider} per il funzionamento del servizio e, in questo processo, i registri di accesso di cui al punto 3 sono trattati secondo le politiche di quel fornitore.",
    ...
    },
    {
      ...
      "paragraphs": [
        "In caso di modifica di questa informativa, la data di entrata in vigore e le modifiche saranno pubblicate su questa pagina. Se ci sono cambiamenti effettivi nel trattamento, come la pubblicazione di annunci o l'inizio della vendita di prodotti a pagamento, informeremo prima della modifica."
      ]
    }
  ],
  ...
  "sections": [
    {
      ...
      "paragraphs": [
        "Il servizio mostra un riferimento basato sulla data di nascita e sull'ora di nascita applicando le regole della tradizionale astrologia coreana (saju) per visualizzare il grafico natale e il potere dei cinque elementi, la forza e la debolezza del giorno, e la posizione in cui il giorno e il grafico natale si incontrano.",
        "I punteggi e le spiegazioni forniti sono **materiale di riferimento dal punto di vista dell'astrologia tradizionale e non costituiscono previsioni scientifiche o affermazioni sul futuro, la salute o la ricchezza di un individuo.** Un punteggio basso non significa che il giorno sia negativo e un punteggio alto non garantisce nulla.",
        "**Le frasi di spiegazione dei rapporti a pagamento sono scritte da un'IA generativa.** Tuttavia, tutti i valori come punteggio, segni e potere degli elementi sono calcolati dal motore di regole del servizio e l'IA non modifica o crea nuovi valori. Se non è possibile generare una spiegazione, viene utilizzata una descrizione basata sui valori calcolati dal motore, e il numero di pagine e gli elementi inclusi nel documento sono esattamente quelli descritti nel paragrafo 3 sottostante."
      ]
    },
    {
      ...
      "paragraphs": [
        ...
        "Quando inizieremo a vendere prodotti a pagamento (due rapporti PDF), si applicheranno le condizioni del paragrafo 3 sottostante. Prima dell'inizio delle vendite, questi termini saranno nuovamente comunicati."
      ]
    },
    {
      "heading": "3. Prodotti a pagamento e rimborsi",
      "paragraphs": [
        "I prodotti a pagamento in vendita sono **due rapporti PDF**. Entrambi forniscono un documento con i risultati visualizzati sullo schermo, insieme a contenuti non presenti sullo schermo.",
        "**Rapporto di lettura della vita saju PDF (A4 5 pagine)** — Include le inclinazioni e i punti di forza innati, le otto lettere del grafico natale, il potere degli elementi e la forza e debolezza del giorno, l'energia necessaria al momento, l'oroscopo di oggi e le quattro aree della vita (finanze, affetti, professione, salute). Prezzo per pagamenti nazionali {priceDomestic} (IVA inclusa), prezzo per pagamenti internazionali {priceGlobal}.",
        "**Rapporto di lettura della vita premium PDF (A4 7 pagine)** — Aggiunge due pagine ai cinque del rapporto principale. Include i dieci segni delle quattro colonne e la posizione delle energie stagionali, l'oroscopo dell'anno, le variazioni dei punteggi di oggi per ciascun elemento, e le correzioni per l'ora di nascita. Prezzo per pagamenti nazionali {priceAffinityDomestic} (IVA inclusa), prezzo per pagamenti internazionali {priceAffinityGlobal}.",
      ...
      "bullets": [
        ...
        "**Dopo il completamento del download,** il recesso per semplice ripensamento è limitato. Si tratta di contenuti digitali forniti immediatamente e non è possibile ripristinare la situazione originale, il che rientra nelle cause di limitazione del recesso ai sensi dell'articolo 17, comma 2, della Legge sulla protezione dei consumatori nel commercio elettronico.",
        "**In caso di errore di sistema che impedisce la creazione del documento, file non apribili o importo di pagamento diverso da quello dell'ordine,** verrà effettuata una riemissione o un rimborso completo.",
        "**Le lamentele sui contenuti dei risultati** non costituiscono motivo di rimborso. L'interpretazione del saju è materiale di riferimento dal punto di vista dell'astrologia tradizionale e la sua natura è stata comunicata prima del pagamento (vedi paragrafo 1).",
    ...
    },
    {
      ...
      "paragraphs": [
        "L'utente può inserire la data di nascita di un'altra persona, ma non deve utilizzare i risultati in modo da danneggiare l'altra persona.",
    ...
    },
    {
      ...
      "bullets": [
        ...
        "Presentare i risultati del servizio come fatti o come valutazioni di esperti",
        "Copiare o modificare il servizio per fornire un servizio identico"
      ]
    },
    {
      ...
      "paragraphs": [
        ...
        "Non ci assumiamo responsabilità per danni derivanti dall'interruzione del servizio per cause al di fuori del nostro controllo, come eventi naturali o guasti dei fornitori di infrastrutture."
      ]
    },
    {
      "heading": "8. Diritti di proprietà intellettuale",
      "paragraphs": [
        "I diritti sullo schermo del servizio, sul testo e sull'implementazione delle regole di calcolo appartengono all'operatore. L'utente può salvare o condividere i risultati per scopi personali."
      ]
    },
    {
  ...
  "sections": [
    {
      ...
      "paragraphs": [
        "I prodotti in vendita sono **rapporto di lettura della vita saju (사주) PDF (A4 5 pagine)** e **rapporto premium di lettura della vita saju (사주) PDF (A4 7 pagine)**, entrambi contenuti digitali che vengono creati e inviati immediatamente dopo l'approvazione del pagamento.",
    ...
    },
    {
      ...
      "bullets": [
        ...
        "**Dopo il completamento del download,** il diritto di recesso per semplice ripensamento è limitato. Si tratta di contenuti digitali forniti immediatamente dopo il pagamento, per i quali non è possibile il ripristino, e ciò rientra nei motivi di limitazione stabiliti dall'articolo 17, comma 2 della legge sulla protezione dei consumatori nel commercio elettronico. Questa informazione viene comunicata e concordata nella schermata di pagamento."
      ]
    },
    {
      ...
      "bullets": [
        ...
        "**Se un minorenne ha effettuato il pagamento senza il consenso del legale rappresentante** — È possibile richiedere la cancellazione da parte del minorenne o del legale rappresentante."
      ]
    },
    {
      ...
      "paragraphs": [],
      "bullets": [
        "**Insoddisfazione riguardo al contenuto dei risultati.** L'interpretazione del saju (사주) è un materiale di riferimento secondo la prospettiva della tradizionale astrologia coreana, e la sua natura è stata comunicata prima del pagamento.",
        "Richiesta di riemissione dopo aver utilizzato tutte le 5 riemissioni."
      ]
    },
    {
      "heading": "5. Modalità di richiesta",
      "paragraphs": [
        "Per rimborsi e domande, si prega di contattare il servizio clienti ({customerCenter}) o via email ({email}). Se fornite anche il numero dell'ordine, la verifica sarà più rapida.",
...
const d3 = {
  ...
  "sections": [
    ...
    {
      "heading": "2. Rapporto di Lettura della Vita Saju PDF (a pagamento)",
      "paragraphs": [
        "Pagamento nazionale {priceDomestic} (IVA inclusa) · Pagamento internazionale {priceGlobal}",
        "Il risultato sullo schermo verrà trasformato in un documento PDF di **5 pagine A4**. Include copertina e riepilogo, inclinazioni e punti di forza innati, aspetti da considerare, la carta natale e il bilanciamento degli elementi, la fortuna di oggi e le quattro aree della vita in un unico documento.",
        "Puoi scaricare nuovamente fino a **5 volte** con lo stesso ordine. Tuttavia, se i valori di input scompaiono al di fuori dello schermo dei risultati, non sarà possibile ricrearlo, quindi ti preghiamo di salvare il file subito dopo il pagamento."
      ]
    },
    {
      "heading": "3. Rapporto Premium di Lettura della Vita Saju PDF (a pagamento)",
      "paragraphs": [
        "Pagamento nazionale {priceAffinityDomestic} (IVA inclusa) · Pagamento internazionale {priceAffinityGlobal}",
        "È un documento di **7 pagine A4** con **due pagine aggiuntive** rispetto al rapporto di lettura della vita. Le aggiunte includono i Dieci Segni delle Quattro Colonne e le correzioni di Jin Tai Yang Shi, oltre ai dettagli di aumento e diminuzione dei punteggi annuali e giornalieri. Questi numeri di riferimento non sono mostrati sullo schermo.",
        "Le condizioni per il riemissione sono le stesse del rapporto di lettura della vita."
      ]
    },
    {
...
const d4 = {
  "title": "Informativa sul trattamento dei dati personali",
  "intro": "Saju-Link non memorizza informazioni necessarie per l'interpretazione del saju (사주). Questa informativa descrive cosa viene ricevuto dal servizio, cosa non viene conservato e cosa viene registrato automaticamente.",
  "sections": [
    {
      "heading": "1. Informazioni non memorizzate",
      "paragraphs": [
    ...
    },
    {
      ...
      "bullets": [
        ...
        "Google utilizza cookie per pubblicare annunci basati sulla cronologia delle visite a questo sito e ad altri siti.",
    ...
    },
    {
      ...
      "bullets": [
        ...
        "Periodo di conservazione — secondo l'articolo 6 della legge sulla protezione dei consumatori nel commercio elettronico, i registri relativi ai pagamenti e alla fornitura di beni saranno conservati per 5 anni, mentre i registri relativi alla gestione dei reclami o delle controversie dei consumatori saranno conservati per 3 anni e poi distrutti."
      ]
    },
    {
      "heading": "6. Fornitura a terzi e delega al trattamento",
  ...
  "sections": [
    ...
    },
    {
      ...
      "paragraphs": [
        ...
        "Per il funzionamento del servizio, utilizziamo l'infrastruttura di hosting di {hostingProvider}, e durante questo processo, i registri di accesso di cui al punto 3 vengono trattati secondo le politiche di quel fornitore.",
    ...
    },
    {
      ...
      "paragraphs": [
        ...
        "Gli utenti possono eliminare tutte le tracce di input semplicemente cancellando il link dei risultati dalla barra degli indirizzi del browser.",
        "Se ci sono domande relative all'uso del servizio, si prega di contattare ai seguenti recapiti."
      ]
    },
    {
      "heading": "8. Dati personali dei minori",
    ...
    },
    {
      "heading": "10. Modifiche all'informativa",
      "paragraphs": [
        "In caso di modifica di questa informativa, la data di entrata in vigore e le modifiche saranno pubblicate su questa pagina. Se ci saranno cambiamenti effettivi nel trattamento, come l'inizio della pubblicazione di pubblicità o la vendita di prodotti a pagamento, verrà comunicato in anticipo."
      ]
    }
  ],
  "effectiveLabel": "Data di entrata in vigore"
...
const d6 = {
  "title": "Termini di utilizzo",
  "intro": "Questi termini stabiliscono le condizioni per l'utilizzo del servizio Saju-Link (di seguito \"Servizio\"). Utilizzando il servizio, si considera che si accettino questi termini.",
  "sections": [
    {
      "heading": "1. Natura del servizio",
      "paragraphs": [
        "Il servizio mostra un riferimento basato sulla data di nascita e sull'ora di nascita applicando le regole della tradizionale astrologia coreana (saju) per fornire il grafico natale e il bilanciamento dei cinque elementi, la forza e la debolezza del giorno, e la posizione in cui il giorno e il grafico natale si incontrano.",
        "I punteggi e le spiegazioni forniti sono **materiale di riferimento dal punto di vista della tradizionale astrologia coreana e non costituiscono previsioni scientifiche o affermazioni sul futuro, la salute o la ricchezza di un individuo.** Un punteggio basso non significa necessariamente che quel giorno sia negativo, e un punteggio alto non garantisce nulla.",
        "**Le frasi di spiegazione dei rapporti a pagamento sono scritte da un'IA generativa.** Tuttavia, tutti i punteggi, i segni e i valori dei cinque elementi sono calcolati dal motore di regole del servizio e l'IA non modifica o crea nuovi valori. Se non è possibile generare una spiegazione, viene inserita una descrizione basata sui valori calcolati dal motore, e il numero di pagine e gli elementi inclusi nel documento rimangono come indicato nel paragrafo 3 sottostante."
      ]
    },
    {
      "heading": "2. Tariffe di utilizzo",
    ...
    },
    {
      "heading": "3. Prodotti a pagamento e rimborsi",
      "paragraphs": [
        "I prodotti a pagamento in vendita sono **due tipi di rapporti PDF.** Entrambi trasformano i risultati visualizzati in un documento e includono contenuti non presenti nella schermata.",
        "**Rapporto di lettura della vita saju PDF (A4 5 pagine)** — Include le inclinazioni e i punti di forza innati, otto caratteri del grafico natale, la forza dei cinque elementi e la forza del giorno, l'energia necessaria al momento, la fortuna del giorno e le quattro aree della vita (denaro, amore, lavoro, salute). Prezzo per pagamenti nazionali {priceDomestic} (IVA inclusa), prezzo per pagamenti internazionali {priceGlobal}.",
        "**Rapporto premium di lettura della vita PDF (A4 7 pagine)** — Aggiunge due pagine ai cinque del rapporto principale. Include i dieci segni delle quattro colonne e il Wang Sang Hyu Su Sa (come le stagioni posizionano ciascuna energia), la fortuna dell'anno, le variazioni dei punteggi del giorno per ogni voce, e le correzioni per il tempo di Jin Tae Yang. Prezzo per pagamenti nazionali {priceAffinityDomestic} (IVA inclusa), prezzo per pagamenti internazionali {priceAffinityGlobal}.",
        "I pagamenti nazionali possono essere effettuati tramite Toss Payments utilizzando carte di credito/debito e pagamenti semplificati (Toss Pay, Kakao Pay, Naver Pay, Payco, ecc.), mentre i pagamenti internazionali sono tramite PayPal attraverso PortOne. L'importo finale è quello visualizzato nella schermata di pagamento.",
        "**Il servizio non conserva né i dati inseriti dall'utente né i file PDF generati.** Una volta approvato il pagamento, il documento viene creato e inviato immediatamente, senza lasciare nulla sul server. Pertanto, il file scaricato deve essere conservato dall'utente.",
      ...
      "bullets": [
        ...
        "**Dopo il completamento del download,** il recesso per semplice ripensamento è limitato. Si tratta di contenuti digitali forniti immediatamente e non ripristinabili, che rientrano nelle cause di limitazione del recesso ai sensi dell'articolo 17, comma 2, della Legge sulla protezione dei consumatori nel commercio elettronico.",
        ...
        "**Lamentele sui contenuti dei risultati** non costituiscono motivo di rimborso. La lettura del saju è materiale di riferimento dal punto di vista della tradizionale astrologia coreana e la sua natura è stata comunicata prima del pagamento (vedi paragrafo 1).",
        "Richieste di riemissione dopo aver utilizzato tutte le 5 volte non costituiscono motivo di rimborso.",
        "**Se un minorenne effettua un pagamento senza il consenso del legale rappresentante,** il minorenne o il legale rappresentante possono annullare il pagamento. Si prega di contattarci ai dettagli sottostanti per ricevere un rimborso."
      ]
    },
    {
      "heading": "4. Risultati dei calcoli",
      "paragraphs": [
        "Tutti i punteggi sono calcolati secondo regole pubbliche, quindi inserendo gli stessi valori si ottiene sempre lo stesso risultato.",
        "Se non si inserisce l'ora di nascita, il calcolo esclude il segno orario (時柱), quindi i risultati possono variare. Maggiore è la precisione nella scelta del luogo di nascita, più accurato sarà il calcolo del segno orario.",
        "Il calcolo del manseongyeok utilizza una libreria di calcolo pubblica e i risultati possono variare a seconda del trattamento delle stagioni e dei fusi orari."
      ]
    },
    {
      "heading": "5. Responsabilità dell'utente",
      "paragraphs": [
        "L'utente può inserire la data di nascita di un'altra persona, ma non deve utilizzare i risultati in modo da danneggiare tale persona.",
        "Non utilizzare i risultati del servizio come base per decisioni che influenzano i diritti di altri, come matrimonio, divorzio, assunzione, transazioni, ecc. Il servizio non è stato creato per tali scopi."
      ]
    },
    {
    ...
    },
    {
      "heading": "7. Esclusione di responsabilità",
      "paragraphs": [
        "Il servizio fornisce solo materiale di riferimento e non si assume responsabilità per le decisioni e i risultati derivanti da tali decisioni.",
        "In caso di interruzione del servizio per cause non controllabili, come eventi naturali o guasti dei fornitori di infrastrutture, non si assume responsabilità per i danni derivanti."
      ]
    },
    {
      "heading": "8. Diritti di proprietà intellettuale",
  ...
  "sections": [
    {
      "heading": "1. Informazioni non memorizzate",
      "paragraphs": [
        "La data di nascita, l'ora di nascita, il luogo di nascita, il sesso e il nome forniti per l'interpretazione del saju (사주) **non vengono memorizzati in alcun modo.** Vengono utilizzati solo nella memoria del server durante l'elaborazione della richiesta e scompaiono con la risposta.",
        "Non vengono registrati nel database e non vengono conservati in file separati. Non essendoci registrazione, i dati inseriti non sono collegati a persone specifiche."
      ]
    },
    {
      "heading": "2. Informazioni contenute nel link dei risultati",
      "paragraphs": [
        "L'indirizzo della schermata dei risultati contiene i valori di input codificati. Tuttavia, questo valore si trova dopo il # nell'indirizzo e, secondo gli standard web, il contenuto dopo il # non viene inviato dal browser al server. Pertanto, anche se si apre il link dei risultati, nel registro di accesso del server rimane solo il percorso dell'indirizzo.",
        "Se si invia il link dei risultati a un'altra persona, anche quella persona può vedere gli stessi risultati. Poiché il link stesso contiene i valori di input, la decisione di condividerlo spetta all'utente."
      ]
    },
    {
      "heading": "3. Informazioni raccolte automaticamente",
    ...
    },
    {
      ...
      "bullets": [
        "Fornitori terzi, inclusi Google, possono memorizzare o leggere cookie nel browser dell'utente.",
        "Google utilizza cookie per pubblicare annunci basati sulla cronologia di navigazione di questo sito e di altri siti.",
    ...
    },
    {
      ...
      "paragraphs": [
        ...
        "Per eventuali domande relative all'utilizzo del servizio, si prega di contattare ai seguenti recapiti."
      ]
    },
    {
      "heading": "8. Dati personali dei minori",
