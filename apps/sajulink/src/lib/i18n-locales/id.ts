...
export const id: Dictionary = {
  ...
  "form": {
    ...
    "todayIntro": "Hari ini, Fortune membangun dua karakter hari ini — sebuah batang dan sebuah cabang — dengan cara yang sama seperti pilar kelahiran Anda dibangun, kemudian memeriksanya terhadap natal chart Anda. Ini menambah dan mengurangi dari empat hal: apakah energi hari ini cocok dengan apa yang saat ini dibutuhkan oleh chart Anda, bagaimana batang hari ini berhubungan dengan day master Anda dalam istilah Lima Elemen, apakah cabang hari ini menggabungkan atau bertentangan dengan cabang-cabang di chart Anda, dan bagaimana chart yang kuat atau lemah menerima energi yang sama secara berbeda — semuanya dimulai dari skor dasar 50. Kekayaan, cinta, karir, dan kesehatan masing-masing mewarisi sebagian dari total tersebut dan menambahkan skor spesifik faktor mereka sendiri, sehingga dua orang dengan skor total yang sama masih dapat melihat angka yang berbeda per area.\nSetiap bobot dan batas grade yang digunakan di sini dipublikasikan dalam dokumen penjelasan di bawah.",
