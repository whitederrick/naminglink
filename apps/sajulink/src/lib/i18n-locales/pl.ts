...
export const pl: Dictionary = {
  ...
  "form": {
    ...
    "todayIntro": "Dzienna fortuna buduje własne dwa znaki dnia — pień i gałąź — w taki sam sposób, w jaki zbudowano twój filar urodzenia, a następnie porównuje je z twoim wykresem urodzeniowym. Dodaje i odejmuje w czterech kwestiach: czy energia dzisiejszego dnia pasuje do tego, czego obecnie potrzebuje twój wykres, jak dzisiejszy pień odnosi się do twojego dnia mistrza w kategoriach pięciu elementów, czy dzisiejsza gałąź łączy się lub koliduje z gałęziami twojego wykresu, oraz jak silny lub słaby wykres inaczej odbiera tę samą energię — wszystko zaczynając od podstawowego wyniku 50. Bogactwo, miłość, kariera i zdrowie dziedziczą część tej całkowitej wartości i dodają swoje własne specyficzne oceny, więc dwie osoby z tym samym całkowitym wynikiem mogą nadal widzieć różne liczby w każdej dziedzinie.\nKażda waga i granica ocen użyta tutaj jest opublikowana w dokumencie uzasadniającym poniżej.",
    "meLegend": "O tobie",
