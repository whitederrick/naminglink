...
export const ms: Dictionary = {
  ...
  "form": {
    ...
    "todayIntro": "Hari ini punya ramalan yang membina dua karakter hari ini — satu batang dan satu cabang — dengan cara yang sama seperti tiang kelahiran anda dibina, kemudian memeriksanya dengan carta kelahiran anda. Ia menambah dan mengurangkan empat perkara: sama ada tenaga hari ini sepadan dengan apa yang diperlukan oleh carta anda sekarang, bagaimana batang hari ini berkaitan dengan penguasa hari anda dalam istilah Lima Elemen, sama ada cabang hari ini bergabung atau bertentangan dengan cabang carta anda, dan bagaimana carta yang kuat atau lemah menerima tenaga yang sama dengan cara yang berbeza — semuanya bermula dari skor asas 50. Kekayaan, cinta, kerjaya, dan kesihatan masing-masing mewarisi sebahagian daripada jumlah itu dan menambah skor khusus faktor mereka sendiri, jadi dua orang dengan skor total yang sama masih boleh melihat nombor yang berbeza bagi setiap bidang.\nSetiap berat dan sempadan gred yang digunakan di sini diterbitkan dalam dokumen alasan di bawah.",
  ...
  "reportDetail": {
    ...
    "yongsinTitle": "Apa yang anda perlukan sekarang",
    "tenGodDepthTitle": "Apa yang menonjol dalam carta ini",
    "disclaimerTitle": "Cara membaca dokumen ini",
    "yearOutlookUnavailable": "Tiang tahun ini tidak dapat dibaca, jadi bahagian ini dibiarkan kosong. Segala yang terdapat pada halaman sebelum ini masih sah.",
    "factorsTitle": "Dari mana skor setiap kawasan berasal",
  ...
  "report": {
    "title": "Bacaan kehidupan dan tahun yang akan datang",
    "body": "Kami mengubah bacaan ini menjadi PDF dan menambah lapisan yang tidak ditunjukkan oleh skrin: kekuatan day master anda dan apa yang diperlukan sekarang, ten gods dari empat tiang anda, empat bidang kehidupan yang dibaca dari carta kelahiran anda dengan nombor di belakangnya, dan ramalan untuk tahun ini. Ramalan hari ini tidak termasuk — ia berubah setiap hari, jadi ia tetap percuma di skrin.",
    ...
    "contents": [
      ...
      "Natal chart anda dan berat lima elemen — lapan watak",
      "Kekuatan day master anda, dan tenaga yang diperlukan sekarang",
      "Kehidupan musiman dan ten gods dari empat tiang anda",
      "Apa yang menonjol dalam carta ini — ten gods yang tebal dan yang tidak ada",
      "Empat bidang kehidupan yang dibaca dari natal chart anda, dengan nombor di belakang setiap satu",
      "Pembetulan waktu solar sebenar, dan ramalan untuk tahun ini"
    ],
    ...
    "productInfo": [
      ...
      [
        "Format",
        "Satu dokumen PDF (9 halaman A4), dimuat turun di skrin sejurus selepas pembayaran."
      ],
      [
        "Keperluan",
  ...
  "fallbackReport": {
    ...
    "yongsinDepth": {
      "STRONG": "Elemen yang menyokong day master anda berjalan dengan penuh. Itu memberi anda dorongan sendiri tetapi mudah condong ke satu sisi, jadi apa yang anda perlukan sekarang bukanlah lebih banyak sokongan — ia adalah sesuatu untuk mengurangkan lebihan. {favorable} melakukan kerja itu. Di mana elemen itu sampai — mengeluarkan, mengambil, mengumpul — adalah di mana anda menetap.",
      "BALANCED": "Apa yang menyokong day master anda dan apa yang menarik daripadanya hampir seimbang. Terlalu dekat untuk dipanggil ke mana-mana arah, jadi di sini kita membaca apa yang paling nipis sebagai apa yang anda perlukan: {favorable}. Carta yang tidak condong menyesuaikan diri dengan baik tetapi mengaburkan garisnya sendiri, jadi mengarahkan ke arah tempat yang nipis memberi anda arah untuk dipegang.",
      "WEAK": "Elemen yang menyokong day master anda berjalan dengan nipis. Anda meminjam kekuatan dari sekeliling anda dengan baik tetapi cepat letih jika bertahan sendirian, jadi apa yang anda perlukan sekarang adalah sesuatu untuk menyokong anda dan mengisi anda. {favorable} melakukan kerja itu. Menjaga perkara yang menyokong dekat bukanlah kelemahan dalam carta ini — ia adalah kaedah."
    }
  },
  "footer": {
    "privacy": "Privasi",
