...
export const uz: Dictionary = {
  ...
  "form": {
    ...
    "todayIntro": "Bugungi taqdir, tug'ilgan kuningizdagi ustun va shoxni yaratish kabi, bugun uchun ikkita xarakter — bir asos va bir shox — hosil qiladi va ularni sizning natal jadvalingiz bilan solishtiradi. U to'rt narsani qo'shadi va ayiradi: bugungi energiya sizning jadvalingizda hozirda kerak bo'lgan energiyaga mos keladimi, bugungi asosning Oltita Elementlar nuqtai nazaridan sizning kun ustuniga qanday ta'siri bor, bugungi shox sizning jadvalingizdagi shoxlar bilan birlashadimi yoki to'qnashadimi, va kuchli yoki zaif jadval bir xil energiyani qanday farq bilan qabul qiladi — bularning barchasi 50 ballik asosiy balldan boshlanadi. Boylik, sevgi, kasb va salomatlik har biri ushbu umumiy ballning bir qismini meros qilib oladi va o'ziga xos ballarini qo'shadi, shuning uchun bir xil umumiy ballga ega bo'lgan ikki kishi har bir sohada turli raqamlarni ko'rishi mumkin.\nBu yerda ishlatilgan har bir og'irlik va daraja chegarasi quyidagi asoslash hujjatida e'lon qilingan.",
