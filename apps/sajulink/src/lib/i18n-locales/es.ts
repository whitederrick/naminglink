...
export const es: Dictionary = {
  ...
  "form": {
    ...
    "intro": "Saju-Link convierte una fecha y hora de nacimiento en los ocho caracteres de los cuatro pilares, luego lee qué fuerza elemental está ausente o desbordante a través de las relaciones de los Cinco Elementos y los Diez Dioses. El pilar de la hora se corrige a la hora solar verdadera en el lugar de nacimiento, y la Fortuna de Hoy puntúa veinte elementos de relación al comparar el pilar del día de hoy con este mismo gráfico.\nCada umbral y tabla de puntuación utilizada en el cálculo se publica en el documento de razonamiento a continuación.",
    "todayIntro": "La fortuna de hoy construye los dos caracteres del día — un tronco y una rama — de la misma manera en que se construyó tu pilar de nacimiento, y luego los compara con tu carta natal. Suma y resta en base a cuatro aspectos: si la energía de hoy coincide con lo que tu carta necesita actualmente, cómo se relaciona el tronco de hoy con tu maestro del día en términos de los Cinco Elementos, si la rama de hoy se combina o choca con las ramas de tu carta, y cómo una carta fuerte o débil recibe la misma energía de manera diferente — todo comenzando desde una puntuación base de 50. La riqueza, el amor, la carrera y la salud heredan cada uno parte de ese total y añaden su propia puntuación específica por factor, por lo que dos personas con la misma puntuación total aún pueden ver números diferentes por área.\nCada peso y límite de grado utilizado aquí se publica en el documento de razonamiento a continuación.",
    "meLegend": "Sobre ti",
