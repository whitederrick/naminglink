...
export const de: Dictionary = {
  ...
  "form": {
    ...
    "todayIntro": "Das heutige Glück baut die beiden Zeichen des Tages — einen Stamm und einen Zweig — auf die gleiche Weise auf, wie dein Geburts-Pfeiler erstellt wurde, und überprüft sie dann gegen dein Geburtshoroskop. Es addiert und subtrahiert in vier Aspekten: ob die Energie von heute mit dem übereinstimmt, was dein Horoskop derzeit benötigt, wie der heutige Stamm in Bezug auf deinen Tagesmeister in den fünf Elementen steht, ob der heutige Zweig mit den Zweigen deines Horoskops kombiniert oder kollidiert, und wie ein starkes oder schwaches Horoskop die gleiche Energie unterschiedlich aufnimmt — alles beginnt mit einem Basiswert von 50. Wohlstand, Liebe, Karriere und Gesundheit erben jeweils einen Teil dieses Gesamtwerts und fügen ihre eigenen, faktorspezifischen Bewertungen hinzu, sodass zwei Personen mit demselben Gesamtwert dennoch unterschiedliche Zahlen in den einzelnen Bereichen sehen können.\nJede Gewichtung und jede Notengrenze, die hier verwendet wird, ist im untenstehenden Dokument zur Begründung veröffentlicht.",
    "meLegend": "Über Sie",
