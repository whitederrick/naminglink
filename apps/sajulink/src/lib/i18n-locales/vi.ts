...
export const vi: Dictionary = {
  ...
  "form": {
    ...
    "todayIntro": "Vận mệnh hôm nay xây dựng hai ký tự của ngày — một cành và một nhánh — theo cách giống như cột sinh của bạn được xây dựng, sau đó kiểm tra chúng với biểu đồ sinh của bạn. Nó cộng và trừ qua bốn điều: liệu năng lượng hôm nay có phù hợp với những gì biểu đồ của bạn hiện cần, cách mà cành hôm nay liên quan đến chủ ngày của bạn theo các yếu tố Ngũ hành, liệu nhánh hôm nay có kết hợp hay xung khắc với các nhánh trong biểu đồ của bạn, và cách mà một biểu đồ mạnh hoặc yếu tiếp nhận cùng một năng lượng khác nhau — tất cả bắt đầu từ điểm cơ bản là 50. Tài sản, tình yêu, sự nghiệp và sức khỏe mỗi lĩnh vực thừa hưởng một phần tổng số đó và thêm vào điểm số cụ thể theo yếu tố của riêng mình, vì vậy hai người có cùng tổng điểm vẫn có thể thấy các con số khác nhau theo từng lĩnh vực.\nMọi trọng số và ranh giới cấp bậc được sử dụng ở đây đều được công bố trong tài liệu lý do bên dưới.",
    "meLegend": "Về bạn",
    "nickname": "Cách gọi",
