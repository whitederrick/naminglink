...
export const pt: Dictionary = {
  ...
  "form": {
    ...
    "todayIntro": "A sorte de hoje constrói os dois caracteres do dia — um tronco e um ramo — da mesma forma que seu pilar de nascimento foi construído, e então os verifica em relação ao seu mapa natal. Ela adiciona e subtrai em quatro aspectos: se a energia de hoje corresponde ao que seu mapa atualmente precisa, como o tronco de hoje se relaciona com seu dia mestre em termos dos Cinco Elementos, se o ramo de hoje combina ou conflita com os ramos do seu mapa, e como um mapa forte ou fraco recebe a mesma energia de forma diferente — tudo começando de uma pontuação base de 50. Riqueza, amor, carreira e saúde herdam cada um parte desse total e adicionam sua própria pontuação específica, então duas pessoas com a mesma pontuação total ainda podem ver números diferentes por área.\nCada peso e limite de grau usado aqui está publicado no documento de raciocínio abaixo.",
    "meLegend": "Sobre você",
