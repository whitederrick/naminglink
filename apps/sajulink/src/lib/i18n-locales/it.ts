...
export const it: Dictionary = {
  ...
  "form": {
    ...
    "todayIntro": "La fortuna di oggi costruisce i due caratteri del giorno — un tronco e un ramo — nello stesso modo in cui è stato costruito il tuo pilastro di nascita, quindi li confronta con il tuo grafico natale. Aggiunge e sottrae quattro elementi: se l'energia di oggi corrisponde a ciò di cui il tuo grafico ha attualmente bisogno, come il tronco di oggi si relaziona al tuo giorno maestro in termini di Cinque Elementi, se il ramo di oggi si combina o si scontra con i rami del tuo grafico, e come un grafico forte o debole riceve la stessa energia in modo diverso — tutto partendo da un punteggio base di 50. Ricchezza, amore, carriera e salute ereditano ciascuna parte di quel totale e aggiungono il proprio punteggio specifico per fattore, quindi due persone con lo stesso punteggio totale possono comunque vedere numeri diversi per area.\nOgni peso e confine di grado utilizzato qui è pubblicato nel documento di ragionamento qui sotto.",
  ...
  "result": {
    ...
    "seeToday": "Guarda l'oroscopo di oggi",
    "seeReading": "Guarda il tuo grafico natale"
  },
  "today": {
