...
export const tr: Dictionary = {
  ...
  "form": {
    ...
    "todayIntro": "Bugünün Şansı, doğduğunuz günün sütununu oluşturduğu gibi, bugünün kendi iki karakterini — bir gövde ve bir dal — oluşturur ve bunları doğum haritanızla karşılaştırır. Bugünün enerjisinin, haritanızın şu anda ihtiyaç duyduğu enerjiyle örtüşüp örtüşmediğini, bugünün gövdesinin Beş Element terimleriyle gün ustanızla nasıl ilişkili olduğunu, bugünün dalının haritanızın dallarıyla birleşip birleşmediğini veya çatışıp çatışmadığını ve güçlü veya zayıf bir haritanın aynı enerjiyi nasıl farklı algıladığını kontrol eder — tüm bunlar 50 temel puandan başlar. Zenginlik, aşk, kariyer ve sağlık her biri bu toplamdan bir kısmını miras alır ve kendi faktörlerine özgü puanlamalarını ekler, bu nedenle aynı toplam puana sahip iki kişi bile alan başına farklı sayılar görebilir.\nBurada kullanılan her ağırlık ve derece sınırı, aşağıdaki gerekçe belgesinde yayımlanmıştır.",
    "meLegend": "Hakkınızda",
