...
export const fil: Dictionary = {
  ...
  "form": {
    ...
    "todayIntro": "Ang Fortune ng araw ay bumubuo ng dalawang karakter ng araw — isang stem at isang branch — sa parehong paraan na itinayo ang iyong birth pillar, at pagkatapos ay sinusuri ang mga ito laban sa iyong natal chart. Idinadagdag at ibinabawas nito ang apat na bagay: kung ang enerhiya ng araw na ito ay tumutugma sa kasalukuyang pangangailangan ng iyong chart, kung paano nauugnay ang stem ng araw na ito sa iyong day master sa mga tuntunin ng Five Elements, kung ang branch ng araw na ito ay nag-uugnay o sumasalungat sa mga branch ng iyong chart, at kung paano tinatanggap ng isang malakas o mahina na chart ang parehong enerhiya nang iba — lahat ay nagsisimula mula sa isang base score na 50. Ang yaman, pag-ibig, karera, at kalusugan ay bawat isa ay nagmamana ng bahagi ng kabuuang iyon at nagdadagdag ng kanilang sariling factor-specific scoring, kaya't ang dalawang tao na may parehong kabuuang score ay maaari pa ring makakita ng iba't ibang numero sa bawat larangan.\nBawat timbang at hangganan ng grado na ginamit dito ay nailathala sa dokumento ng pangangatwiran sa ibaba.",
  ...
  "fallbackReport": {
    ...
    "yongsinDepth": {
      "STRONG": "Ang mga elemento na sumusuporta sa iyong day master ay puno. Nagbibigay ito sa iyo ng sariling lakas ngunit madaling matipon sa isang panig, kaya ang kailangan mo ngayon ay hindi higit pang suporta — kundi isang bagay na mag-aalis ng labis. Ang {favorable} ay gumagawa ng ganitong trabaho. Kung saan umaabot ang elementong iyon — naglalabas, tumatanggap, nag-iipon — ay kung saan ka nagiging komportable.",
      "BALANCED": "Ang sumusuporta sa iyong day master at ang umaalis mula rito ay halos pantay. Napakalapit upang makilala ang alinman, kaya dito natin binabasa ang anumang pinakamahinang elemento bilang iyong kailangan: {favorable}. Ang tsart na hindi nakatipon ay mahusay na umaangkop ngunit malabo ang sariling linya, kaya ang pagtuon sa manipis na lugar ay nagbibigay sa iyo ng direksyon na hawakan.",
      "WEAK": "Ang mga elemento na sumusuporta sa iyong day master ay manipis. Mahusay kang humihiram ng lakas mula sa paligid mo ngunit napapagod sa paghawak nang mag-isa, kaya ang kailangan mo ngayon ay isang bagay na sumusuporta at pumupuno sa iyo. Ang {favorable} ay gumagawa ng ganitong trabaho. Ang pagpapanatili ng mga sumusuportang bagay na malapit ay hindi kahinaan sa tsart na ito — ito ay isang pamamaraan."
    }
  },
  "footer": {
    "privacy": "Privacy",
