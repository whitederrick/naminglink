...
// `Naming-Link`, 등록번호가 "준비 중"인 채였다. 그런데 2026-08-06에 **이 앱의 운영 환경에
// Supabase 환경변수가 없어 폴백이 그대로 화면에 나가고 있었다** — 라이브 통신판매 사이트가
// 상호를 `Naming-Link`(실제는 `(주)Platforest`)로 고지한 셈이다(전자상거래법 제10조 표시의무).
//
