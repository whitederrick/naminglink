 ...
 * 셀프 광고를 보여 주는 시간.
 *
 * **후보 열기 관문과 같은 5초다**(`UNLOCK_AD_SECONDS`). 예전 입력 화면 관문은 10초(한자는
 * 15초)였는데, 그때는 **분석과 동시에** 돌아 체감 대기가 0이었다. 여기서는 분석이 끝난 뒤에
 * 도므로 그대로 옮기면 대기가 통째로 더해진다. 같은 대가를 치르는 자리끼리 값을 맞춘다.
 */
const ENTRY_AD_SECONDS = 5;
