      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            type: "checkbox",
            placeholder:
              "전통적으로 이름에 잘 안 쓰는 한자(불용문자)를 후보에서 아예 뺍니다. 켜지 않으면 빼지 않고 결과에 \"전통상 기피\" 표시와 이유만 붙여 드립니다 — 법적 제한이 아니라 성명학의 관습이므로 판단은 직접 하시는 편이 낫습니다. 뜻이 지나치게 귀하거나(珍·寶) 기가 너무 세다고 보는 글자(王·帝)가 여기 해당합니다.",
          },
          {
      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            type: "select",
            options: [
              { value: "natural_modern", label: "자연스럽고 현대적" },
              { value: "traditional", label: "전통적" },
              { value: "business_friendly", label: "비즈니스 친화" },
              { value: "soft", label: "부드럽고 따뜻함" },
              { value: "distinctive", label: "개성 있음" },
            ],
          },
          {
            name: "usageContext",
            ...
            type: "select",
            options: [
              { value: "korean_workplace", label: "한국 직장" },
              { value: "school", label: "학교/교환학생" },
              { value: "creator", label: "크리에이터/공개 프로필" },
