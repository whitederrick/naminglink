...
const en: FormCopy = {
  ...
  submitTransliteration: "View ad to analyze Hangul pronunciation",
...
const vi: FormCopy = {
  ...
  submitTransliteration: "広告を見て発音分析を開始",
...
const th: FormCopy = {
  ...
  submitTransliteration: "观看广告后开始分析",
...
const ja: FormCopy = {
  ...
  submitTransliteration: "Werbung ansehen und Analyse starten",
...
const zh: FormCopy = {
  ...
  submitTransliteration: "Ver un anuncio y comenzar el análisis",
...
const id: FormCopy = {
  ...
  submitTransliteration: "Regarder une publicité puis commencer l'analyse de la prononciation",
...
const de: FormCopy = {
  ...
  submitTransliteration: "Guarda un annuncio e inizia l'analisi",
...
const es: FormCopy = {
  ...
  submitTransliteration: "Ver o anúncio e começar a análise",
...
const fr: FormCopy = {
  ...
  submitTransliteration: "Xem quảng cáo để bắt đầu phân tích phát âm",
...
const it: FormCopy = {
  ...
  submitTransliteration: "ชมโฆษณาแล้วเริ่มการวิเคราะห์เสียงฮันกึล",
...
const pt: FormCopy = {
  ...
  submitTransliteration: "Tonton iklan untuk memulai analisis pengucapan Hangul",
...
const ru: FormCopy = {
  ...
  submitTransliteration: "Сначала реклама, затем анализ Хангыль",
...
const ar: FormCopy = {
  ...
  submitTransliteration: "شاهد الإعلان وابدأ التحليل",
...
const tr: FormCopy = {
  ...
  submitTransliteration: "Manood ng patalastas at simulan ang pagsusuri",
...
const fil: FormCopy = {
  ...
  submitTransliteration: "Reklamani ko'rib, o'zgarishlarni boshlang",
...
const uz: FormCopy = {
  ...
  submitTransliteration: "Сурталчилгааг үзээд Хангул дууны шинжилгээ эхлэх",
...
const mn: FormCopy = {
  ...
  submitTransliteration: "विज्ञापन देखकर हिंदी उच्चारण विश्लेषण शुरू करें",
...
const hi: FormCopy = {
  ...
  submitTransliteration: "Reklamı izle ve analizi başlat",
...
const km: FormCopy = {
  ...
  submitTransliteration: "មើលពាណិជ្ជកម្ម ដើម្បីវិភាគអត្ថបទហង់គុល",
...
const kk: FormCopy = {
  ...
  submitTransliteration: "Tonton iklan untuk memulakan analisis sebutan",
...
const ms: FormCopy = {
  ...
  submitTransliteration: "Жарнаманы көріп, талдауды бастаңыз",
...
const pl: FormCopy = {
  ...
  submitTransliteration: "Zobacz reklamę, aby uzyskać analizę Hangul",
...
const formCopies: Record<Locale, FormCopy> = { ko, en, vi, th, ja, zh, id, de, es, fr, it, pt, ru, ar, tr, fil, uz, mn, hi, km, kk, ms, pl };

export function getFormCopy(locale: Locale): FormCopy {
  return formCopies[locale];
}
