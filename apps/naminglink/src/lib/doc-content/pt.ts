...
export const PT_DOCS = {
  ...
  "guide/reading": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "É por isso que o Naming-Link fixa o som antes de procurar hanja. Se o nome é \"지은\", o significado só pode ser escolhido entre os caracteres atribuídos à leitura **지** e os caracteres atribuídos à leitura **은**."
          },
          {
            "p": "Por melhor que um significado seja, um caractere cuja leitura não corresponda não pode ser usado para esse nome. Também nunca mudamos o som de um nome para se ajustar a um caractere — um nome é falado por toda a vida, e o som é definido primeiro, com o hanja seguindo."
          }
        ]
      },
      {
  ...
  "guide/how-global-to-korean": {
    ...
    "summary": "Escolhemos entre sobrenomes que existem, avaliamos quão facilmente o nome é dito e escrito, e perguntamos para que serve o nome.",
    "backLabel": "Guia",
    "sections": [
      {
        ...
        "blocks": [
          {
            "p": "Na Coreia, o sobrenome vem primeiro e, ao contrário dos nomes próprios, não é inventado livremente — você o herda. Portanto, sugerimos apenas sobrenomes que as pessoas coreanas realmente têm. Nosso conjunto padrão é os **20 sobrenomes mais comuns**, que juntos cobrem cerca de 80% da população."
          },
          {
            "p": "Se o seu próprio sobrenome coincidir com um sobrenome coreano real por som — Wang com 왕, Ye com 예 — colocamos esse primeiro. Manter uma conexão com seu nome original vale mais do que um sobrenome escolhido aleatoriamente."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "p": "O significado também importa. Os nomes próprios coreanos geralmente têm um, então dizemos como o nome é lido e por que o escolhemos — não apenas o nome em si."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Um nome para documentos universitários não é o mesmo que um nome que amigos gritarão através de uma sala, ou um apelido que você usará online. Perguntamos como você planeja usá-lo e levamos isso em consideração."
          }
        ]
      },
      {
    ...
    "sections": [
      {
        ...
        "blocks": [
          ...
          {
            "p": "O pensamento subjacente é que **\"significado excessivo é na verdade indesejável.\"** Isso inclui caracteres que são considerados muito preciosos (珍·寶), caracteres vistos como tendo uma presença muito forte (王·帝), e aqueles considerados muito grandiosos para uma pessoa incorporar, como o céu ou deuses. Isso reflete um antigo senso de contenção, acreditando que um nome pode ofuscar a pessoa."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "**Excluir Caracteres Evitados dos Candidatos** — Se ativado, eles são completamente excluídos. Se desativado, permanecem nos resultados com um rótulo \"Tradicionalmente Evitado\" e a razão anexada."
          },
          {
  ...
  "guide/how-korean-to-global": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Ao traduzir para um idioma que não usa letras romanas, deve ser escrito no script daquele idioma. Para o japonês, seria kana e kanji; para o russo, mongol e cazaque, seria cirílico; para o árabe, seria o script árabe; e para o tailandês, khmer e hindi, seria seus respectivos scripts. Se você escrever em letras romanas e chamar de \"nome japonês\", não pode ser usado naquele país."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Para evitar criar nomes que soam plausíveis, mas não existem naquele país, baseamos nossas opções em nomes existentes. Nomes são usados em documentos e apresentações, então, se uma pessoa local pensar \"não existe tal nome\", não pode ser usado."
          }
        ]
      },
      {
  ...
  "guide/how-hanja-meaning": {
    ...
    "summary": "Primeiro, os sons são fixos, e apenas hanja que podem ser registrados com aquele som são reunidos, e o significado é visto como uma combinação em vez de um único caractere.",
    "backLabel": "Guia de Uso",
    "sections": [
      {
        ...
        "blocks": [
          {
            "p": "Se você decidiu por \"지은\", então **지** e **은** não mudam. Não alteramos o som do nome para corresponder ao hanja. Um nome é algo que é chamado por toda a vida, e acreditamos que a ordem é que o som é fixo primeiro, seguido pelo hanja."
          },
          {
            "figure": "hanja-match-flow",
            "caption": "Esta é a ordem em que os candidatos são reduzidos. Não se trata de escolher hanja primeiro e combinar os sons, mas sim que os sons vêm primeiro, e apenas caracteres designados para serem lidos com aquele som se tornam candidatos."
          }
        ]
      },
      {
        "title": "Reunir apenas hanja que podem ser registrados com aquele som",
        "blocks": [
          {
          ...
          {
            "p": "O intervalo para selecionar candidatos é os {characterTotal} caracteres da tabela da Suprema Corte. Caracteres que não estão nesta tabela não são apresentados de forma alguma — mesmo que sejam mostrados, não podem ser registrados."
          },
          {
            "p": "O número de caracteres na tabela publicada pela Suprema Corte é ligeiramente maior do que isso. A tabela também inclui **caracteres sem códigos de caracteres padrão**, que não podem ser exibidos corretamente em telas e documentos, portanto, esses caracteres foram excluídos dos candidatos. Você deve verificar com a autoridade relevante se pode registrar com esses caracteres."
          }
        ]
      },
      {
        "title": "O significado é visto como uma combinação, não como um único caractere",
        "blocks": [
          {
            "p": "O significado de cada caractere individual ser bom e o significado lido quando dois caracteres são combinados serem bons são diferentes. Os nomes são lidos como combinações, então analisamos as combinações juntas. Se você tiver significados específicos que deseja incluir ou evitar, esses serão levados em consideração."
          },
          {
            "p": "Se você estiver usando um caractere geracional, esse caractere é fixo, e combinações são buscadas nas posições restantes. O sobrenome (성) não é restrito pela tabela oficial de hanja, portanto, é tratado separadamente."
          }
        ]
      },
      {
    ...
    "sections": [
      {
        ...
        "blocks": [
          ...
          {
            "p": "**Primeiro, não há apenas um padrão.** Os métodos para calcular a fortuna variam de escola para escola, e o mesmo nome pode ser avaliado positivamente por um padrão e negativamente por outro. Não temos base para decidir qual é o correto. É desonesto apresentar um como se fosse a resposta."
          },
          {
            "p": "**Segundo, esses cálculos dependem de contagens de traços.** No entanto, os dados da Suprema Corte não incluem contagens de traços. Além disso, as contagens de traços podem variar dependendo de serem contadas como caracteres regulares ou simplificados e de como os radicais são contados. Como os números fundamentais não estão definitivamente estabelecidos, as pontuações construídas sobre eles não podem ser definitivas."
          },
          {
            "p": "**Terceiro, números parecem mais sólidos do que a realidade.** Quando diz \"87 pontos\", soa como um valor medido em vez de uma interpretação convencional. Aqueles que nomeiam podem se sentir pressionados por esse número, afastando-se do que é realmente importante (É agradável chamar? O significado se encaixa? Contém os desejos desejados?)."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Os dados oficiais de hanja fornecidos pela Suprema Corte não incluem contagens de traços. Entre os {characterTotal} caracteres que recebemos, **nenhum único caractere tem contagens de traços.**"
          },
          {
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "p": "Criar um nome e visualizar os resultados é **gratuito**. Nenhum registro de associação é necessário. Você pode ver os significados correspondentes de hanja, criar nomes coreanos, conversão de nomes globais e notação de pronúncia em Hangul, juntamente com resultados recomendados e suas justificativas na tela."
          },
          {
      ...
      {
        "title": "Detalhes de Hanja — Três Estágios",
        "blocks": [
          {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Os hanja utilizáveis e seus significados vêm da tabela oficial de hanja da Suprema Corte da Coreia, e todos estão disponíveis publicamente nos documentos de orientação do serviço. O que os produtos pagos vendem não é informação de hanja, mas **o ato de selecionar e explicar de acordo com o nome**."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "p": "As condições detalhadas estão descritas na [Política de Reembolso](/refund-policy) e no [Guia de Preços](/pricing). Este texto serve como um guia do que está incluído, e as condições legais são priorizadas nesses dois documentos."
          }
        ]
      }
    ]
  ...
  "guide/hanja-basics": {
    ...
    "summary": "Os hanja que podem ser usados para nomes de crianças foram estabelecidos pelo Supremo Tribunal em uma tabela. Isso resume o que é a tabela e por que foi criada.",
    "backLabel": "Guia de Uso",
    "sections": [
      {
        "title": "O que é o hanja oficial para nomes?",
        "blocks": [
          ...
          {
            "p": "Você não pode usar qualquer caractere para o nome de uma criança. **Os hanja que podem ser usados para o registro de nascimento foram estabelecidos pelo Supremo Tribunal em uma tabela, e apenas os caracteres dessa tabela podem ser registrados como hanja para nomes.** Isso é chamado de hanja oficial."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Existem dezenas de milhares de hanja. Entre eles, alguns têm significados desagradáveis, alguns não são mais usados e não têm leituras conhecidas, e alguns não podem ser exibidos em computadores. Se tais caracteres forem incluídos em um nome, a pessoa que acaba arcando com o ônus é aquela que usará esse nome por toda a vida. Nomes podem ser quebrados ou lidos de forma diferente em vários lugares, como registro de residentes, passaportes, bancos e escolas, exigindo que o indivíduo explique seu próprio nome."
          },
          {
            "p": "Portanto, foi escolhida uma metodologia para predefinir o alcance dos hanja que podem ser usados em nomes. Em vez de ser uma regulamentação restritiva, é mais um mecanismo para garantir que os nomes possam ser usados sem problemas ao longo da vida de uma pessoa."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "O Supremo Tribunal estabelece a tabela oficial de hanja para nomes, que é revisada conforme necessário, e caracteres são adicionados."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Dados oficiais de hanja do {publisher} · A partir de {effectiveDate}"
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "p": "Se você verificar os dados de consulta do Supremo Tribunal, ele contém {listedTotal} caracteres. Entre eles, **{excludedNoStandardCode} caracteres** são **caracteres que não têm um lugar no código de caracteres comum global (Unicode).** O sistema do Supremo Tribunal trata tais caracteres com números que funcionam apenas dentro de seu próprio sistema, e eles são exibidos como **imagens** em vez de caracteres na tela."
          }
        ]
      },
      {
      ...
      {
        "title": "Se você quiser usar hanja que não estão na tabela",
        "blocks": [
          {
            "p": "Você não pode usá-los. Para ser preciso, esses caracteres não serão registrados como hanja para o nome, e o nome será registrado apenas em Hangul. Se você quiser usar hanja junto, deve escolher da tabela."
          },
          {
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "p": "Isso inclui todos os {characterTotal} caracteres da tabela oficial de hanja do Supremo Tribunal. Cada caractere inclui a **leitura quando usado em nomes** e seu significado. Caracteres não incluídos na tabela não podem ser registrados como hanja para nomes, então você deve escolher entre os caracteres listados aqui."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "p": "Detalhamos as razões para isso e por que não recomendamos esses caracteres em [O que é Hanja Oficial para Nomes?](/guide/hanja-basics). Você deve verificar com a autoridade relevante a usabilidade real desses caracteres."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Para **伽 · 가 · 절**, ao usar \"伽\" em um nome, é lido como **가** e significa \"templo\". Mesmo para o mesmo hanja, a leitura quando usada em nomes é fixa pela tabela, e não pode ser usada de nenhuma outra forma."
          }
        ]
      }
    ]
  ...
  "items": {
    ...
    "2026-08-01-payments-preparing": {
      ...
      "body": [
        ...
        "Itens pagos ainda não estão à venda. Os valores mostrados na página de preços são o que se aplicará uma vez que as vendas sejam abertas."
      ]
    }
  }
