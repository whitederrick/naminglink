...
export const IT_DOCS = {
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "p": "La tabella dei nomi-hanja non decide solo quali caratteri possono essere usati. **Fissa anche come ciascun carattere viene letto quando appare in un nome.** Quella lettura fissa è ciò su cui si basa la registrazione."
          },
          {
            "p": "La maggior parte dei hanja ha diverse letture possibili. Un nome, però, è scritto su documenti e pronunciato ad alta voce, quindi ha bisogno di esattamente una lettura. La tabella assegna quindi a ciascun carattere la sua lettura per l'uso nei nomi, e nessun'altra lettura può essere registrata."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Ecco perché Naming-Link fissa il suono prima di cercare il hanja. Se il nome è \"지은\", il significato può essere scelto solo tra i caratteri assegnati alla lettura **지** e i caratteri assegnati alla lettura **은**."
          },
          {
            "p": "Per quanto buono possa essere un significato, un carattere la cui lettura non corrisponde non può essere usato per quel nome. Inoltre, non cambiamo mai il suono di un nome per adattarlo a un carattere — un nome viene pronunciato per tutta la vita, e il suono è stabilito prima, con il hanja che segue."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Questo è spesso frainteso. **La tabella governa il nome di battesimo, non il nome di famiglia.** Un nome di famiglia segue ciò che è già registrato nel registro familiare, quindi alcune persone usano caratteri che non sono nella tabella dei nomi-hanja."
          },
          {
    ...
    "sections": [
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "p": "Se nessuna di esse ti sembra giusta, puoi aggiungere un suggerimento sul suono che desideri e ripetere — ad esempio, che una particolare sillaba dovrebbe essere scritta diversamente."
          }
        ]
      },
      {
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "p": "In Corea il cognome viene prima, e a differenza dei nomi propri non è liberamente inventato — lo erediti. Quindi suggeriamo solo cognomi che le persone coreane hanno realmente. Il nostro pool predefinito è composto dai **20 cognomi più comuni**, che coprono insieme circa l'80% della popolazione."
          },
          {
            "p": "Se il tuo cognome si allinea con uno reale coreano per suono — Wang con 왕, Ye con 예 — lo mettiamo per primo. Mantenere un legame con il tuo nome originale vale di più di un cognome scelto a caso."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Questo è un nome che le persone in Corea ti chiameranno realmente, quindi la prima cosa che controlliamo è se un coreano può sentirlo una volta e scriverlo. Un nome che deve essere sillabato ogni volta è un peso che porti, non noi."
          },
          {
            "p": "Anche il significato è importante. I nomi propri coreani di solito portano un significato, quindi ti diciamo come si legge il nome e perché lo abbiamo scelto — non solo il nome stesso."
          }
        ]
      },
      {
    ...
    "sections": [
      {
        ...
        "blocks": [
          ...
          {
            "p": "Infatti, tra i {avoidTotal} caratteri che abbiamo compilato, {avoidCommonlyUsed} sono ancora comunemente usati nei nomi. Il fatto che siano noti per essere evitati ma ancora ampiamente utilizzati indica che questa consuetudine non è assoluta."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "ul": [
              ...
              "**Esseri Divini** — Caratteri che si riferiscono a regni sacri, come dei o spiriti",
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "p": "**Escludi anche i caratteri comunemente usati** — Questo esclude i caratteri che sono sulla lista di evitamento ma sono effettivamente ampiamente usati (圭·琳·玲·元·太·星·海, ecc.). Se abilitato, i candidati saranno significativamente ridotti."
          },
          {
            "p": "Il predefinito è **non escludere ma solo visualizzare**. Se vengono silenziosamente rimossi dalla lista, potrebbe sembrare a chi vuole usare quel carattere che non esista."
          }
        ]
      },
      {
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "p": "Non c'è solo un modo per tradurre un nome in un'altra lingua. A seconda che si voglia preservare il suono o il significato, scegliere un nome naturale nel contesto locale o dare priorità all'individualità, le risposte varieranno. Pertanto, invece di presentare un'opzione, forniamo **una da ciascuna delle cinque diverse prospettive**."
          },
          {
            "ul": [
              ...
              "**Opzione di Autenticità Locale** — Sceglie nomi che sono effettivamente comunemente usati in quel contesto culturale",
              "**Opzione di Individualità e Branding** — Dà priorità a nomi che sono memorabili e distintivi"
            ]
          },
          {
            "p": "Cinque opzioni sono garantite per essere fornite. Poiché le preferenze variano da persona a persona, crediamo sia meglio permettere scelte piuttosto che presentare una come risposta corretta."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Quando si traduce in una lingua che non utilizza lettere romane, deve essere scritto nel sistema di scrittura di quella lingua. Per il giapponese, sarebbe kana e kanji; per il russo, mongolo e kazako, sarebbe cirillico; per l'arabo, sarebbe in scrittura araba; e per il tailandese, khmer e hindi, sarebbe nei rispettivi sistemi di scrittura. Se lo scrivi in lettere romane e lo chiami un \"nome giapponese\", non può essere usato in quel paese."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Per evitare di creare nomi che suonano plausibili ma non esistono in quel paese, basiamo le nostre opzioni su nomi esistenti. I nomi sono utilizzati in documenti e presentazioni, quindi se una persona locale pensa \"non esiste un nome del genere\", non può essere usato."
          }
        ]
      },
      {
  ...
  "guide/how-hanja-meaning": {
    ...
    "sections": [
        ...
        "blocks": [
          ...
          },
          {
            ...
            "labels": {
              ...
              "soundNote": "Non lo cambiamo mai per adattarlo a un carattere",
              ...
              "combineNote": "il significato è come la coppia legge, non ciascun carattere da solo"
            },
            "caption": "Questo è l'ordine in cui i candidati vengono ristretti. Non si tratta di scegliere prima i hanja e abbinare i suoni, ma piuttosto che i suoni vengono prima, e solo i caratteri designati per essere letti con quel suono diventano candidati."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Il significato di ciascun carattere individuale che è buono e il significato letto quando due caratteri sono combinati che è buono sono diversi. I nomi vengono letti come combinazioni, quindi consideriamo le combinazioni insieme. Se hai significati specifici che desideri includere o evitare, questi vengono presi in considerazione."
          },
          {
  ...
  "guide/what-we-dont-use": {
    ...
    "summary": "Non assegniamo fortuna totale o punteggi numerici, né utilizziamo conteggi di tratti. I cinque elementi sono usati solo come asse supplementare. Ecco i motivi.",
    "backLabel": "Guida all'Uso",
    "sections": [
      {
        ...
        "blocks": [
          {
            "p": "Ci sono metodi che assegnano fortuna totale o punteggi numerici ai nomi per valutarli. Naming-Link non fornisce quei numeri. I motivi sono quattro."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "I dati ufficiali degli hanja per i nomi forniti dalla Corte Suprema non includono conteggi di tratti. Tra i {characterTotal} caratteri che abbiamo ricevuto, **non c'è un singolo carattere con conteggi di tratti.**"
          },
          {
        ...
        "blocks": [
          {
            ...
            "caption": "Le relazioni tra i cinque elementi. Muoversi lungo il cerchio rappresenta la generazione reciproca (相生), mentre saltare uno e premere giù rappresenta il vincolo reciproco (相剋). Utilizziamo questa relazione solo come asse supplementare per confrontare i candidati."
          },
          {
          ...
          {
            "p": "Se desideri un'analisi precisa basata sul saju, trattiamo questo in un rapporto dettagliato separato. Il motivo per cui non diamo priorità ai cinque elementi nel matching gratuito degli hanja è che non vogliamo presentare giudizi basati sui cinque elementi derivati da una data e ora di nascita incompleta come se fossero definitivi."
          }
        ]
      }
    ]
  ...
  "guide/what-we-sell": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "I risultati raccomandati sono strutturati per aprire i candidati uno alla volta. Quando si visualizzano gli annunci, uno si apre alla volta, mentre questo prodotto **apre tutti i candidati rimanenti contemporaneamente**."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Gli hanja utilizzabili e i loro significati provengono dall'ufficiale tabella degli hanja per nomi stabilita dalla Corte Suprema della Corea, e tutti sono pubblicamente disponibili nei documenti di guida del servizio. Ciò che i prodotti a pagamento vendono non è informazione sugli hanja ma **l'atto di selezionare e spiegarlo in base al nome**."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Documenti disponibili per convertire nomi stranieri in nomi coreani o scrivere nomi in Hangul. I prezzi seguono gli importi visualizzati sullo schermo di pagamento."
          },
          {
            "ul": [
  ...
  "guide/hanja-basics": {
    ...
    "summary": "Gli hanja che possono essere utilizzati per i nomi dei bambini sono stati stabiliti dalla Corte Suprema in una tabella. Questo riassume cosa è la tabella e perché è stata impostata.",
    "backLabel": "Guida all'Uso",
    "sections": [
      {
        "title": "Cos'è l'ufficiale nome-hanja?",
        "blocks": [
          ...
          {
            "p": "Non puoi usare qualsiasi carattere per il nome di un bambino. **Gli hanja che possono essere utilizzati per la registrazione alla nascita sono stati stabiliti dalla Corte Suprema in una tabella, e solo i caratteri in quella tabella possono essere registrati come hanja per i nomi.** Questo è chiamato nome-hanja ufficiale."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Ci sono decine di migliaia di hanja. Tra questi, alcuni hanno significati sgradevoli, alcuni non sono più utilizzati e non hanno letture conosciute, e alcuni non possono essere visualizzati affatto sui computer. Se tali caratteri sono inclusi in un nome, la persona che alla fine sopporta il peso è colui che utilizzerà quel nome per tutta la vita. I nomi possono essere rotti o letti in modo diverso in vari luoghi come registrazione dei residenti, passaporti, banche e scuole, richiedendo all'individuo di spiegare il proprio nome."
          },
          {
            "p": "Pertanto, è stato scelto un metodo per predefinire l'ambito degli hanja che possono essere utilizzati nei nomi. Piuttosto che essere una regolazione restrittiva, è più un meccanismo per garantire che i nomi possano essere utilizzati senza problemi per tutta la vita di una persona."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "La Corte Suprema stabilisce la tabella ufficiale degli hanja, che viene revisionata secondo necessità, e i caratteri vengono aggiunti."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "{publisher} dati ufficiali nome-hanja · A partire dal {effectiveDate}"
          },
          {
      ...
      {
        "title": "Il numero di caratteri annunciati dalla Corte Suprema differisce da ciò che mostriamo",
        "blocks": [
          {
            "p": "**Il nome-hanja ufficiale annunciato dalla Corte Suprema è {announcedTotal} caratteri, mentre ciò che presentiamo come candidati è {characterTotal} caratteri.** Non c'è motivo di nascondere questa differenza, quindi lo dichiariamo chiaramente."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "**Riempire l'elenco con caratteri che non possono essere visualizzati non è utile.** La maggior parte dei significati di questi caratteri è anche vuota nei nostri dati, il che non si allinea con il metodo del servizio di scegliere nomi basati sui significati."
          },
          {
            "p": "**La ragione più importante riguarda la persona che utilizzerà il nome.** Un nome è un valore che sarà inserito in vari luoghi nel corso della vita di una persona. I caratteri senza codici carattere potrebbero non essere in grado di essere inseriti o stampati nei sistemi di banche, scuole, ospedali o passaporti, anche dopo aver completato la registrazione della nascita. Pertanto, non possiamo raccomandare tali caratteri."
          },
          {
            "p": "Tuttavia, **non determiniamo se quei caratteri possono essere utilizzati o meno.** Poiché sono caratteri nella tabella della Corte Suprema, la registrazione stessa potrebbe essere possibile. Se desideri davvero utilizzare quel carattere, ti preghiamo di controllare direttamente nel sistema elettronico di registrazione dei legami familiari della Corte Suprema e **di informarti con l'autorità competente riguardo alla reale utilizzabilità.**"
          }
        ]
      },
      {
  ...
  "guide/hanja": {
    "eyebrow": "Elenco",
    "title": "Lista Completa degli Hanja Ufficiali per i Nomi",
    "summary": "Abbiamo organizzato gli hanja che possono essere utilizzati per la registrazione della nascita per consonante iniziale. Puoi vedere la lettura designata e il significato per ciascun carattere quando utilizzato nei nomi.",
    "backLabel": "Guida all'Uso",
    "sections": [
      {
        ...
        "blocks": [
          {
            "p": "Questo include tutti i {characterTotal} caratteri dalla tabella ufficiale degli hanja per i nomi della Corte Suprema. Ogni carattere include la **lettura quando utilizzato nei nomi** e il suo significato. I caratteri non inclusi nella tabella non possono essere registrati come hanja per i nomi, quindi dovresti scegliere tra i caratteri elencati qui."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Il numero di caratteri annunciati dalla Corte Suprema è {announcedTotal}, ma questo elenco contiene {characterTotal} caratteri. **La differenza di {excludedNoStandardCode} caratteri è quella di caratteri che non possono essere visualizzati in nessun font a causa della mancanza di un posto nel codice carattere universale.** Il sistema della Corte Suprema mostra quei caratteri come immagini."
          },
          {
            "p": "Abbiamo dettagliato le ragioni di ciò e perché non raccomandiamo quei caratteri in [Cosa sono gli Hanja Ufficiali per i Nomi?](/guide/hanja-basics). Dovresti controllare con l'autorità competente per la reale utilizzabilità di quei caratteri."
          }
        ]
      },
      {
