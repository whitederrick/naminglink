...
export const ID_DOCS = {
  ...
  "guide/reading": {
    ...
    "summary": "Tabel resmi tidak hanya mencantumkan karakter. Ini juga menetapkan bagaimana setiap karakter dibaca saat digunakan dalam nama.",
    "backLabel": "Panduan",
    "sections": [
      {
        ...
        "blocks": [
          {
            "p": "Tabel nama-hanja tidak hanya menentukan karakter mana yang dapat digunakan. **Ini juga menetapkan bagaimana setiap karakter dibaca saat muncul dalam nama.** Bacaan tetap itulah yang menjadi dasar pendaftaran."
          },
          {
            "p": "Sebagian besar hanja memiliki beberapa bacaan yang mungkin. Namun, sebuah nama ditulis di dokumen dan diucapkan, sehingga memerlukan satu bacaan yang tepat. Oleh karena itu, tabel menetapkan setiap karakter bacaan untuk digunakan dalam nama, dan bacaan lain tidak dapat didaftarkan."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          {
            "p": "Sebagus apapun maknanya, karakter yang bacaan tidak cocok tidak dapat digunakan untuk nama itu. Kami juga tidak pernah mengubah suara nama untuk menyesuaikan dengan karakter — sebuah nama diucapkan seumur hidup, dan suara ditetapkan terlebih dahulu, dengan hanja mengikuti."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Ini sering disalahpahami. **Tabel mengatur nama yang diberikan, bukan nama keluarga.** Nama keluarga mengikuti apa yang sudah ada di daftar keluarga, jadi beberapa orang memang menggunakan karakter yang tidak ada di tabel nama-hanja."
          },
          {
    ...
    "sections": [
      {
        ...
        "blocks": [
            ...
            "stats": [
              {
                ...
                "label": "Karakter yang Dihindari yang Telah Dikompilasi"
              },
              {
          ...
          {
            "p": "Pemikiran yang mendasari adalah bahwa **\"makna yang berlebihan sebenarnya tidak diinginkan.\"** Ini mencerminkan rasa pengendalian yang lama, percaya bahwa sebuah nama dapat mengalahkan orangnya."
          },
          {
            "ul": [
              "珍·寶 — karakter yang dianggap terlalu berharga",
              "王·帝 — karakter yang dianggap membawa terlalu banyak kekuatan",
              "surga dan dewa — terlalu megah untuk diemban oleh seseorang"
            ]
          },
          {
            "p": "**Namun, karakter-karakter ini tidak tidak dapat digunakan.** Ini bukan larangan hukum tetapi sebuah kebiasaan, dan kebiasaan bervariasi menurut daerah, keluarga, dan generasi, serta dapat berubah seiring waktu."
          },
          {
            "p": "Faktanya, di antara {avoidTotal} karakter yang kami kompilasi, {avoidCommonlyUsed} masih umum digunakan dalam nama. Fakta bahwa mereka diketahui dihindari namun masih banyak digunakan menunjukkan bahwa kebiasaan ini tidak mutlak."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Kami tidak sembarangan menghapus karakter-karakter ini. **Kami telah menyediakan dua opsi di layar input untuk pemilih nama memilih bagaimana menanganinya.**"
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          {
            "p": "Defaultnya adalah **tidak mengecualikan tetapi hanya menampilkan** mereka. Jika mereka dihapus secara diam-diam dari daftar, mungkin akan tampak bagi mereka yang ingin menggunakan karakter tersebut seolah-olah tidak ada."
          }
        ]
      },
      {
  ...
  "guide/how-korean-to-global": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Untuk menghindari pembuatan nama yang terdengar masuk akal tetapi tidak ada di negara tersebut, kami mendasarkan pilihan kami pada nama-nama yang sudah ada. Nama digunakan dalam dokumen dan pengenalan, jadi jika seseorang lokal berpikir \"tidak ada nama seperti itu,\" maka nama tersebut tidak dapat digunakan."
          }
        ]
      },
      {
  ...
  "guide/how-hanja-meaning": {
    ...
    "summary": "Pertama, suara ditetapkan, dan hanya hanja yang dapat didaftarkan dengan suara tersebut yang dikumpulkan, dan makna dilihat sebagai kombinasi daripada karakter tunggal.",
    "backLabel": "Panduan Penggunaan",
    "sections": [
      {
        ...
        "blocks": [
          ...
          },
          {
            ...
            "labels": {
              ...
              "tableBody": "hanya karakter yang ditugaskan dengan pembacaan itu",
              ...
              "combineNote": "makna adalah bagaimana pasangan itu dibaca, bukan setiap karakter sendiri"
            },
            "caption": "Ini adalah urutan di mana kandidat disaring. Ini bukan tentang memilih hanja terlebih dahulu dan mencocokkan suara, tetapi lebih kepada suara yang datang terlebih dahulu, dan hanya karakter yang ditunjuk untuk dibaca dengan suara tersebut yang menjadi kandidat."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Tabel hanja nama resmi memiliki pembacaan yang ditugaskan untuk setiap karakter ketika digunakan dalam nama. Hanya karakter yang ditugaskan untuk dibaca sebagai **지** dan **은** yang menjadi kandidat. Tidak peduli seberapa baik maknanya, jika pembacaannya tidak cocok, itu tidak dapat menjadi hanja untuk nama tersebut."
          },
          {
            "p": "Rentang untuk memilih kandidat adalah {characterTotal} karakter dari tabel Mahkamah Agung. Karakter yang tidak ada dalam tabel ini sama sekali tidak disajikan — bahkan jika ditampilkan, mereka tidak dapat didaftarkan."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Makna dari setiap karakter individu yang baik dan makna yang dibaca ketika dua karakter digabungkan adalah berbeda. Nama dibaca sebagai kombinasi, jadi kami melihat kombinasi tersebut bersama-sama. Jika Anda memiliki makna spesifik yang ingin dimasukkan atau dihindari, itu akan diperhitungkan."
          },
          {
            "p": "Jika Anda menggunakan karakter generasi, karakter tersebut tetap, dan kombinasi dicari dari posisi yang tersisa. Nama keluarga (성) tidak dibatasi oleh tabel hanja nama resmi, jadi diperlakukan secara terpisah."
          }
        ]
      },
      {
  ...
  "guide/hanja-basics": {
    ...
    "sections": [
      ...
      {
        "title": "Mengapa hal ini ditetapkan?",
        "blocks": [
          {
            "p": "Ada puluhan ribu hanja. Di antara mereka, beberapa memiliki makna yang tidak menyenangkan, beberapa tidak lagi digunakan dan tidak memiliki pembacaan yang diketahui, dan beberapa sama sekali tidak dapat ditampilkan di komputer. Jika karakter semacam itu termasuk dalam nama, orang yang pada akhirnya menanggung beban adalah orang yang akan menggunakan nama itu seumur hidup. Nama dapat dibaca atau ditulis berbeda di berbagai tempat seperti pendaftaran penduduk, paspor, bank, dan sekolah, yang mengharuskan individu untuk menjelaskan nama mereka sendiri."
          },
          {
            "p": "Oleh karena itu, sebuah metode telah dipilih untuk mendefinisikan jangkauan hanja yang dapat digunakan dalam nama. Alih-alih menjadi regulasi yang membatasi, ini lebih merupakan mekanisme untuk memastikan bahwa nama dapat digunakan tanpa masalah sepanjang hidup seseorang."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "p": "Jika Anda memeriksa data permintaan Mahkamah Agung, itu berisi {listedTotal} karakter. Di antara mereka, **{excludedNoStandardCode} karakter** adalah **karakter yang tidak memiliki tempat dalam kode karakter umum global (Unicode).** Sistem Mahkamah Agung memperlakukan karakter semacam itu dengan angka yang hanya berfungsi dalam sistemnya sendiri, dan mereka ditampilkan sebagai **gambar** daripada karakter di layar."
          }
        ]
      },
      {
  ...
  "guide/hanja": {
    ...
    "summary": "Kami telah mengorganisir hanja yang dapat digunakan untuk pendaftaran kelahiran berdasarkan konsonan awal. Anda dapat melihat pembacaan yang ditetapkan dan makna untuk setiap karakter saat digunakan dalam nama.",
    "backLabel": "Panduan Penggunaan",
    "sections": [
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Untuk **伽 · 가 · 절**, saat menggunakan \"伽\" dalam nama, itu dibaca sebagai **가** dan berarti \"kuil\". Bahkan untuk hanja yang sama, pembacaan saat digunakan dalam nama ditetapkan oleh tabel, dan tidak dapat digunakan dengan cara lain."
          }
        ]
      }
    ]
