...
export const PL_DOCS = {
  "about": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Hanja pochodzą z **oficjalnej tabeli hanja imion ustalonej przez Sąd Najwyższy Korei.** Każdy znak ma przypisaną stałą wymowę do użycia w imionach, a znaki spoza tabeli nie mogą być rejestrowane. Nie dodajemy do tej listy ani nie wybieramy ulubionych."
          },
          {
  ...
  "guide/reading": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Dlatego Naming-Link ustala dźwięk przed poszukiwaniem hanja. Jeśli imię to \"지은\", znaczenie może być wybierane tylko spośród znaków przypisanych do odczytu **지** i znaków przypisanych do odczytu **은**."
          },
          {
            "p": "Niezależnie od tego, jak dobre jest znaczenie, znak, którego odczyt nie pasuje, nie może być użyty dla tego imienia. Nigdy również nie zmieniamy dźwięku imienia, aby dopasować go do znaku — imię jest wypowiadane przez całe życie, a dźwięk jest ustalany najpierw, z hanja następującym później."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          {
            "p": "Dlatego Naming-Link traktuje hanja nazwisk inaczej. Pomagamy tylko w znalezieniu nazwiska, a także zostawiamy pole do bezpośredniego wprowadzenia, dla osób, których znak znajduje się poza tabelą. Nazwiska dwusylabowe, takie jak Namgung i Seonwoo, są wprowadzane w ten sam sposób."
          }
        ]
      }
    ]
    ...
    "sections": [
      {
        ...
        "blocks": [
          ...
          {
            "p": "Możesz samodzielnie wybrać nazwisko lub pozwolić nam na zaproponowanie jednego. Tak czy inaczej, będzie to **nazwisko, które istnieje**."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          {
            "p": "Znaczenie również ma znaczenie. Koreańskie imiona zazwyczaj niosą ze sobą jakieś znaczenie, więc informujemy cię, jak imię się czyta i dlaczego je wybraliśmy — nie tylko samo imię."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Imię do dokumentów uniwersyteckich nie jest tym samym, co imię, które przyjaciele będą wołać przez pokój, czy pseudonim, którego użyjesz w Internecie. Pytamy, jak zamierzasz je używać i bierzemy to pod uwagę."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "ul": [
              ...
              "**Cokolwiek innego** — partnerstwa i prasa idą na ten sam adres."
            ]
          }
        ]
      },
  ...
  "guide/avoid": {
    ...
    "backLabel": "Przewodnik po użyciu",
    "sections": [
      {
        ...
        "blocks": [
          ...
          {
            "p": "Istnieją znaki, które są zawarte na liście znaków do imion i **są prawnie akceptowalne**, ale są uważane za nieodpowiednie do imion."
          },
          {
          ...
          {
            "p": "**Jednak te znaki nie są bezużyteczne.** Nie jest to zakaz prawny, ale zwyczaj, a zwyczaje różnią się w zależności od regionu, rodziny i pokolenia oraz mogą zmieniać się w czasie."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Obecnie skompilowane znaki dzielą się na siedem kategorii."
          },
          {
            "ul": [
      ...
      {
        "title": "Możesz samodzielnie dodać lub usunąć znaki",
        "blocks": [
          {
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "p": "**Wyklucz nawet powszechnie używane znaki** — To wyklucza znaki, które są na liście unikania, ale są rzeczywiście szeroko stosowane (圭·琳·玲·元·太·星·海 itp.). Jeśli włączone, liczba kandydatów zostanie znacznie zmniejszona."
          },
          {
            "p": "Domyślnie **nie wyklucza, a jedynie wyświetla** je. Jeśli zostaną cicho usunięte z listy, może się wydawać tym, którzy chcą użyć tego znaku, że nie istnieje."
          }
        ]
      },
      {
  ...
  "guide/how-korean-to-global": {
    ...
    "sections": [
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Podczas tłumaczenia na język, który nie używa liter rzymskich, musi być zapisane w skrypcie tego języka. Dla japońskiego byłoby to kana i kanji; dla rosyjskiego, mongolskiego i kazachskiego byłoby to cyrylica; dla arabskiego byłoby to skrypt arabski; a dla tajskiego, khmerskiego i hindi byłoby to ich odpowiednie skrypty. Jeśli zapiszesz to w literach rzymskich i nazwiesz to \"japońskim imieniem\", nie może być używane w tym kraju."
          },
          {
            "p": "Dlatego mamy osobne zasady dla systemu pisma każdego języka, a serwer sprawdza jeszcze raz, aby upewnić się, że wyniki są w tym systemie pisma. Błędy takie jak pomijanie nazwisk czy mieszanie w Hangul są tutaj filtrowane."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Zajmujemy się zadaniem określenia pięciu kandydatów oddzielnie od zadania opisywania każdego kandydata w szczegółach. Ponieważ opis zajmuje dużo czasu, oddzielamy tę część, aby stworzyć ją równocześnie."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Początkowo stworzyliśmy pięć perspektyw oddzielnie. Było to szybsze, ale **liczba kandydatów różniła się za każdym razem.** Gdy każda osoba wybierała kandydatów, występowały nakładki lub rozbieżności, a jeśli jeden zawiódł, ten kandydat znikał całkowicie, co skutkowało tylko dwoma lub trzema zamiast pięciu."
          },
          {
            "p": "Teraz, ponieważ określamy zestaw kandydatów i rozkład perspektyw jednocześnie, **liczba jest stała.** Nawet jeśli jeden opis zawiedzie, kandydaci pozostają i są prezentowani z krótkimi informacjami. Uważamy, że lepiej jest mieć zawsze tę samą liczbę, nawet jeśli zajmuje to trochę więcej czasu."
          }
        ]
      }
    ]
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "p": "Jeśli zdecydowałeś się na \"지은\", to **지** i **은** nie zmieniają się. Nie zmieniamy dźwięku imienia, aby dopasować go do hanja. Imię to coś, co jest wymawiane przez całe życie, i uważamy, że kolejność jest taka, że dźwięk jest najpierw ustalany, a potem hanja."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "p": "Liczba znaków w tabeli opublikowanej przez Sąd Najwyższy jest nieco większa niż ta. Tabela zawiera również **znaki bez standardowych kodów znaków**, które nie mogą być poprawnie wyświetlane na ekranach i dokumentach, więc te znaki zostały wykluczone z kandydatów. Musisz sprawdzić z odpowiednim organem, czy możesz zarejestrować się z tymi znakami."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          {
            "p": "Jeśli używasz znaku generacyjnego, ten znak jest stały, a kombinacje są poszukiwane z pozostałych pozycji. Nazwisko (성) nie jest ograniczone przez oficjalną tabelę imienną-hanja, więc traktuje się je osobno."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Jeśli znak tradycyjnie uważany za unikany jest uwzględniony w kandydatach, nie usuwamy go, ale pokazujemy powód wraz z nim. To kwestia zwyczaju, a nie prawa, i możesz zdecydować się na całkowite wykluczenie go z ekranu wejściowego. Aby uzyskać więcej szczegółów, zobacz [Tradycyjnie Unikane Hanja](/guide/avoid)."
          }
        ]
      },
      {
    ...
    "sections": [
      {
        ...
        "blocks": [
          ...
          {
            "p": "**Po drugie, te obliczenia opierają się na liczbie pociągnięć.** Jednak dane Sądu Najwyższego w ogóle nie zawierają liczby pociągnięć. Co więcej, liczby pociągnięć mogą się różnić w zależności od tego, czy są liczone jako znaki regularne czy uproszczone oraz jak liczone są elementy składowe. Ponieważ podstawowe liczby nie są definitywnie ustalone, wyniki oparte na nich nie mogą być definitywne."
          },
          {
            "p": "**Po trzecie, liczby wydają się bardziej solidne niż rzeczywistość.** Kiedy mówi \"87 punktów\", brzmi to jak wartość mierzona, a nie konwencjonalna interpretacja. Osoby nadające imiona mogą czuć presję ze strony tej liczby, odsuwając na bok to, co naprawdę ważne (Czy jest przyjemnie to wymawiać? Czy znaczenie pasuje? Czy zawiera pożądane życzenia?)."
          },
          {
            "p": "**Po czwarte, nie ma sposobu na weryfikację.** Związek między imieniem a życiem osoby nie może być zweryfikowany. Przekształcenie czegoś, co nie może być określone jako dobre lub złe, w wynik prowadzi do liczby, której nie można potwierdzić, mimo że nie może być błędna."
          },
          {
            "p": "Używamy tylko tego, co można **uzasadnić.** Oficjalna tabela imienno-hanja Sądu Najwyższego, wyznaczone odczyty dla każdego znaku oraz znaczenia wymienione w tabeli. Zamiast tego podajemy powody, dla których ten kandydat został wybrany i dlaczego niektóre znaki zostały wykluczone, pokazując **powody zamiast punktów**."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Oficjalne dane imienno-hanja dostarczone przez Sąd Najwyższy nie zawierają liczby pociągnięć. Spośród {characterTotal} znaków, które otrzymaliśmy, **żaden znak nie ma liczby pociągnięć.**"
          },
          {
        ...
        "blocks": [
          {
            ...
            "caption": "Relacje między pięcioma elementami. Poruszanie się wzdłuż okręgu reprezentuje wzajemne generowanie (相生), podczas gdy pomijanie jednego i naciskanie na inny reprezentuje wzajemne ograniczenie (相剋). Używamy tej relacji tylko jako osi pomocniczej do porównywania kandydatów."
          },
          {
            "p": "Jeśli wpisałeś swój miesiąc urodzenia, używamy uproszczonego odniesienia pięciu elementów na podstawie tego miesiąca jako osi pomocniczej do porównywania kandydatów. Jednak nie jest to precyzyjna analiza saju, a **nie twierdzimy, że imiona determinują los lub charakter osoby.**"
          },
          {
          ...
          {
            "p": "Jeśli chcesz precyzyjnej analizy opartej na saju, obejmujemy to w osobnym szczegółowym raporcie. Powód, dla którego nie priorytetujemy pięciu elementów w bezpłatnym dopasowywaniu hanja, jest taki, że nie chcemy przedstawiać osądów opartych na pięciu elementach pochodzących z niekompletnej daty i godziny urodzenia, jakby były definitywne."
          }
        ]
      }
    ]
  ...
  "guide/what-we-sell": {
    ...
    "title": "Co jest zawarte w produktach płatnych?",
    ...
    "sections": [
      {
        ...
        "blocks": [
          {
            "p": "Tworzenie imienia i przeglądanie wyników jest **darmowe**. Nie jest wymagana rejestracja członkowska. Możesz zobaczyć dopasowane znaczenia hanja, tworzenie koreańskich imion, konwersję imion globalnych oraz notację wymowy w Hangul, wraz z zalecanymi wynikami i ich uzasadnieniami na ekranie."
          },
          {
            "p": "Produkty płatne **nie odsprzedają tego, co już zostało pokazane na ekranie.** Otwierają więcej kandydatów, dodają więcej wyjaśnień lub tworzą format, który można przechowywać lub przesyłać."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Istnieją trzy szczegółowe produkty w procesie wybierania hanja do dołączenia do imienia w Hangul."
          },
          {
            "ul": [
              ...
              "**Maksymalnie 10 kandydatów hanja z raportem saju i pięciu elementów** — {priceTenSaju}. Oprócz powyższego, zawiera wykres saju pochodzący z daty urodzenia oraz siły pięciu elementów, badając, dlaczego dany hanja pasuje do tego imienia z perspektywy pięciu elementów."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Użyteczne hanja i ich znaczenia pochodzą z oficjalnej tabeli imienno-hanja ustalonej przez Sąd Najwyższy Korei i wszystkie są publicznie dostępne w dokumentach informacyjnych usługi. To, co sprzedają produkty płatne, nie jest informacją o hanja, ale **działaniem wyboru i wyjaśnienia tego zgodnie z imieniem**."
          }
        ]
      },
      {
        ...
        "blocks": [
          ...
          },
          {
            "ul": [
              ...
              "**Sztuka imienia w Hangul** — 2 strony. Zawiera okładkę kaligraficzną i przewodnik po wymowie. Zawiera informacje, jak napisać imię w Hangul i jak je wymówić."
            ]
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Wycinamy imię stworzone na ekranie w fizyczny stempel i wysyłamy go do Ciebie. Ceny różnią się w zależności od modelu — stempel okrągły {priceStampRound}, stempel kwadratowy {priceStampSquare}, stempel z hebanu {priceStampEbony}. Dostawa międzynarodowa jest również dostępna."
          },
          {
            "p": "**Od tego miejsca, produkty obejmują wysyłkę.** W przeciwieństwie do poprzednich przedmiotów, produkcja i wysyłka zajmują czas, a wymagany jest adres dostawy. Informacje o wysyłce są używane tylko do przetwarzania zamówienia i przechowywania prawnego, a po zakończeniu przetwarzania zostaną zniszczone po okresie określonym w polityce."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "**Produkty cyfrowe są dostarczane natychmiast po dokonaniu płatności.** Możesz anulować i otrzymać pełny zwrot w dowolnym momencie przed rozpoczęciem pobierania, ale po zakończeniu pobierania, wycofanie z powodu prostych zmian zdania jest ograniczone (Artykuł 17, Paragraf 2 Ustawy o handlu elektronicznym). Ten warunek jest osobno uzgadniany na ekranie płatności."
          },
          {
            "p": "**Reklamacje dotyczące treści wyników nie są powodem do zwrotu.** Jednakże, jeśli dokument nie został stworzony, plik nie może być otwarty, lub kwota płatności różni się od zamówienia, zostanie to przetworzone jako ponowne wydanie lub pełny zwrot."
          },
          {
  ...
  "guide/hanja-basics": {
    "eyebrow": "System",
    "title": "Czym jest oficjalna tabela hanja dla imion?",
    ...
    "sections": [
      {
        ...
        "blocks": [
          ...
          {
            "p": "Nie możesz używać dowolnego znaku jako imienia dziecka. **Hanja, które mogą być używane do rejestracji urodzenia, zostały ustalone przez Sąd Najwyższy w tabeli, a tylko znaki w tej tabeli mogą być zarejestrowane jako hanja dla imion.** To nazywa się oficjalną tabelą hanja dla imion."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Sąd Najwyższy ustala oficjalną tabelę hanja dla imion, która jest w razie potrzeby aktualizowana, a znaki są dodawane."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Dane o oficjalnej tabeli hanja od {publisher} · Stan na {effectiveDate}"
          },
          {
            "p": "{characterTotal} znaków obejmuje {syllableCount} sylab Hangul. Wartość skrótu oryginalnego pliku jest również przechowywana, więc jeśli tabela się zmieni, można sprawdzić, kiedy i co się zmieniło."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "**Oficjalna tabela hanja ogłoszona przez Sąd Najwyższy to {announcedTotal} znaków, podczas gdy to, co przedstawiamy jako kandydatów, to {characterTotal} znaków.** Nie ma powodu, aby ukrywać tę różnicę, więc stwierdzamy to wprost."
          },
          {
            "p": "Jeśli sprawdzisz dane zapytania Sądu Najwyższego, zawiera {listedTotal} znaków. Wśród nich, **{excludedNoStandardCode} znaków** to **znaki, które nie mają miejsca w globalnym kodzie znaków (Unicode).** System Sądu Najwyższego traktuje takie znaki numerami, które działają tylko w jego własnym systemie, a są one wyświetlane jako **obrazy** zamiast znaków na ekranie."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Aby znak pojawił się na ekranie, musi mieć **numer uzgodniony przez świat**, a czcionka zawiera obraz odpowiadający temu numerowi. Znaki, które nie mają numeru, nie mogą być zawarte w żadnej czcionce. Niezależnie od tego, ile czcionek dodamy, te znaki będą się pojawiać jako puste kwadraty."
          }
        ]
      },
      {
      ...
      },
      {
        ...
        "blocks": [
          {
            "p": "Nie możesz ich używać. Dokładniej mówiąc, te znaki nie będą zarejestrowane jako hanja dla imienia, a imię będzie zapisane tylko w Hangul. Jeśli chcesz użyć hanja obok, musisz wybierać z tabeli."
          },
          {
            "p": "Dlatego nie przedstawiamy znaków, które nie znajdują się w tabeli, jako kandydatów. Wszystkie hanja widoczne na ekranie to znaki, które mogą być faktycznie używane do rejestracji urodzenia. Pełna lista jest dostępna w [Pełnej liście oficjalnej tabeli hanja](/guide/hanja)."
          }
        ]
      }
    ]
  ...
  "guide/hanja": {
    "eyebrow": "Lista",
    "title": "Pełna lista oficjalnej tabeli hanja dla imion",
    "summary": "Zorganizowaliśmy hanja, które mogą być używane do rejestracji urodzenia według spółgłoski początkowej. Możesz zobaczyć przypisaną wymowę i znaczenie dla każdego znaku, gdy jest używane w imionach.",
    "backLabel": "Przewodnik użytkowania",
    "sections": [
      {
        ...
        "blocks": [
          {
            "p": "To obejmuje wszystkie {characterTotal} znaki z oficjalnej tabeli hanja Sądu Najwyższego. Każdy znak zawiera **wymowę, gdy jest używany w imionach** oraz jego znaczenie. Znaki, które nie są zawarte w tabeli, nie mogą być zarejestrowane jako hanja dla imion, więc powinieneś wybierać spośród znaków wymienionych tutaj."
          },
          {
      ...
      },
      {
        ...
        "blocks": [
          ...
          {
            "p": "Szczegółowo opisaliśmy powody tego oraz dlaczego nie polecamy tych znaków w [Czym jest oficjalna tabela hanja?](/guide/hanja-basics). Powinieneś skonsultować się z odpowiednim organem w celu rzeczywistej użyteczności tych znaków."
          }
        ]
      },
      {
        "title": "Początkowe spółgłoski z niewielką liczbą znaków",
        "slot": "mały",
        "blocks": [
          {
            "p": "Początkowe spółgłoski poniżej mają bardzo niewiele oficjalnych znaków hanja do imion, dlatego wyświetliliśmy je tutaj bez osobnej strony."
          }
        ]
      },
      {
        ...
        "blocks": [
          {
            "p": "Dla **伽 · 가 · 절**, gdy używasz \"伽\" w imieniu, jest ono czytane jako **가** i oznacza \"świątynia\". Nawet dla tego samego hanja, odczyt używany w imionach jest ustalony przez tabelę i nie może być używany w żaden inny sposób."
          }
        ]
      }
    ]
