...
// AUDIT_NO_SIDE_EFFECTS: 이 파일의 INSERT 문양은 소스에서 찾는 정규식이다 — 아무것도 부르지 않는다
//
// **선언 문구에 그 문양을 그대로 적지 말 것** (2026-08-21). 처음에 이유를 적으면서 찾는
// 문자열을 따옴표째 옮겨 적었더니, **이 검사기가 자기 머리말을 위반으로 신고했다.**
// 검사기의 검사 대상에 그 검사기 자신이 들어 있다는 것을 잊으면 이렇게 된다.
