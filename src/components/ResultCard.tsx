...
const resultCardCopies: Record<string, ResultCardCopy> = {
  ...
  hi: {
    ...
    summaryFallback: "आपका विश्लेषण परिणाम तैयार है।",
    allRevealed: (count) => `सभी ${count} खुले`,
    partialRevealed: (count) => `${count} खुले · और लॉक हैं`,
    noRecommendation: "कोई सिफ़ारिश नहीं",
    candidateFallbackSubtitle: "सिफ़ारिश किया गया उम्मीदवार नाम",
    lockedNote: "एक विज्ञापन या पूर्ण खरीद से अनलॉक करें",
    fitScore: (score) => `उपयुक्तता (संदर्भ) ${score}`,
    rejectedTitle: "बाहर किए गए विकल्प",
    rejectedFallbackReason: "सिफ़ारिश मानदंडों पर खरा नहीं उतरा",
    officialNoteTitle: "आधिकारिक सत्यापन नोट",
    rowReason: "हम इसकी सिफ़ारिश क्यों करते हैं",
    rowPronunciation: "उच्चारण",
    rowMeaning: "नाम का अर्थ",
    rowNaturalness: "कोरियाई में स्वाभाविकता",
    rowUsageNote: "उपयोग का संदर्भ",
    rowHanjaAddon: "हांजा ऐड-ऑन",
    rowCaution: "सावधानी",
    rowSourceBasis: "मूल भाषा के उच्चारण का आधार",
    rowIpa: "ध्वन्यात्मक संकेतन (IPA)",
    rowSyllables: "शब्दांश विश्लेषण",
    rowHangulPronunciation: "हांगुल कैसे पढ़ें (रोमन लिपि में)",
    rowNotationBasis: "लेखन का आधार",
    rowNotationTraits: "कोरियाई लेखन की विशेषताएँ",
  },
  km: {
    analysisSummary: "សេចក្តីសង្ខេបនៃការវិភាគ",
    summaryFallback: "លទ្ធផលវិភាគរបស់អ្នករួចរាល់ហើយ។",
    allRevealed: (count) => `បើកទាំង ${count} ហើយ`,
    partialRevealed: (count) => `បើកហើយ ${count} · នៅជាប់សោទៀត`,
    noRecommendation: "គ្មានការណែនាំ",
    candidateFallbackSubtitle: "បេក្ខឈ្មោះដែលបានណែនាំ",
    lockedNote: "បើកដោយមើលពាណិជ្ជកម្មមួយ ឬទិញពេញលេញ",
    fitScore: (score) => `ភាពសមស្រប (យោង) ${score}`,
    rejectedTitle: "ជម្រើសដែលត្រូវបានដកចេញ",
    rejectedFallbackReason: "មិនត្រូវតាមលក្ខណវិនិច្ឆ័យនៃការណែនាំ",
    officialNoteTitle: "កំណត់សម្គាល់ការផ្ទៀងផ្ទាត់ផ្លូវការ",
    rowReason: "មូលហេតុដែលយើងណែនាំ",
    rowPronunciation: "ការបញ្ចេញសំឡេង",
    rowMeaning: "អត្ថន័យឈ្មោះ",
    rowNaturalness: "ភាពធម្មជាតិក្នុងភាសាកូរ៉េ",
    rowUsageNote: "បរិបទនៃការប្រើប្រាស់",
    rowHanjaAddon: "ផ្នែកបន្ថែមហានចា",
    rowCaution: "ការប្រុងប្រយ័ត្ន",
    rowSourceBasis: "មូលដ្ឋាននៃការបញ្ចេញសំឡេងភាសាដើម",
    rowIpa: "សញ្ញាសូរសព្ទ (IPA)",
    rowSyllables: "ការវិភាគព្យាង្គ",
    rowHangulPronunciation: "របៀបអានអក្សរហាន់គុល (អក្សរឡាតាំង)",
    rowNotationBasis: "មូលដ្ឋាននៃការសរសេរ",
    rowNotationTraits: "លក្ខណៈនៃការសរសេរភាសាកូរ៉េ",
  },
  kk: {
    analysisSummary: "Талдау қорытындысы",
    summaryFallback: "Талдау нәтижеңіз дайын.",
    allRevealed: (count) => `Барлық ${count} нұсқа ашылды`,
    partialRevealed: (count) => `${count} ашылды · қалғаны құлыпта`,
    noRecommendation: "Ұсыныс жоқ",
    candidateFallbackSubtitle: "Ұсынылған есім нұсқасы",
    lockedNote: "Бір жарнамамен немесе толық сатып алумен ашыңыз",
    fitScore: (score) => `Сәйкестік (анықтамалық) ${score}`,
    rejectedTitle: "Шығарылған нұсқалар",
    rejectedFallbackReason: "Ұсыныс өлшемдеріне сай келмеді",
    officialNoteTitle: "Ресми тексеру ескертпесі",
    rowReason: "Неге ұсынамыз",
    rowPronunciation: "Айтылуы",
    rowMeaning: "Есімнің мағынасы",
    rowNaturalness: "Корей тіліндегі табиғилық",
    rowUsageNote: "Қолдану аясы",
    rowHanjaAddon: "Ханджа қосымшасы",
    rowCaution: "Назар аударыңыз",
    rowSourceBasis: "Бастапқы тілдегі айтылым негізі",
    rowIpa: "Фонетикалық жазба (IPA)",
    rowSyllables: "Буын талдауы",
    rowHangulPronunciation: "Хангыльді қалай оқу керек (латын әрпімен)",
    rowNotationBasis: "Жазылу негізі",
    rowNotationTraits: "Корейше жазылу ерекшеліктері",
  },
  ms: {
    analysisSummary: "Ringkasan analisis",
    summaryFallback: "Hasil analisis anda sudah sedia.",
    allRevealed: (count) => `Kesemua ${count} dibuka`,
    partialRevealed: (count) => `${count} dibuka · yang lain berkunci`,
    noRecommendation: "Tiada cadangan",
    candidateFallbackSubtitle: "Calon yang dicadangkan",
    lockedNote: "Buka dengan satu iklan atau pembelian penuh",
    fitScore: (score) => `Kesesuaian (rujukan) ${score}`,
    rejectedTitle: "Pilihan yang dikecualikan",
    rejectedFallbackReason: "Tidak memenuhi kriteria cadangan",
    officialNoteTitle: "Nota pengesahan rasmi",
    rowReason: "Sebab kami mencadangkannya",
    rowPronunciation: "Sebutan",
    rowMeaning: "Makna nama",
    rowNaturalness: "Keaslian dalam bahasa Korea",
    rowUsageNote: "Konteks penggunaan",
    rowHanjaAddon: "Tambahan Hanja",
    rowCaution: "Perhatian",
    rowSourceBasis: "Asas sebutan bahasa sumber",
    rowIpa: "Notasi fonetik (IPA)",
    rowSyllables: "Analisis suku kata",
    rowHangulPronunciation: "Cara membaca Hangul (rumi)",
    rowNotationBasis: "Asas ejaan",
    rowNotationTraits: "Ciri ejaan bahasa Korea",
  },
  pl: {
    analysisSummary: "Podsumowanie analizy",
    summaryFallback: "Twój wynik analizy jest gotowy.",
    allRevealed: (count) => `Odblokowano wszystkie ${count}`,
    partialRevealed: (count) => `Odblokowano: ${count} · pozostałe zablokowane`,
    noRecommendation: "Brak rekomendacji",
    candidateFallbackSubtitle: "Polecany kandydat",
    lockedNote: "Odblokuj jedną reklamą lub pełnym zakupem",
    fitScore: (score) => `Dopasowanie (orientacyjnie) ${score}`,
    rejectedTitle: "Odrzucone opcje",
    rejectedFallbackReason: "Nie spełniło kryteriów rekomendacji",
    officialNoteTitle: "Uwaga o oficjalnej weryfikacji",
    rowReason: "Dlaczego to polecamy",
    rowPronunciation: "Wymowa",
    rowMeaning: "Znaczenie imienia",
    rowNaturalness: "Naturalność w języku koreańskim",
    rowUsageNote: "Kontekst użycia",
    rowHanjaAddon: "Dodatek hanja",
    rowCaution: "Uwaga",
    rowSourceBasis: "Podstawa wymowy w języku źródłowym",
    rowIpa: "Zapis fonetyczny (IPA)",
    rowSyllables: "Analiza sylab",
    rowHangulPronunciation: "Jak czytać hangul (w zapisie łacińskim)",
    rowNotationBasis: "Podstawa zapisu",
    rowNotationTraits: "Cechy zapisu koreańskiego",
  },
  en: {
