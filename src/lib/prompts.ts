  ...
  switch (serviceType) {
    ...
    case "KOREAN_TO_GLOBAL":
      return [
        ...
        "name: 대상 언어의 표준 문자로 쓴 이름(given name)만 깔끔하게 넣으십시오(병기·부가 설명 금지). 일본어면 실제 일본 이름처럼 한자 또는 가나로(예: 陽翔), 중국어면 한자로, 러시아어면 키릴 문자로, 영어권·로마자권이면 로마자로 씁니다.",
