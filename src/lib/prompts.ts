  ...
  switch (serviceType) {
    ...
    case "KOREAN_TO_GLOBAL":
      return [
        ...
        "Every candidate must include recommendation_reason explaining why this name fits the user's Korean name meaning, target region, usage context, profession, tone, birth profile, and pronunciation constraints.",
    ...
    case "GLOBAL_TO_KOREAN":
      return [
        ...
        "Create Korean names from a foreign original name using country, selected birth profile, Korean usage context, preferred family name, pronunciation, and cultural naturalness.",
        ...
        "Every candidate must include recommendation_reason explaining why this Korean name fits the original name, country, birth profile, Korean usage context, and selected tone.",
