    ...
    sections: [
      {
        ...
        paragraphs: [
          "비회원 이름 서비스 이용 시 이름, 생년월일, 생시, 국가, 언어, 사용 목적, 발음 힌트, 입력 프롬프트와 생성 결과가 처리될 수 있습니다.",
          "굿즈 주문 기능을 이용할 때에만 주문자명, 이메일, 연락처, 배송지, 결제 상태와 주문 처리 정보가 추가로 처리될 수 있습니다.",
          "서비스 안정성과 남용 방지를 위해 접속 IP, 브라우저 정보, 요청 시각, 무료 사용 횟수, 광고 노출·보상 이벤트가 로그로 처리될 수 있습니다.",
        ],
      },
      {
        title: "2. 개인정보 처리 목적",
      ...
      },
      {
        title: "3. 보관 및 파기",
        paragraphs: [
          "분석 입력과 결과는 서비스 제공 및 이용자가 요청한 보관 목적이 종료되면 파기합니다. 배송 상세정보는 주문 처리와 반품·분쟁 대응에 필요한 기간이 지나면 파기하거나 비식별화합니다. 결제·주문 거래기록은 관계 법령의 법정 보관 기간에 따라 별도로 보관합니다.",
        ],
      },
      {
