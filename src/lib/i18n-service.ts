...
const hi: ServiceCopyOverride = {
  byService: {
    "global-to-korean": {
      hero: {
        title: "अपने नाम को कोरियाई नाम में बदलें",
        eyebrow: "कोरिया में जीवन और काम के लिए एक कोरियाई नाम",
        description:
          "हमें अपना मूल नाम, देश, जन्म विवरण और बताएं कि आप कोरिया में नाम का उपयोग कैसे करेंगे — हम स्वाभाविक और आसानी से समझाए जा सकने वाले कोरियाई नाम सुझाएँगे।",
        promise:
          "हम ऐसे नाम सुझाते हैं जिन्हें पुकारना और लिखना आसान हो, और जिनके अर्थ व उच्चारण की आप पुष्टि कर सकें।",
        resultLabel: "सुझाए गए कोरियाई नाम",
      },
      sectionTitles: {
        "기본 정보": "मूल जानकारी",
        "출생 정보": "जन्म जानकारी",
        "한국 사용 맥락": "कोरिया में उपयोग का संदर्भ",
      },
      sectionDescriptions: {
        "기본 정보": "कोरियाई नाम सुझाने के लिए ज़रूरी मूल जानकारी चुनें।",
        "출생 정보": "सटीक तुलना और विश्लेषण के लिए हर मद चुनें।",
        "한국 사용 맥락": "मनचाही नाम शैली चुनें और बताएं कि आप कोरिया में नाम का उपयोग कैसे करेंगे।",
      },
      fieldLabels: {
        originalName: "मूल नाम",
        country: "देश",
        nameMotivation: "आपके कोरियाई नाम का उद्देश्य",
        gender: "लिंग / छवि",
        birthYear: "जन्म वर्ष",
        birthMonth: "जन्म माह",
        birthDay: "जन्म दिन",
        birthHour: "जन्म समय",
        koreanFamilyName: "पसंदीदा कोरियाई सरनेम",
        koreanTone: "नाम की शैली",
        usageContext: "उपयोग का संदर्भ",
        outputLanguage: "परिणाम की भाषा",
      },
      fieldPlaceholders: {
        originalName: "जैसे: राहुल शर्मा",
      },
    },
    "global-name-to-hangul": {
      hero: {
        title: "अपना नाम उसके असली उच्चारण के अनुसार हांगुल में लिखें",
        eyebrow: "आपका नाम हांगुल में",
        description:
          "हम विश्लेषण करते हैं कि आपका नाम कैसे उच्चारित होता है और स्वाभाविक हांगुल वर्तनी सुझाते हैं।",
        promise:
          "कोरियाई उच्चारण नियमों का पालन करते हुए हम आपके नाम की अपनी ध्वनियों और सिलेबल को प्राथमिकता देते हैं।",
        resultLabel: "सुझाई गई हांगुल वर्तनियाँ",
      },
      sectionTitles: {
        "본명 정보": "मूल नाम की जानकारी",
      },
      sectionDescriptions: {
        "본명 정보": "वह भाषा और देश चुनें जिनसे आपका नाम लिखा और उच्चारित होता है।",
      },
      fieldLabels: {
        originalName: "मूल नाम",
        originalNameLanguage: "आपके नाम की स्रोत भाषा",
        country: "देश",
        pronunciationHint: "उच्चारण संकेत (वैकल्पिक)",
      },
      fieldHints: {
        originalName: "※ अपना पूरा नाम अपनी स्थानीय भाषा में दर्ज करें।",
        originalNameLanguage: "※ वह भाषा चुनें जिसमें आपका नाम उच्चारित होता है।",
        country:
          "※ इससे देश के अनुसार उच्चारण के अंतर को दर्शाने में मदद मिलती है।\nदेश बदलने से परिणाम बदल सकता है।",
        pronunciationHint:
          "※ सिलेबल विभाजन और उच्चारण संकेत दर्ज करें।\nआपके संकेत को सर्वोच्च प्राथमिकता दी जाती है।",
      },
      fieldPlaceholders: {
        originalName: "जैसे: राहुल शर्मा",
        pronunciationHint: "जैसे: उच्चारण रा-हुल शर-मा जैसा है",
      },
    },
  },
  optionLabels: {
    recommend: "मेरे लिए सुझाएँ",
    natural_modern: "स्वाभाविक और आधुनिक",
    traditional: "पारंपरिक",
    business_friendly: "बिज़नेस के अनुकूल",
    soft: "कोमल और गर्मजोशी भरा",
    distinctive: "विशिष्ट",
    korean_workplace: "कोरियाई कार्यस्थल",
    school: "स्कूल / एक्सचेंज",
    creator: "क्रिएटर / सार्वजनिक प्रोफ़ाइल",
    daily: "रोज़मर्रा की ज़िंदगी",
    auto: "मेरे ब्राउज़र की भाषा के अनुसार",
    not_specified: "निर्दिष्ट नहीं",
    female: "महिला",
    male: "पुरुष",
    neutral: "तटस्थ / कोई भी",
    auto_by_country: "देश के अनुसार स्वतः चयन",
    korean_education: "कोरियाई पढ़ाई, काम या एक्सचेंज",
    k_culture: "K-कल्चर, सोशल मीडिया, निकनेम",
    business: "बिज़नेस, विज़िटिंग कार्ड, ग्लोबल काम",
    daily_social: "दोस्त, स्कूल, रोज़मर्रा की ज़िंदगी",
    family_pet: "बच्चे, परिवार या पालतू जानवर का नाम",
    creator_brand: "क्रिएटर, ब्रांड, सार्वजनिक प्रोफ़ाइल",
    unknown: "पता नहीं",
    "23-01": "23:00–01:00 (Jasi)",
    "01-03": "01:00–03:00 (Chuksi)",
    "03-05": "03:00–05:00 (Insi)",
...
const km: ServiceCopyOverride = {
  byService: {
    "global-to-korean": {
      hero: {
        title: "ប្រែក្លាយឈ្មោះរបស់អ្នកទៅជាឈ្មោះកូរ៉េ",
        eyebrow: "ឈ្មោះកូរ៉េសម្រាប់ការរស់នៅ និងការងារនៅកូរ៉េ",
        description:
          "ប្រាប់យើងអំពីឈ្មោះដើម ប្រទេស ព័ត៌មានកំណើត និងរបៀបដែលអ្នកនឹងប្រើឈ្មោះនៅកូរ៉េ ហើយយើងនឹងណែនាំឈ្មោះកូរ៉េដែលធម្មជាតិ និងអាចពន្យល់បាន។",
        promise:
          "យើងណែនាំឈ្មោះដែលងាយហៅ ងាយសរសេរ ដោយអត្ថន័យ និងការបញ្ចេញសំឡេងអាចផ្ទៀងផ្ទាត់បាន។",
        resultLabel: "ឈ្មោះកូរ៉េដែលបានណែនាំ",
      },
      sectionTitles: {
        "기본 정보": "ព័ត៌មានមូលដ្ឋាន",
        "출생 정보": "ព័ត៌មានកំណើត",
        "한국 사용 맥락": "បរិបទនៃការប្រើប្រាស់នៅកូរ៉េ",
      },
      sectionDescriptions: {
        "기본 정보": "ជ្រើសរើសព័ត៌មានមូលដ្ឋានដែលយើងត្រូវការ ដើម្បីណែនាំឈ្មោះកូរ៉េ។",
        "출생 정보": "ជ្រើសរើសធាតុនីមួយៗ ដើម្បីប្រៀបធៀប និងវិភាគបានត្រឹមត្រូវ។",
        "한국 사용 맥락": "ជ្រើសរើសស្ទីលឈ្មោះដែលអ្នកចង់បាន និងរបៀបដែលអ្នកនឹងប្រើឈ្មោះនៅកូរ៉េ។",
      },
      fieldLabels: {
        originalName: "ឈ្មោះដើម",
        country: "ប្រទេស",
        nameMotivation: "គោលបំណងនៃឈ្មោះកូរ៉េរបស់អ្នក",
        gender: "ភេទ / រូបភាព",
        birthYear: "ឆ្នាំកំណើត",
        birthMonth: "ខែកំណើត",
        birthDay: "ថ្ងៃកំណើត",
        birthHour: "ម៉ោងកំណើត",
        koreanFamilyName: "នាមត្រកូលកូរ៉េដែលចង់បាន",
        koreanTone: "ស្ទីលឈ្មោះ",
        usageContext: "បរិបទនៃការប្រើប្រាស់",
        outputLanguage: "ភាសាលទ្ធផល",
      },
      fieldPlaceholders: {
        originalName: "ឧ. សុខ ចន្ថា",
      },
    },
    "global-name-to-hangul": {
      hero: {
        title: "សរសេរឈ្មោះរបស់អ្នកជាហាន់គុល តាមការបញ្ចេញសំឡេងពិត",
        eyebrow: "ឈ្មោះរបស់អ្នកជាអក្សរហាន់គុល",
        description:
          "យើងវិភាគរបៀបបញ្ចេញសំឡេងឈ្មោះរបស់អ្នក ហើយណែនាំការសរសេរហាន់គុលដែលធម្មជាតិ។",
        promise:
          "យើងផ្ដល់អាទិភាពដល់សំឡេង និងព្យាង្គដើមរបស់ឈ្មោះអ្នក ដោយអនុលោមតាមក្បួនបញ្ចេញសំឡេងភាសាកូរ៉េ។",
        resultLabel: "ការសរសេរហាន់គុលដែលបានណែនាំ",
      },
      sectionTitles: {
        "본명 정보": "ព័ត៌មានឈ្មោះដើម",
      },
      sectionDescriptions: {
        "본명 정보": "ជ្រើសរើសភាសា និងប្រទេសដែលប្រើសម្រាប់សរសេរ និងបញ្ចេញសំឡេងឈ្មោះរបស់អ្នក។",
      },
      fieldLabels: {
        originalName: "ឈ្មោះដើម",
        originalNameLanguage: "ភាសាដើមនៃឈ្មោះរបស់អ្នក",
        country: "ប្រទេស",
        pronunciationHint: "ជំនួយបញ្ចេញសំឡេង (ស្រេចចិត្ត)",
      },
      fieldHints: {
        originalName: "※ បញ្ចូលឈ្មោះពេញរបស់អ្នកជាភាសាកំណើតរបស់អ្នក។",
        originalNameLanguage: "※ ជ្រើសរើសភាសាដែលប្រើសម្រាប់បញ្ចេញសំឡេងឈ្មោះរបស់អ្នក។",
        country:
          "※ វាជួយឆ្លុះបញ្ចាំងភាពខុសគ្នានៃការបញ្ចេញសំឡេងតាមប្រទេស។\nការប្ដូរប្រទេសអាចផ្លាស់ប្ដូរលទ្ធផល។",
        pronunciationHint:
          "※ បញ្ចូលការបំបែកព្យាង្គ និងជំនួយបញ្ចេញសំឡេង។\nជំនួយរបស់អ្នកត្រូវបានអនុវត្តជាអាទិភាពខ្ពស់បំផុត។",
      },
      fieldPlaceholders: {
        originalName: "ឧ. សុខ ចន្ថា",
        pronunciationHint: "ឧ. អានស្រដៀងនឹង សុខ ចាន់-ថា",
      },
    },
  },
  optionLabels: {
    recommend: "ណែនាំឱ្យខ្ញុំ",
    natural_modern: "ធម្មជាតិ និងទំនើប",
    traditional: "បែបប្រពៃណី",
    business_friendly: "សមស្របសម្រាប់ការងារ",
    soft: "ទន់ភ្លន់ និងកក់ក្ដៅ",
    distinctive: "ប្លែក មិនដូចគេ",
    korean_workplace: "កន្លែងធ្វើការនៅកូរ៉េ",
    school: "សាលារៀន / កម្មវិធីផ្លាស់ប្ដូរ",
    creator: "អ្នកបង្កើតមាតិកា / ប្រវត្តិរូបសាធារណៈ",
    daily: "ជីវិតប្រចាំថ្ងៃ",
    auto: "តាមភាសាកម្មវិធីរុករករបស់ខ្ញុំ",
    not_specified: "មិនបញ្ជាក់",
    female: "ស្រី",
    male: "ប្រុស",
    neutral: "អព្យាក្រឹត / មួយណាក៏បាន",
    auto_by_country: "ជ្រើសរើសស្វ័យប្រវត្តិតាមប្រទេស",
    korean_education: "រៀនភាសាកូរ៉េ ការងារ ឬកម្មវិធីផ្លាស់ប្ដូរ",
    k_culture: "K-culture បណ្ដាញសង្គម ឈ្មោះហៅក្រៅ",
    business: "អាជីវកម្ម នាមប័ណ្ណ ការងារអន្តរជាតិ",
    daily_social: "មិត្តភក្ដិ សាលារៀន ជីវិតប្រចាំថ្ងៃ",
    family_pet: "ឈ្មោះសម្រាប់កូន គ្រួសារ ឬសត្វចិញ្ចឹម",
    creator_brand: "អ្នកបង្កើតមាតិកា ម៉ាក ប្រវត្តិរូបសាធារណៈ",
    unknown: "មិនដឹង",
    "23-01": "23:00–01:00 (Jasi)",
    "01-03": "01:00–03:00 (Chuksi)",
    "03-05": "03:00–05:00 (Insi)",
...
const kk: ServiceCopyOverride = {
  byService: {
    "global-to-korean": {
      hero: {
        title: "Есіміңізді корей есіміне айналдырыңыз",
        eyebrow: "Кореяда өмір сүру мен жұмысқа арналған корей есімі",
        description:
          "Бізге бастапқы есіміңізді, еліңізді, туған күн деректеріңізді және есімді Кореяда қалай қолданатыныңызды айтыңыз — біз табиғи әрі түсіндіруге оңай корей есімдерін ұсынамыз.",
        promise:
          "Атауға да, жазуға да оңай, мағынасы мен айтылуын тексеруге болатын есімдерді ұсынамыз.",
        resultLabel: "Ұсынылған корей есімдері",
      },
      sectionTitles: {
        "기본 정보": "Негізгі ақпарат",
        "출생 정보": "Туу туралы мәліметтер",
        "한국 사용 맥락": "Кореядағы қолдану мәнмәтіні",
      },
      sectionDescriptions: {
        "기본 정보": "Корей есімін ұсыну үшін қажетті негізгі деректерді таңдаңыз.",
        "출생 정보": "Дәл салыстыру мен талдау үшін әр тармақты таңдаңыз.",
        "한국 사용 맥락": "Қалаған есім стилін және есімді Кореяда қалай қолданатыныңызды таңдаңыз.",
      },
      fieldLabels: {
        originalName: "Бастапқы есім",
        country: "Ел",
        nameMotivation: "Корей есімінің мақсаты",
        gender: "Жыныс / бейне",
        birthYear: "Туған жыл",
        birthMonth: "Туған ай",
        birthDay: "Туған күн",
        birthHour: "Туған уақыт",
        koreanFamilyName: "Қалаған корей тегі",
        koreanTone: "Есім стилі",
        usageContext: "Қолдану мәнмәтіні",
        outputLanguage: "Нәтиже тілі",
      },
      fieldPlaceholders: {
        originalName: "Мысалы: Айдос Серікұлы",
      },
    },
    "global-name-to-hangul": {
      hero: {
        title: "Есіміңізді нақты айтылуы бойынша хангыльмен жазыңыз",
        eyebrow: "Есіміңіз хангыль жазуында",
        description:
          "Есіміңіздің қалай айтылатынын талдап, табиғи хангыль жазылымын ұсынамыз.",
        promise:
          "Корей тілінің айтылу ережелерін сақтай отырып, есіміңіздің өз дыбыстары мен буындарына басымдық береміз.",
        resultLabel: "Ұсынылған хангыль жазылымдары",
      },
      sectionTitles: {
        "본명 정보": "Бастапқы есім туралы ақпарат",
      },
      sectionDescriptions: {
        "본명 정보": "Есіміңізді жазу мен айтуға қолданылатын тіл мен елді таңдаңыз.",
      },
      fieldLabels: {
        originalName: "Бастапқы есім",
        originalNameLanguage: "Есіміңіздің бастапқы тілі",
        country: "Ел",
        pronunciationHint: "Айтылу нұсқауы (міндетті емес)",
      },
      fieldHints: {
        originalName: "※ Толық есіміңізді өз ана тіліңізде енгізіңіз.",
        originalNameLanguage: "※ Есіміңізді айтуға қолданылатын тілді таңдаңыз.",
        country:
          "※ Бұл елдер арасындағы айтылу айырмашылығын ескеруге көмектеседі.\nЕлді өзгертсеңіз, нәтиже өзгеруі мүмкін.",
        pronunciationHint:
          "※ Буын бөлінісі мен айтылу нұсқауларын енгізіңіз.\nСіздің нұсқауыңыз ең жоғары басымдықпен қолданылады.",
      },
      fieldPlaceholders: {
        originalName: "Мысалы: Айдос Серікұлы",
        pronunciationHint: "Мысалы: Ай-дос Се-рік-ұлы деп оқылады",
      },
    },
  },
  optionLabels: {
    recommend: "Маған ұсыныңыз",
    natural_modern: "Табиғи әрі заманауи",
    traditional: "Дәстүрлі",
    business_friendly: "Іскерлік ортаға лайық",
    soft: "Жұмсақ әрі жылы",
    distinctive: "Ерекше",
    korean_workplace: "Кореядағы жұмыс орны",
    school: "Мектеп / алмасу бағдарламасы",
    creator: "Контент жасаушы / ашық профиль",
    daily: "Күнделікті өмір",
    auto: "Браузерім тіліне сай",
    not_specified: "Көрсетілмеген",
    female: "Әйел",
    male: "Ер",
    neutral: "Бейтарап / кез келгені",
    auto_by_country: "Елге қарай автоматты таңдау",
    korean_education: "Корей тілін үйрену, жұмыс немесе алмасу",
    k_culture: "K-мәдениет, әлеуметтік желілер, лақап ат",
    business: "Бизнес, визитка, халықаралық жұмыс",
    daily_social: "Достар, мектеп, күнделікті өмір",
    family_pet: "Бала, отбасы немесе үй жануарының есімі",
    creator_brand: "Контент жасаушы, бренд, ашық профиль",
    unknown: "Белгісіз",
    "23-01": "23:00–01:00 (Jasi)",
    "01-03": "01:00–03:00 (Chuksi)",
    "03-05": "03:00–05:00 (Insi)",
...
const ms: ServiceCopyOverride = {
  byService: {
    "global-to-korean": {
      hero: {
        title: "Tukar nama anda menjadi nama Korea",
        eyebrow: "Nama Korea untuk kehidupan dan kerja di Korea",
        description:
          "Beritahu kami nama asal, negara, maklumat kelahiran dan cara anda akan menggunakan nama itu di Korea — kami akan mencadangkan nama Korea yang semula jadi dan mudah dijelaskan.",
        promise:
          "Kami mencadangkan nama yang mudah disebut dan ditulis, dengan makna dan sebutan yang boleh disahkan.",
        resultLabel: "Nama Korea yang dicadangkan",
      },
      sectionTitles: {
        "기본 정보": "Maklumat asas",
        "출생 정보": "Maklumat kelahiran",
        "한국 사용 맥락": "Konteks penggunaan di Korea",
      },
      sectionDescriptions: {
        "기본 정보": "Pilih maklumat asas yang kami perlukan untuk mencadangkan nama Korea.",
        "출생 정보": "Pilih setiap item untuk perbandingan dan analisis yang tepat.",
        "한국 사용 맥락": "Pilih gaya nama yang diingini dan cara anda akan menggunakan nama itu di Korea.",
      },
      fieldLabels: {
        ...
        birthMonth: "Bulan lahir",
        birthDay: "Hari lahir",
        birthHour: "Waktu lahir",
        koreanFamilyName: "Nama keluarga Korea pilihan",
        koreanTone: "Gaya nama",
        usageContext: "Konteks penggunaan",
        outputLanguage: "Bahasa hasil",
      },
      fieldPlaceholders: {
        originalName: "Contoh: Ahmad Faizal",
      },
    },
    "global-name-to-hangul": {
      hero: {
        title: "Tulis nama anda dalam Hangul mengikut sebutan sebenar",
        eyebrow: "Nama anda dalam Hangul",
        description:
          "Kami menganalisis cara nama anda disebut dan mencadangkan ejaan Hangul yang semula jadi.",
        promise:
          "Kami mengutamakan bunyi dan suku kata nama anda sendiri, mengikut peraturan sebutan bahasa Korea.",
        resultLabel: "Ejaan Hangul yang dicadangkan",
      },
      sectionTitles: {
        "본명 정보": "Maklumat nama asal",
      },
      sectionDescriptions: {
        "본명 정보": "Pilih bahasa dan negara yang digunakan untuk menulis dan menyebut nama anda.",
      },
      fieldLabels: {
        originalName: "Nama asal",
        originalNameLanguage: "Bahasa sumber nama anda",
        country: "Negara",
        pronunciationHint: "Petunjuk sebutan (pilihan)",
      },
      fieldHints: {
        originalName: "※ Masukkan nama penuh anda dalam bahasa tempatan anda.",
        originalNameLanguage: "※ Pilih bahasa yang digunakan untuk menyebut nama anda.",
        country:
          "※ Ini membantu mengambil kira perbezaan sebutan mengikut negara.\nMenukar negara boleh mengubah hasil.",
        pronunciationHint:
          "※ Masukkan pemisahan suku kata dan petunjuk sebutan.\nPetunjuk anda diberi keutamaan tertinggi.",
      },
      fieldPlaceholders: {
        originalName: "Contoh: Ahmad Faizal",
        pronunciationHint: "Contoh: disebut seperti Ah-mad Fai-zal",
      },
    },
  },
  optionLabels: {
    recommend: "Cadangkan untuk saya",
    natural_modern: "Semula jadi dan moden",
    traditional: "Tradisional",
    business_friendly: "Sesuai untuk perniagaan",
    soft: "Lembut dan mesra",
    distinctive: "Unik dan tersendiri",
    korean_workplace: "Tempat kerja di Korea",
    school: "Sekolah / pertukaran pelajar",
    creator: "Pencipta kandungan / profil awam",
    daily: "Kehidupan seharian",
    auto: "Ikut bahasa pelayar saya",
    not_specified: "Tidak dinyatakan",
    female: "Perempuan",
    male: "Lelaki",
    neutral: "Neutral / mana-mana",
    auto_by_country: "Pilih automatik mengikut negara",
    korean_education: "Belajar bahasa Korea, kerja atau pertukaran",
    k_culture: "K-culture, media sosial, nama samaran",
    business: "Perniagaan, kad nama, kerja global",
    daily_social: "Rakan, sekolah, kehidupan seharian",
    family_pet: "Nama untuk anak, keluarga atau haiwan peliharaan",
    creator_brand: "Pencipta kandungan, jenama, profil awam",
...
const pl: ServiceCopyOverride = {
  byService: {
    "global-to-korean": {
      hero: {
        title: "Zamień swoje imię na imię koreańskie",
        eyebrow: "Koreańskie imię do życia i pracy w Korei",
        description:
          "Podaj nam swoje oryginalne imię, kraj, dane urodzenia oraz sposób, w jaki będziesz używać imienia w Korei — zaproponujemy naturalne, łatwe do wyjaśnienia koreańskie imiona.",
        promise:
          "Polecamy imiona łatwe do wymówienia i zapisania, o znaczeniu i wymowie, które można zweryfikować.",
        resultLabel: "Polecane imiona koreańskie",
      },
      sectionTitles: {
        "기본 정보": "Informacje podstawowe",
        "출생 정보": "Dane urodzenia",
        "한국 사용 맥락": "Kontekst użycia w Korei",
      },
      sectionDescriptions: {
        "기본 정보": "Wybierz podstawowe dane potrzebne do zaproponowania koreańskiego imienia.",
        "출생 정보": "Wybierz każdą pozycję, aby porównanie i analiza były dokładne.",
        "한국 사용 맥락": "Wybierz pożądany styl imienia oraz sposób, w jaki będziesz go używać w Korei.",
      },
      fieldLabels: {
        originalName: "Oryginalne imię",
        country: "Kraj",
        nameMotivation: "Cel Twojego koreańskiego imienia",
        gender: "Płeć / wizerunek",
        birthYear: "Rok urodzenia",
        birthMonth: "Miesiąc urodzenia",
        birthDay: "Dzień urodzenia",
        birthHour: "Godzina urodzenia",
        koreanFamilyName: "Preferowane koreańskie nazwisko",
        koreanTone: "Styl imienia",
        usageContext: "Kontekst użycia",
        outputLanguage: "Język wyniku",
      },
      fieldPlaceholders: {
        originalName: "np. Jan Kowalski",
      },
    },
    "global-name-to-hangul": {
      hero: {
        title: "Zapisz swoje imię w hangul zgodnie z prawdziwą wymową",
        eyebrow: "Twoje imię w hangul",
        description:
          "Analizujemy, jak wymawia się Twoje imię, i proponujemy naturalny zapis w hangul.",
        promise:
          "Priorytetem są dźwięki i sylaby Twojego własnego imienia, zgodnie z zasadami wymowy koreańskiej.",
        resultLabel: "Polecane zapisy w hangul",
      },
      sectionTitles: {
        "본명 정보": "Dane oryginalnego imienia",
      },
      sectionDescriptions: {
        "본명 정보": "Wybierz język i kraj używane do zapisu i wymowy Twojego imienia.",
      },
      fieldLabels: {
        originalName: "Oryginalne imię",
        originalNameLanguage: "Język źródłowy Twojego imienia",
        country: "Kraj",
        pronunciationHint: "Wskazówka wymowy (opcjonalnie)",
      },
      fieldHints: {
        originalName: "※ Wpisz swoje pełne imię i nazwisko w swoim języku.",
        originalNameLanguage: "※ Wybierz język, w którym wymawia się Twoje imię.",
        country:
          "※ Pomaga to uwzględnić różnice w wymowie między krajami.\nZmiana kraju może zmienić wynik.",
        pronunciationHint:
          "※ Wpisz podział na sylaby i wskazówki dotyczące wymowy.\nTwoja wskazówka ma najwyższy priorytet.",
      },
      fieldPlaceholders: {
        originalName: "np. Jan Kowalski",
        pronunciationHint: "np. brzmi jak Jan Ko-wal-ski",
      },
    },
  },
  optionLabels: {
    recommend: "Poleć mi",
    natural_modern: "Naturalne i nowoczesne",
    traditional: "Tradycyjne",
    business_friendly: "Biznesowe",
    soft: "Łagodne i ciepłe",
    distinctive: "Wyraziste",
    korean_workplace: "Koreańskie miejsce pracy",
    school: "Szkoła / wymiana",
    creator: "Twórca / profil publiczny",
    daily: "Życie codzienne",
    auto: "Zgodnie z językiem przeglądarki",
    not_specified: "Nie określono",
    female: "Kobieta",
    male: "Mężczyzna",
    neutral: "Neutralne / dowolne",
    auto_by_country: "Automatycznie według kraju",
    korean_education: "Nauka koreańskiego, praca lub wymiana",
    k_culture: "K-kultura, media społecznościowe, pseudonim",
    business: "Biznes, wizytówki, praca międzynarodowa",
    daily_social: "Znajomi, szkoła, życie codzienne",
    family_pet: "Imię dla dziecka, rodziny lub zwierzaka",
    creator_brand: "Twórca, marka, profil publiczny",
    unknown: "Nie wiem",
    "23-01": "23:00–01:00 (Jasi)",
    "01-03": "01:00–03:00 (Chuksi)",
    "03-05": "03:00–05:00 (Insi)",
